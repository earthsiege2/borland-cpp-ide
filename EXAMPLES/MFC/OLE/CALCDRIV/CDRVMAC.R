...
/////////////////////////////////////////////////////////////////////////
// cdrvmac.r: Macintosh-specific resources
...
resource 'BNDL' (128, purgeable)    // calcdriv bundle resource ID
{
	'CDRV',                 // calcdriv signature
...
resource 'FREF' (128, purgeable)    // calcdriv application
{
	'APPL', 0,
	""
};

resource 'FREF' (129, purgeable)    // calcdriv document
{
	'CDRV', 1,
	""
};
...
resource 'CDRV' (0, purgeable)
{
	"CALCDRIV Application"
};
...
resource 'hovr' (1000)
{
    HelpMgrVersion, hmDefaultOptions, 0, 0,
        ...
        {
            "Miscellaneous part of the Microsoft CALCDRIV "
            "Sample Application."
        },
        {
            ...
            {
                "Click here to close the Microsoft CALCDRIV "
                "Sample Application."
            },
            ...
            {
                "This is not part of the Microsoft CALCDRIV "
...
resource 'STR ' (500)
{
	"This is the Win32 CALCDRIV sample application "
