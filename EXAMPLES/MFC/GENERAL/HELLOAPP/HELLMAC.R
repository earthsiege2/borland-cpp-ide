...
resource 'hovr' (1000)
{
    HelpMgrVersion, hmDefaultOptions, 0, 0,
        ...
        {
            "Miscellaneous part of the Microsoft HelloApp "
            "Sample Application."
        },
        {
            ...
            {
                "Click here to close the Microsoft HelloApp "
                "Sample Application."
            },
            ...
            {
                "This is not part of the Microsoft HelloApp "
...
resource 'STR ' (500)
{
	"This is the Win32 HelloApp sample application "
