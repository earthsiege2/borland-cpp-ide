//  collmac.r: Macintosh-specific resources
...
resource 'BNDL' (128, purgeable)    // Collect bundle resource ID
{
...
resource 'FREF' (128, purgeable)    // Collect application
{
	'APPL', 0,
	""
};

resource 'FREF' (129, purgeable)    // Collect document
{
	'COLL', 1,
	""
};
...
{
	"Collect 1.0 Copyright \251 1994-1995 Microsoft Corp."
};
...
resource 'hovr' (1000)
{
    HelpMgrVersion, hmDefaultOptions, 0, 0,
        ...
        {
            "Miscellaneous part of the Microsoft Collect "
            "Sample Application."
        },
        {
            ...
            {
                "Click here to close the Microsoft Collect "
                "Sample Application."
            },
            ...
            {
                "This is not part of the Microsoft Collect "
...
resource 'STR ' (500)
{
	"This is the Win32 Collect sample application "
