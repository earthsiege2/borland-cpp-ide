...
//   Tutorial application -- cntrl18.cpp
//----------------------------------------------------------------------------
#include <owl/pch.h>
...
class TMyApp : public TApplication {
  ...
  private:
    void TestAutomation(); //Routine to execute step18
...
TMyApp::InitMainWindow()
{
  ...
  SetMainWindow(new TFrameWindow(0,"Step 18 Controller",Disp));
}
...
TMyApp::TestAutomation()
{
  ...
  try {
    ...
    app.Bind("DrawPad.Application.18");
    ...
    ::MessageBox(0, "End of Program", "CNTRL18.EXE", MB_OK);
