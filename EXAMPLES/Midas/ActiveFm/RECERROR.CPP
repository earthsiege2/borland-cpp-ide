...
//
//  Copyright (c) 1999-2002 Borland International
//
//---------------------------------------------------------------------------
...
//
// Action = HandleReconcileError(DataSet, UpdateKinde, E);
//
// After adding this unit to your project you must go into the Project Options
// dialog and remove this form from the list of Auto-created forms or an error
// will occur when compiling.
//
