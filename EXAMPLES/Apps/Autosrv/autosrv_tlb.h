...
// File generated on 1/17/2002 2:24:44 PM from Type Library described below.

// ************************************************************************  //
// Type Lib: autosrv.tlb (1)
// LIBID: {14452774-CA96-4F0A-B4B1-F464D6150463}
// LCID: 0
// Helpfile: 
...
// *********************************************************************//
extern "C" const __declspec(selectany) GUID LIBID_autosrv = {0x14452774, 0xCA96, 0x4F0A,{ 0xB4, 0xB1, 0xF4,0x64, 0xD6, 0x15,0x04, 0x63} };
extern "C" const __declspec(selectany) GUID IID_IEditServer = {0x4C58BE81, 0xEF79, 0x4C7E,{ 0xAD, 0xE7, 0xA5,0x2B, 0x8F, 0x09,0x0C, 0x97} };
extern "C" const __declspec(selectany) GUID CLSID_EditServer = {0xE75CBA81, 0x036A, 0x4B11,{ 0xA5, 0x70, 0x4B,0x31, 0x07, 0xE3,0x35, 0xFC} };
...
{
  BSTR result = 0;
  OLECHECK(this->SetThreeStr(, (BSTR*)&result));
  return result;
}
