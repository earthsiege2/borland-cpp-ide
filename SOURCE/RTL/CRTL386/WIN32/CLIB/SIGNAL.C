...
typedef void  ( __cdecl * CatcherPTR)(int);
typedef void  ( __cdecl * CatcherPTR2)(int,int);
                               ...
                               PVOID s)
{
        ...
        Index == SIGFPE_INDEX)
    {
         ...
         * enable all others.  Then clear all exceptions.  This is necessary
         * because at this point OS/2 has masked all exceptions.  If the
         * signal handler longjmps out and never returns, no more exceptions
         * could be processed.
         */
...
/*+----------------------------------------------------------------------+
  ...
  +----------------------------------------------------------------------+*/
/*
void (__cdecl * _RTLENTRY signal(sig, New))(int)
int sig;
CatcherPTR New;
*/
