...
Name            __lsearch - searches a table

Usage           static void *near
                pascal __lsearch(const void      *key,
                                void            *base,
                                size_t          *nelem,
                                size_t          width,
...
*---------------------------------------------------------------------*/
static void *near pascal __lsearch(const void    *key,
                                   register void *base,
                                   size_t        *nelem,
                                   size_t        width,
                                   int cdecl (*fcmp)(const void *, const void *),
...
{
        return(__lsearch(key,base,nelem,width,fcmp,1));
}
...
void * _FARFUNC lfind(const void *key, const void *base, size_t *nelem, size_t width,
            int cdecl (* _FARFUNC fcmp)(const void *, const void *))
{
        return(__lsearch(key,(void *)base,nelem,width,fcmp,0));
}
