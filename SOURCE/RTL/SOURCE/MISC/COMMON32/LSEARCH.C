...
*---------------------------------------------------------------------*/
static void * _lsearch(const void    *key,
                       register void *base,
                       size_t        *nelem,
                       size_t        width,
                       int (_USERENTRY *fcmp)(const void *, const void *),
...
void * _RTLENTRY _EXPFUNC lsearch(const void *key, void *base, size_t *nelem, size_t width,
              int (_USERENTRY *fcmp)(const void *, const void *))
{
...
void * _RTLENTRY _EXPFUNC lfind(const void *key, const void *base, size_t *nelem, size_t width,
            int (_USERENTRY *fcmp)(const void *, const void *))
{
