 ...
 *        _wspawnvpe - creates and runs child processes
 *-----------------------------------------------------------------------*/
...
Name            spawnvpe, _wspawnvpe - creates and runs child processes

Usage           #include <process.h>
                int spawnvpe(int modeF, const char *pathP,
                             char * const * argv,
                             char * const * envP);
                int spawnvpe(int modeF, const wchar_t *pathP,
                             wchar_t * const * argv,
                             wchar_t * const * envP);
...
int _RTLENTRY _EXPFUNC _tspawnvpe(int modeF, const _TCHAR *pathP,
                                _TCHAR * const * argv,
                                _TCHAR * const * envV)
{
    /*
      ...
      a Func argument.
    */
        return _tLoadProg(modeF, pathP, argv, envV, 1);
}
