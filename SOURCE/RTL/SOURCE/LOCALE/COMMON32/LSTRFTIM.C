...
the_switch:
        ...
        case 'a':
            ...
            p = (char *) &__pLocale->TimeCat.TimeDateInfo.abday[ t->tm_wday ];
        ...
        case 'A':
            ...
            p = (char *) &__pLocale->TimeCat.TimeDateInfo.day[ t->tm_wday ];
        ...
        case 'b':
            ...
            p = (char *) &__pLocale->TimeCat.TimeDateInfo.abmon[ t->tm_mon ];
        ...
        case 'B':
            ...
            p = (char *) &__pLocale->TimeCat.TimeDateInfo.mon[ t->tm_mon ];
        ...
        case 'c':
            ...
            /* recurse */
            _lstrftime( p, maxsize, (char *) &__pLocale->TimeCat.TimeDateInfo.d_t_fmt, t );
        ...
        case 'p':
            ...
            p = (char *) &__pLocale->TimeCat.TimeDateInfo.am_pm[ t->tm_hour / 12 ];
        ...
        case 'r':
            ...
            /* recurse */
            _lstrftime( p, maxsize, (char *) &__pLocale->TimeCat.TimeDateInfo.t_fmt_ampm, t );
        ...
        case 'x':
            ...
            /* recurse */
            _lstrftime( p, maxsize, (char *) &__pLocale->TimeCat.TimeDateInfo.d_fmt, t );
        ...
        case 'X':
            ...
            /* recurse */
            _lstrftime( p, maxsize, (char *) &__pLocale->TimeCat.TimeDateInfo.t_fmt, t );
...

{
   ...
   ptr = (char *) &__pLocale->TimeCat.TimeDateInfo.alt_digits;
