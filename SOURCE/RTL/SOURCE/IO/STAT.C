...
Description     Gather statistics about the file named by *pathP and place them
                ...
                st_atime        time file last accessed (seconds since 1970)
                st_mtime        time file was last modified
                st_ctime        time file was originally created
...
NOTE:           The MSCompat struct _stat is binary compatible with
                our struct stat.
...
int _RTLENTRY _EXPFUNC _tstat (const _TCHAR *pathP, struct _stat *_bufP)
{
    WIN32_FIND_DATA ff;
    ...
    _TCHAR     *full = 0;
    _TCHAR     *ext;
    struct stat *bufP = (struct stat *)_bufP;
