...
// File generated on 1/29/2002 1:29:02 PM from Type Library described below.

// ************************************************************************  //
// Type Lib: c:\program files\microsoft office\office10\excel.exe (1)
// LIBID: {00020813-0000-0000-C000-000000000046}
// LCID: 0
// Helpfile: c:\program files\microsoft office\office10\VBAXL10.CHM
// HelpString: Microsoft Excel 10.0 Object Library
// DepndLst: 
//   (1) v2.2 Office, (C:\Program Files\Common Files\Microsoft Shared\Office10\MSO.DLL)
...
void __fastcall TExcelApplication::InvokeEvent(int id, Oleserver::TVariantArray& params)
{
  switch(id)
  {
    case 1565: {
      if (OnNewWorkbook) {
        (OnNewWorkbook)(this, (Excel_xp::ExcelWorkbook*)(LPDISPATCH)TVariant(params[0]));
      }
      break;
      }
    case 1558: {
      if (OnSheetSelectionChange) {
        (OnSheetSelectionChange)(this, TVariant(params[0]), (Excel_xp::Range*)(LPDISPATCH)TVariant(params[1]));
      }
      break;
      }
    case 1559: {
      if (OnSheetBeforeDoubleClick) {
        (OnSheetBeforeDoubleClick)(this, TVariant(params[0]), (Excel_xp::Range*)(LPDISPATCH)TVariant(params[1]), TVariant(params[2]));
      }
      break;
      }
    case 1560: {
      if (OnSheetBeforeRightClick) {
        (OnSheetBeforeRightClick)(this, TVariant(params[0]), (Excel_xp::Range*)(LPDISPATCH)TVariant(params[1]), TVariant(params[2]));
      }
      break;
      }
    case 1561: {
    ...
    case 1564: {
      if (OnSheetChange) {
        (OnSheetChange)(this, TVariant(params[0]), (Excel_xp::Range*)(LPDISPATCH)TVariant(params[1]));
      }
      break;
      }
    case 1567: {
      if (OnWorkbookOpen) {
        (OnWorkbookOpen)(this, (Excel_xp::ExcelWorkbook*)(LPDISPATCH)TVariant(params[0]));
      }
      break;
      }
    case 1568: {
      if (OnWorkbookActivate) {
        (OnWorkbookActivate)(this, (Excel_xp::ExcelWorkbook*)(LPDISPATCH)TVariant(params[0]));
      }
      break;
      }
    case 1569: {
      if (OnWorkbookDeactivate) {
        (OnWorkbookDeactivate)(this, (Excel_xp::ExcelWorkbook*)(LPDISPATCH)TVariant(params[0]));
      }
      break;
      }
    case 1570: {
      if (OnWorkbookBeforeClose) {
        (OnWorkbookBeforeClose)(this, (Excel_xp::ExcelWorkbook*)(LPDISPATCH)TVariant(params[0]), TVariant(params[1]));
      }
      break;
      }
    case 1571: {
      if (OnWorkbookBeforeSave) {
        (OnWorkbookBeforeSave)(this, (Excel_xp::ExcelWorkbook*)(LPDISPATCH)TVariant(params[0]), TVariant(params[1]), TVariant(params[2]));
      }
      break;
      }
    case 1572: {
      if (OnWorkbookBeforePrint) {
        (OnWorkbookBeforePrint)(this, (Excel_xp::ExcelWorkbook*)(LPDISPATCH)TVariant(params[0]), TVariant(params[1]));
      }
      break;
      }
    case 1573: {
      if (OnWorkbookNewSheet) {
        (OnWorkbookNewSheet)(this, (Excel_xp::ExcelWorkbook*)(LPDISPATCH)TVariant(params[0]), TVariant(params[1]));
      }
      break;
      }
    case 1574: {
      if (OnWorkbookAddinInstall) {
        (OnWorkbookAddinInstall)(this, (Excel_xp::ExcelWorkbook*)(LPDISPATCH)TVariant(params[0]));
      }
      break;
      }
    case 1575: {
      if (OnWorkbookAddinUninstall) {
        (OnWorkbookAddinUninstall)(this, (Excel_xp::ExcelWorkbook*)(LPDISPATCH)TVariant(params[0]));
      }
      break;
      }
    case 1554: {
      if (OnWindowResize) {
        (OnWindowResize)(this, (Excel_xp::ExcelWorkbook*)(LPDISPATCH)TVariant(params[0]), (Excel_xp::WINDOW*)(LPDISPATCH)TVariant(params[1]));
      }
      break;
      }
    case 1556: {
      if (OnWindowActivate) {
        (OnWindowActivate)(this, (Excel_xp::ExcelWorkbook*)(LPDISPATCH)TVariant(params[0]), (Excel_xp::WINDOW*)(LPDISPATCH)TVariant(params[1]));
      }
      break;
      }
    case 1557: {
      if (OnWindowDeactivate) {
        (OnWindowDeactivate)(this, (Excel_xp::ExcelWorkbook*)(LPDISPATCH)TVariant(params[0]), (Excel_xp::WINDOW*)(LPDISPATCH)TVariant(params[1]));
      }
      break;
      }
    case 1854: {
      if (OnSheetFollowHyperlink) {
        (OnSheetFollowHyperlink)(this, TVariant(params[0]), (Excel_xp::Hyperlink*)(LPDISPATCH)TVariant(params[1]));
      }
      break;
      }
    case 2157: {
      if (OnSheetPivotTableUpdate) {
        (OnSheetPivotTableUpdate)(this, TVariant(params[0]), (Excel_xp::PivotTable*)(LPDISPATCH)TVariant(params[1]));
      }
      break;
      }
    case 2160: {
      if (OnWorkbookPivotTableCloseConnection) {
        (OnWorkbookPivotTableCloseConnection)(this, (Excel_xp::ExcelWorkbook*)(LPDISPATCH)TVariant(params[0]), (Excel_xp::PivotTable*)(LPDISPATCH)TVariant(params[1]));
      }
      break;
      }
    case 2161: {
      if (OnWorkbookPivotTableOpenConnection) {
        (OnWorkbookPivotTableOpenConnection)(this, (Excel_xp::ExcelWorkbook*)(LPDISPATCH)TVariant(params[0]), (Excel_xp::PivotTable*)(LPDISPATCH)TVariant(params[1]));
      }
      break;
      }
    default:
  ...
  switch(id)
  {
    case 1543: {
      if (OnSelectionChange) {
        (OnSelectionChange)(this, (Excel_xp::Range*)(LPDISPATCH)TVariant(params[0]));
      }
      break;
      }
    case 1537: {
      if (OnBeforeDoubleClick) {
        (OnBeforeDoubleClick)(this, (Excel_xp::Range*)(LPDISPATCH)TVariant(params[0]), TVariant(params[1]));
      }
      break;
      }
    case 1534: {
      if (OnBeforeRightClick) {
        (OnBeforeRightClick)(this, (Excel_xp::Range*)(LPDISPATCH)TVariant(params[0]), TVariant(params[1]));
      }
      break;
      }
    case 304: {
    ...
    case 1545: {
      if (OnChange) {
        (OnChange)(this, (Excel_xp::Range*)(LPDISPATCH)TVariant(params[0]));
      }
      break;
      }
    case 1470: {
      if (OnFollowHyperlink) {
        (OnFollowHyperlink)(this, (Excel_xp::Hyperlink*)(LPDISPATCH)TVariant(params[0]));
      }
      break;
      }
    case 2156: {
      if (OnPivotTableUpdate) {
        (OnPivotTableUpdate)(this, (Excel_xp::PivotTable*)(LPDISPATCH)TVariant(params[0]));
      }
      break;
      }
    default:
...
void __fastcall TExcelWorkbook::InvokeEvent(int id, Oleserver::TVariantArray& params)
{
  switch(id)
  {
    ...
    case 1554: {
      if (OnWindowResize) {
        (OnWindowResize)(this, (Excel_xp::WINDOW*)(LPDISPATCH)TVariant(params[0]));
      }
      break;
      }
    case 1556: {
      if (OnWindowActivate) {
        (OnWindowActivate)(this, (Excel_xp::WINDOW*)(LPDISPATCH)TVariant(params[0]));
      }
      break;
      }
    case 1557: {
      if (OnWindowDeactivate) {
        (OnWindowDeactivate)(this, (Excel_xp::WINDOW*)(LPDISPATCH)TVariant(params[0]));
      }
      break;
      }
    case 1558: {
    ...
    case 2158: {
      if (OnPivotTableCloseConnection) {
        (OnPivotTableCloseConnection)(this, (Excel_xp::PivotTable*)(LPDISPATCH)TVariant(params[0]));
      }
      break;
      }
    case 2159: {
      if (OnPivotTableOpenConnection) {
        (OnPivotTableOpenConnection)(this, (Excel_xp::PivotTable*)(LPDISPATCH)TVariant(params[0]));
      }
      break;
      }
    default:
