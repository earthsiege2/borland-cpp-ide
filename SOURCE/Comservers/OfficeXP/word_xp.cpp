...
const GUID IID_Windows = {0x00020961, 0x0000, 0x0000,{ 0xC0, 0x00, 0x00,0x00, 0x00, 0x00,0x00, 0x46} };
...
const GUID IID_IApplicationEvents = {0x000209F7, 0x0001, 0x0000,{ 0xC0, 0x00, 0x00,0x00, 0x00, 0x00,0x00, 0x46} };
const GUID IID_IApplicationEvents2 = {0x000209FE, 0x0001, 0x0000,{ 0xC0, 0x00, 0x00,0x00, 0x00, 0x00,0x00, 0x46} };
const GUID DIID_ApplicationEvents2 = {0x000209FE, 0x0000, 0x0000,{ 0xC0, 0x00, 0x00,0x00, 0x00, 0x00,0x00, 0x46} };
const GUID IID_EmailAuthor = {0x000209D7, 0x0000, 0x0000,{ 0xC0, 0x00, 0x00,0x00, 0x00, 0x00,0x00, 0x46} };
const GUID IID_EmailOptions = {0x000209DB, 0x0000, 0x0000,{ 0xC0, 0x00, 0x00,0x00, 0x00, 0x00,0x00, 0x46} };
const GUID IID_EmailSignature = {0x000209DC, 0x0000, 0x0000,{ 0xC0, 0x00, 0x00,0x00, 0x00, 0x00,0x00, 0x46} };
const GUID IID_Email = {0x000209DD, 0x0000, 0x0000,{ 0xC0, 0x00, 0x00,0x00, 0x00, 0x00,0x00, 0x46} };
const GUID IID_HorizontalLineFormat = {0x000209DE, 0x0000, 0x0000,{ 0xC0, 0x00, 0x00,0x00, 0x00, 0x00,0x00, 0x46} };
const GUID IID_Frameset = {0x000209E2, 0x0000, 0x0000,{ 0xC0, 0x00, 0x00,0x00, 0x00, 0x00,0x00, 0x46} };
const GUID IID_DefaultWebOptions = {0x000209E3, 0x0000, 0x0000,{ 0xC0, 0x00, 0x00,0x00, 0x00, 0x00,0x00, 0x46} };
const GUID IID_WebOptions = {0x000209E4, 0x0000, 0x0000,{ 0xC0, 0x00, 0x00,0x00, 0x00, 0x00,0x00, 0x46} };
const GUID IID_OtherCorrectionsExceptions = {0x000209DF, 0x0000, 0x0000,{ 0xC0, 0x00, 0x00,0x00, 0x00, 0x00,0x00, 0x46} };
const GUID IID_OtherCorrectionsException = {0x000209E1, 0x0000, 0x0000,{ 0xC0, 0x00, 0x00,0x00, 0x00, 0x00,0x00, 0x46} };
const GUID IID_EmailSignatureEntries = {0x000209E5, 0x0000, 0x0000,{ 0xC0, 0x00, 0x00,0x00, 0x00, 0x00,0x00, 0x46} };
const GUID IID_EmailSignatureEntry = {0x000209E6, 0x0000, 0x0000,{ 0xC0, 0x00, 0x00,0x00, 0x00, 0x00,0x00, 0x46} };
const GUID IID_HTMLDivision = {0x000209E7, 0x0000, 0x0000,{ 0xC0, 0x00, 0x00,0x00, 0x00, 0x00,0x00, 0x46} };
const GUID IID_HTMLDivisions = {0x000209E8, 0x0000, 0x0000,{ 0xC0, 0x00, 0x00,0x00, 0x00, 0x00,0x00, 0x46} };
const GUID IID_DiagramNode = {0x000209E9, 0x0000, 0x0000,{ 0xC0, 0x00, 0x00,0x00, 0x00, 0x00,0x00, 0x46} };
const GUID IID_DiagramNodeChildren = {0x000209EA, 0x0000, 0x0000,{ 0xC0, 0x00, 0x00,0x00, 0x00, 0x00,0x00, 0x46} };
const GUID IID_DiagramNodes = {0x000209EB, 0x0000, 0x0000,{ 0xC0, 0x00, 0x00,0x00, 0x00, 0x00,0x00, 0x46} };
const GUID IID_Diagram = {0x000209EC, 0x0000, 0x0000,{ 0xC0, 0x00, 0x00,0x00, 0x00, 0x00,0x00, 0x46} };
const GUID IID_CustomProperty = {0xB923FDE0, 0xF08C, 0x11D3,{ 0x91, 0xB0, 0x00,0x10, 0x5A, 0x0A,0x19, 0xFD} };
const GUID IID_CustomProperties = {0xB923FDE1, 0xF08C, 0x11D3,{ 0x91, 0xB0, 0x00,0x10, 0x5A, 0x0A,0x19, 0xFD} };
const GUID IID_SmartTag = {0x000209ED, 0x0000, 0x0000,{ 0xC0, 0x00, 0x00,0x00, 0x00, 0x00,0x00, 0x46} };
const GUID IID_SmartTags = {0x000209EE, 0x0000, 0x0000,{ 0xC0, 0x00, 0x00,0x00, 0x00, 0x00,0x00, 0x46} };
const GUID IID_StyleSheet = {0x000209EF, 0x0000, 0x0000,{ 0xC0, 0x00, 0x00,0x00, 0x00, 0x00,0x00, 0x46} };
const GUID IID_StyleSheets = {0x07B7CC7E, 0xE66C, 0x11D3,{ 0x94, 0x54, 0x00,0x10, 0x5A, 0xA3,0x1A, 0x08} };
const GUID IID_MappedDataField = {0x5D311669, 0xEA51, 0x11D3,{ 0x87, 0xCC, 0x00,0x10, 0x5A, 0xA3,0x1A, 0x34} };
const GUID IID_MappedDataFields = {0x799A6814, 0xEA41, 0x11D3,{ 0x87, 0xCC, 0x00,0x10, 0x5A, 0xA3,0x1A, 0x34} };
const GUID IID_CanvasShapes = {0x396F9073, 0xF9FD, 0x11D3,{ 0x8E, 0xA0, 0x00,0x50, 0x04, 0x9A,0x1A, 0x01} };
const GUID IID_TableStyle = {0xB7564E97, 0x0519, 0x4C68,{ 0xB4, 0x00, 0x38,0x03, 0xE7, 0xC6,0x32, 0x42} };
const GUID IID_ConditionalStyle = {0x1498F56D, 0xED33, 0x41F9,{ 0xB3, 0x7B, 0xEF,0x30, 0xE5, 0x0B,0x08, 0xAC} };
const GUID IID_FootnoteOptions = {0xBEA85A24, 0xD7DA, 0x4F3D,{ 0xB5, 0x8C, 0xED,0x90, 0xFB, 0x01,0xD6, 0x15} };
const GUID IID_EndnoteOptions = {0xBF043168, 0xF4DE, 0x4E7C,{ 0xB2, 0x06, 0x74,0x1A, 0x8B, 0x3E,0xF7, 0x1A} };
const GUID IID_Reviewers = {0x12DCDC9A, 0x5418, 0x48A3,{ 0xBB, 0xE6, 0xEB,0x57, 0xBA, 0xE2,0x75, 0xE8} };
const GUID IID_Reviewer = {0x47CEF4AE, 0xDC32, 0x4220,{ 0x8A, 0xA5, 0x19,0xCC, 0xC0, 0xE6,0x63, 0x3A} };
const GUID IID_TaskPane = {0xB9F1A4E2, 0x0D0A, 0x43B7,{ 0x84, 0x95, 0x13,0x9E, 0x7A, 0xCB,0xD8, 0x40} };
const GUID IID_TaskPanes = {0xE6AAEC05, 0xE543, 0x4085,{ 0xBA, 0x92, 0x9B,0xF7, 0xD2, 0x47,0x4F, 0x5C} };
const GUID IID_IApplicationEvents3 = {0x00020A00, 0x0001, 0x0000,{ 0xC0, 0x00, 0x00,0x00, 0x00, 0x00,0x00, 0x46} };
const GUID DIID_ApplicationEvents3 = {0x00020A00, 0x0000, 0x0000,{ 0xC0, 0x00, 0x00,0x00, 0x00, 0x00,0x00, 0x46} };
