...
void __fastcall TAccessReferences::InvokeEvent(int id, Oleserver::TVariantArray& params)
{
  switch(id)
  {
    case 0: {
      if (OnItemAdded) {
        (OnItemAdded)(this, (Access_2k::Reference*)(LPDISPATCH)TVariant(params[0]));
      }
      break;
      }
    case 1: {
      if (OnItemRemoved) {
        (OnItemRemoved)(this, (Access_2k::Reference*)(LPDISPATCH)TVariant(params[0]));
      }
      break;
      }
    default:
...
void __fastcall PACKAGE Register()
{
  ...
  TComponentClass cls_svr[] = {
                              __classid(Access_2k::TFormatCondition), 
                              __classid(Access_2k::TAccessHyperlink), 
                              ...
                              __classid(Access_2k::TDataAccessPage), 
                              __classid(Access_2k::TAllForms), 
                              __classid(Access_2k::TAllReports), 
                              __classid(Access_2k::TAllMacros), 
                              __classid(Access_2k::TAllModules), 
                              __classid(Access_2k::TAllDataAccessPages), 
                              __classid(Access_2k::TAllTables), 
                              __classid(Access_2k::TAllQueries), 
                              __classid(Access_2k::TAllViews), 
                              __classid(Access_2k::TAllStoredProcedures), 
                              __classid(Access_2k::TAllDatabaseDiagrams), 
                              __classid(Access_2k::TCurrentProject), 
                              __classid(Access_2k::TCurrentData), 
                              __classid(Access_2k::TCodeProject), 
                              __classid(Access_2k::TCodeData), 
                              __classid(Access_2k::TDefaultWebOptions), 
                              __classid(Access_2k::TAccessWebOptions)
                           };
