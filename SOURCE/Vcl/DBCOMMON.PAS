...
function AddParamSQLForDetail(Params: TParams; SQL: string; Native: Boolean): string;
...
const
  ...
  begin
    ...
    begin
      ...
      if Native then
        Result := Result + format('%s = ?', [Params[I].Name])
      else
        Result := Result + format('%s = :%s', [Params[I].Name, Params[I].Name]);
    end;
