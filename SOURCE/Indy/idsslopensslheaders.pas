...
const
  ...
  OPENSSL_BIO_FLAGS_RWS = OPENSSL_BIO_FLAGS_READ or OPENSSL_BIO_FLAGS_WRITE or
  ...
  OPENSSL_BN_DEC_FMT1 = '%lu'; {Do not localize} {Do not localize}
  OPENSSL_BN_DEC_FMT2 = '%09lu'; {Do not localize} {Do not localize}
  ...
  OPENSSL_LN_SMIMECapabilities = 'S/MIME Capabilities'; {Do not localize}
    {Do not localize}
  OPENSSL_LN_X500 = 'X500'; {Do not localize} {Do not localize}
  OPENSSL_LN_X509 = 'X509'; {Do not localize} {Do not localize}
  OPENSSL_LN_algorithm = 'algorithm'; {Do not localize} {Do not localize}
  ...
  OPENSSL_LN_basic_constraints = 'X509v3 Basic Constraints'; {Do not localize}
    {Do not localize}
  OPENSSL_LN_bf_cbc = 'bf-cbc'; {Do not localize} {Do not localize}
  OPENSSL_LN_bf_cfb64 = 'bf-cfb'; {Do not localize} {Do not localize}
  ...
  OPENSSL_LN_initials = 'initials'; {Do not localize} {Do not localize}
  ...
  OPENSSL_LN_key_usage = 'X509v3 Key Usage'; {Do not localize} {Do not localize}
  OPENSSL_LN_localKeyID = 'localKeyID'; {Do not localize} {Do not localize}
  OPENSSL_LN_localityName = 'localityName'; {Do not localize} {Do not localize}
  OPENSSL_LN_md2 = 'md2'; {Do not localize} {Do not localize}
  OPENSSL_LN_md2WithRSAEncryption = 'md2WithRSAEncryption'; {Do not localize}
    {Do not localize}
  OPENSSL_LN_md5 = 'md5'; {Do not localize} {Do not localize}
  OPENSSL_LN_md5WithRSA = 'md5WithRSA'; {Do not localize} {Do not localize}
  OPENSSL_LN_md5WithRSAEncryption = 'md5WithRSAEncryption'; {Do not localize}
    {Do not localize}
  OPENSSL_LN_md5_sha1 = 'md5-sha1'; {Do not localize} {Do not localize}
  OPENSSL_LN_mdc2 = 'mdc2'; {Do not localize} {Do not localize}
  OPENSSL_LN_mdc2WithRSA = 'mdc2withRSA'; {Do not localize} {Do not localize}
  ...
  OPENSSL_LN_pbe_WithSHA1And2_Key_TripleDES_CBC =
    'pbeWithSHA1And2-KeyTripleDES-CBC'; {Do not localize}
  OPENSSL_LN_pbe_WithSHA1And3_Key_TripleDES_CBC =
    'pbeWithSHA1And3-KeyTripleDES-CBC'; {Do not localize}
  ...
  OPENSSL_SSL3_CHANGE_CIPHER_CLIENT_READ = OPENSSL_SSL3_CC_CLIENT or
    OPENSSL_SSL3_CC_READ;
  OPENSSL_SSL3_CHANGE_CIPHER_CLIENT_WRITE = OPENSSL_SSL3_CC_CLIENT or
    OPENSSL_SSL3_CC_WRITE;
  OPENSSL_SSL3_CHANGE_CIPHER_SERVER_READ = OPENSSL_SSL3_CC_SERVER or
    OPENSSL_SSL3_CC_READ;
  OPENSSL_SSL3_CHANGE_CIPHER_SERVER_WRITE = OPENSSL_SSL3_CC_SERVER or
    OPENSSL_SSL3_CC_WRITE;
  ...
  OPENSSL_SSL3_RT_MAX_COMPRESSED_LENGTH = 1024 +
    OPENSSL_SSL3_RT_MAX_PLAIN_LENGTH;
  OPENSSL_SSL3_RT_MAX_DATA_SIZE = 1024 * 1024;
  OPENSSL_SSL3_RT_MAX_ENCRYPTED_LENGTH = 1024 +
    OPENSSL_SSL3_RT_MAX_COMPRESSED_LENGTH;
  OPENSSL_SSL3_RT_MAX_EXTRA = 16384;
  OPENSSL_SSL3_RT_MAX_PACKET_SIZE = OPENSSL_SSL3_RT_MAX_ENCRYPTED_LENGTH +
  ...
  OPENSSL_SSL_DEFAULT_CIPHER_LIST =
    'ALL:!ADH:RC4+RSA:+HIGH:+MEDIUM:+LOW:+SSLv2:+EXP'; {Do not localize}
  ...
  OPENSSL_SSL_SESS_CACHE_BOTH = OPENSSL_SSL_SESS_CACHE_CLIENT or
  ...
  OPENSSL_SSL_TXT_IDEA_128_CBC_WITH_MD5 =
    OPENSSL_SSL2_TXT_IDEA_128_CBC_WITH_MD5;
  ...
  OPENSSL_TLS1_TXT_DHE_DSS_EXPORT1024_WITH_DES_CBC_SHA =
    'EXP1024-DHE-DSS-DES-CBC-SHA'; {Do not localize}
  OPENSSL_TLS1_TXT_DHE_DSS_EXPORT1024_WITH_RC4_56_SHA =
    'EXP1024-DHE-DSS-RC4-SHA'; {Do not localize}
...
var
  IdSslCtxSetCipherList: function(arg0: PSSL_CTX; str: PChar): Integer cdecl =
    nil;
  ...
  IdSslCtxUsePrivateKeyFile: function(ctx: PSSL_CTX; const _file: PChar; _type:
    Integer): Integer cdecl = nil;
  IdSslCtxUseCertificateFile: function(ctx: PSSL_CTX; const _file: PChar; _type:
    Integer): Integer cdecl = nil;
  ...
  IdSslCtxSetVerify: procedure(ctx: PSSL_CTX; mode: Integer; arg2: PFunction)
    cdecl = nil;
  IdSslCtxSetDefaultPasswdCb: procedure(ctx: PSSL_CTX; cb: Ppem_password_cb)
    cdecl = nil;
  IdSslCtxSetDefaultPasswdCbUserdata: procedure(ctx: PSSL_CTX; u: Pointer) cdecl
    = nil;
  ...
  IdSslWrite: function(ssl: PSSL; const buf: PChar; num: Integer): Integer cdecl
    = nil;
  ...
  IdSslCtxLoadVerifyLocations: function(ctx: PSSL_CTX; const CAfile: PChar; const
    CApath: PChar): Integer cdecl = nil;
  ...
  IdSslX509StoreCtxGetAppData: function(ctx: PX509_STORE_CTX): Pointer cdecl =
    nil;
  IdSslUCTTimeDecode: function(UCTtime: PASN1_UTCTIME; year: PUShort; month:
    PUShort; day: PUShort; hour: PUShort; min: PUShort; sec: PUShort; tz_hour:
    PInteger; tz_min: PInteger): Integer cdecl = nil;
  IdSslSessionGetId: function(s: PSSL_SESSION; id: PPChar; length: PInteger):
    Integer cdecl = nil;
  IdSslSessionGetIdCtx: function(s: PSSL_SESSION; id: PPChar; length: PInteger):
    Integer cdecl = nil;
  ...
  IdSslX509NameOneline: function(a: PX509_NAME; buf: PChar; size: Integer): PChar
    cdecl = nil;
  IdSslX509NameHash: function(x: PX509_NAME): Cardinal cdecl = nil;
  IdSslX509SetIssuerName: function(x: PX509; name: PX509_NAME): Integer cdecl =
    nil;
  IdSslX509GetIssuerName: function(a: PX509): PX509_NAME cdecl = nil;
  IdSslX509SetSubjectName: function(x: PX509; name: PX509_NAME): Integer cdecl =
    nil;
  IdSslX509GetSubjectName: function(a: PX509): PX509_NAME cdecl = nil;
  IdSslX509Digest: function(data: PX509; _type: PEVP_MD; md: PChar; len:
    PUInteger): Integer cdecl = nil;
  ...
  IdSslX509StoreCtxGetError: function(ctx: PX509_STORE_CTX): Integer cdecl =
    nil;
  IdSslX509StoreCtxSetError: procedure(ctx: PX509_STORE_CTX; s: Integer) cdecl =
    nil;
  IdSslX509StoreCtxGetErrorDepth: function(ctx: PX509_STORE_CTX): Integer cdecl
    = nil;
  IdSslX509StoreCtxGetCurrentCert: function(ctx: PX509_STORE_CTX): PX509 cdecl =
    nil;
...
const
  ...
  fn_PEM_read_NETSCAPE_CERT_SEQUENCE = 'PEM_read_NETSCAPE_CERT_SEQUENCE';
    {Do not localize}
  fn_PEM_write_bio_NETSCAPE_CERT_SEQUENCE =
    'PEM_write_bio_NETSCAPE_CERT_SEQUENCE'; {Do not localize}
  ...
  fn_SSL_set_app_data = 'SSL_set_app_data_indy'; {Do not localize}
  fn_SSL_get_app_data = 'SSL_get_app_data_indy'; {Do not localize}
  fn_SSL_CTX_set_info_callback = 'SSL_CTX_set_info_callback_indy';
    {Do not localize}
...
begin
  FceName := FceName + #0;
  Result := GetProcAddress(hIdSSLLib, @FceName[1]);
end;
...
begin
  ...
  if hIdSSL = 0 then
    ...
    Exit;
  if hIdSSLLib = 0 then
    hIdSSLLib := LoadLibrary(SSLCLIB_DLL_name)
  else
    Exit;
  ...
  @IdSslCtxSetDefaultPasswdCbUserdata :=
    LoadFunction(fn_SSL_CTX_set_default_passwd_cb_userdata);
  ...
  @IdSslCtxLoadVerifyLocations :=
    LoadFunction(fn_SSL_CTX_load_verify_locations);
  ...
  @IdSslX509StoreCtxGetErrorDepth :=
    LoadFunctionCLib(fn_X509_STORE_CTX_get_error_depth);
  @IdSslX509StoreCtxGetCurrentCert :=
    LoadFunctionCLib(fn_X509_STORE_CTX_get_current_cert);
...
begin
  ...
  begin
    ...
    if @IdSslEvpMd5 = nil then
      result := result + ' ' + fn_EVP_md5; {Do not localize}
    if @IdSslX509StoreCtxGetError = nil then
      result := result + ' ' + fn_X509_STORE_CTX_get_error; {Do not localize}
    if @IdSslX509StoreCtxSetError = nil then
      result := result + ' ' + fn_X509_STORE_CTX_set_error; {Do not localize}
    if @IdSslX509StoreCtxGetErrorDepth = nil then
      result := result + ' ' + fn_X509_STORE_CTX_get_error_depth; {Do not localize}
    if @IdSslX509StoreCtxGetCurrentCert = nil then
      result := result + ' ' + fn_X509_STORE_CTX_get_current_cert;
      {Do not localize}

    if @IdSslX509Digest = nil then
      result := result + ' ' + fn_X509_digest; {Do not localize}

    if @IdSslX509NameOneline = nil then
      result := result + ' ' + fn_X509_NAME_oneline; {Do not localize}
    if @IdSslX509SetIssuerName = nil then
      result := result + ' ' + fn_X509_set_issuer_name; {Do not localize}
    if @IdSslX509GetIssuerName = nil then
      result := result + ' ' + fn_X509_get_issuer_name; {Do not localize}
    if @IdSslX509SetSubjectName = nil then
      result := result + ' ' + fn_X509_set_subject_name; {Do not localize}
    if @IdSslX509GetSubjectName = nil then
      result := result + ' ' + fn_X509_get_subject_name; {Do not localize}
    if @IdSslX509NameHash = nil then
      result := result + ' ' + fn_X509_NAME_hash; {Do not localize}
    if @IdSslCtxSetCipherList = nil then
      result := result + ' ' + fn_SSL_CTX_set_cipher_list; {Do not localize}
    if @IdSslCtxNew = nil then
      result := result + ' ' + fn_SSL_CTX_new; {Do not localize}
    if @IdSslCtxFree = nil then
      result := result + ' ' + fn_SSL_CTX_free; {Do not localize}
    if @IdSslSetFd = nil then
      result := result + ' ' + fn_SSL_set_fd; {Do not localize}
    if @IdSslCtxUsePrivateKeyFile = nil then
      result := result + ' ' + fn_SSL_CTX_use_PrivateKey_file; {Do not localize}
    if @IdSslCtxUseCertificateFile = nil then
      result := result + ' ' + fn_SSL_CTX_use_certificate_file; {Do not localize}
    if @IdSslLoadErrorStrings = nil then
      result := result + ' ' + fn_SSL_load_error_strings; {Do not localize}
    if @IdSslStateStringLong = nil then
      result := result + ' ' + fn_SSL_state_string_long; {Do not localize}
    if @IdSslGetPeerCertificate = nil then
      result := result + ' ' + fn_SSL_get_peer_certificate; {Do not localize}
    if @IdSslCtxSetVerify = nil then
      result := result + ' ' + fn_SSL_CTX_set_verify; {Do not localize}
    if @IdSslCtxSetDefaultPasswdCb = nil then
      result := result + ' ' + fn_SSL_CTX_set_default_passwd_cb; {Do not localize}
    if @IdSslCtxSetDefaultPasswdCbUserdata = nil then
      result := result + ' ' + fn_SSL_CTX_set_default_passwd_cb_userdata;
      {Do not localize}
    if @IdSslCtxCheckPrivateKeyFile = nil then
      result := result + ' ' + fn_SSL_CTX_check_private_key; {Do not localize}
    if @IdSslNew = nil then
      result := result + ' ' + fn_SSL_new; {Do not localize}
    if @IdSslFree = nil then
      result := result + ' ' + fn_SSL_free; {Do not localize}
    if @IdSslAccept = nil then
      result := result + ' ' + fn_SSL_accept; {Do not localize}
    if @IdSslConnect = nil then
      result := result + ' ' + fn_SSL_connect; {Do not localize}
    if @IdSslRead = nil then
      result := result + ' ' + fn_SSL_read; {Do not localize}
    if @IdSslPeek = nil then
      result := result + ' ' + fn_SSL_peek; {Do not localize}
    if @IdSslWrite = nil then
      result := result + ' ' + fn_SSL_write; {Do not localize}
    if @IdSslGetError = nil then
      result := result + ' ' + fn_SSL_get_error; {Do not localize}
    if @IdSslMethodV2 = nil then
      result := result + ' ' + fn_SSLv2_method; {Do not localize}
    if @IdSslMethodServerV2 = nil then
      result := result + ' ' + fn_SSLv2_server_method; {Do not localize}
    if @IdSslMethodClientV2 = nil then
      result := result + ' ' + fn_SSLv2_client_method; {Do not localize}
    if @IdSslMethodV3 = nil then
      result := result + ' ' + fn_SSLv3_method; {Do not localize}
    if @IdSslMethodServerV3 = nil then
      result := result + ' ' + fn_SSLv3_server_method; {Do not localize}
    if @IdSslMethodClientV3 = nil then
      result := result + ' ' + fn_SSLv3_client_method; {Do not localize}
    if @IdSslMethodV23 = nil then
      result := result + ' ' + fn_SSLv23_method; {Do not localize}
    if @IdSslMethodServerV23 = nil then
      result := result + ' ' + fn_SSLv23_server_method; {Do not localize}
    if @IdSslMethodClientV23 = nil then
      result := result + ' ' + fn_SSLv23_client_method; {Do not localize}
    if @IdSslMethodTLSV1 = nil then
      result := result + ' ' + fn_TLSv1_method; {Do not localize}
    if @IdSslMethodServerTLSV1 = nil then
      result := result + ' ' + fn_TLSv1_server_method; {Do not localize}
    if @IdSslMethodClientTLSV1 = nil then
      result := result + ' ' + fn_TLSv1_client_method; {Do not localize}
    if @IdSslShutdown = nil then
      result := result + ' ' + fn_SSL_shutdown; {Do not localize}
    if @IdSslSetConnectState = nil then
      result := result + ' ' + fn_SSL_set_connect_state; {Do not localize}
    if @IdSslSetAcceptState = nil then
      result := result + ' ' + fn_SSL_set_accept_state; {Do not localize}
    if @IdSslSetShutdown = nil then
      result := result + ' ' + fn_SSL_set_shutdown; {Do not localize}
    if @IdSslCtxLoadVerifyLocations = nil then
      result := result + ' ' + fn_SSL_CTX_load_verify_locations; {Do not localize}
    if @IdSslGetSession = nil then
      result := result + ' ' + fn_SSL_get_session; {Do not localize}
    if @IdSslAddSslAlgorithms = nil then
      result := result + ' ' + fn_SSLeay_add_ssl_algorithms; {Do not localize}
    if @IdSslSetAppData = nil then
      result := result + ' ' + fn_SSL_set_app_data; {Do not localize}
    if @IdSslGetAppData = nil then
      result := result + ' ' + fn_SSL_get_app_data; {Do not localize}
    if @IdSslCtxSetInfoCallback = nil then
      result := result + ' ' + fn_SSL_CTX_set_info_callback; {Do not localize}
    if @IdSslX509StoreCtxGetAppData = nil then
      result := result + ' ' + fn_X509_STORE_CTX_get_app_data; {Do not localize}
    if @IdSslX509GetNotBefore = nil then
      result := result + ' ' + fn_X509_get_notBefore; {Do not localize}
    if @IdSslX509GetNotAfter = nil then
      result := result + ' ' + fn_X509_get_notAfter; {Do not localize}
    if @IdSslUCTTimeDecode = nil then
      result := result + ' ' + fn_UCTTimeDecode; {Do not localize}
    if @IdSslSessionGetId = nil then
      result := result + ' ' + fn_SSL_SESSION_get_id; {Do not localize}
    if @IdSslSessionGetIdCtx = nil then
      result := result + ' ' + fn_SSL_SESSION_get_id_ctx; {Do not localize}
    if @IdSslCtxGetVersion = nil then
      result := result + ' ' + fn_SSL_CTX_get_version; {Do not localize}
    if @IdSslCtxSetOptions = nil then
      result := result + ' ' + fn_SSL_CTX_set_options; {Do not localize}
