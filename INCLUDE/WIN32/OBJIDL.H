...
#if defined(__BORLANDC__) && !defined(__cplusplus) && (_WIN32_WINNT < 0x0400)
  /* This satisfies the undefined forward reference to these structures */
  struct IChannelHook    { int dummy; };
  struct IClientSecurity { int dummy; };
  struct IServerSecurity { int dummy; };
  struct IClassActivator { int dummy; };
#endif
