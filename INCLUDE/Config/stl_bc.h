...
#   ifdef _MT
#    ifdef _RTLDLL
#      pragma comment(lib,"stlpmt_stldebugi.lib")
#    else
#     pragma comment(lib,"stlpmt_stldebug.lib")
#    endif
#   else
#    ifdef _RTLDLL
#      pragma comment(lib,"stlp_stldebugi.lib")
#    else
#     pragma comment(lib,"stlp_stldebug.lib")
#    endif
#   endif
#  else
#   ifdef _MT
