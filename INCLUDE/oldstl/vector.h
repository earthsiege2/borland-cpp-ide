...
#include <oldstl/iterator>
#include <oldstl/memory>
#include <oldstl/stdexcept>
...
#else
    typedef allocator_type::template rebind<unsigned int>::other __value_alloc_type;
#endif
#else
