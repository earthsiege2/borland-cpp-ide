...
// (DO NOT EDIT: machine generated header) 'XMLBrokr.pas' rev: 6.00
...
{
//-- type declarations -------------------------------------------------------
typedef void __fastcall (__closure *TRequestRecordsEvent)(System::TObject* Sender, Httpapp::TWebRequest* Request, /* out */ int &RecCount, OleVariant &OwnerData, AnsiString &Records);

typedef void __fastcall (__closure *TRequestUpdateEvent)(System::TObject* Sender, Httpapp::TWebRequest* Request, Httpapp::TWebResponse* Response, bool &Handled);

typedef void __fastcall (__closure *TGetErrorResponseEvent)(System::TObject* Sender, int ErrorCount, AnsiString XMLErrors, Httpapp::TWebRequest* Request, Httpapp::TWebResponse* Response, bool &Handled);

typedef void __fastcall (__closure *TGetResponseEvent)(System::TObject* Sender, Httpapp::TWebRequest* Request, Httpapp::TWebResponse* Response, bool &Handled);
...
public:
	...
	/* TParams.Create */ inline __fastcall TXMLParams(Classes::TPersistent* Owner)/* overload */ : Db::TParams(Owner) { }
	#pragma option pop
...
protected:
	...
	OleVariant __fastcall AS_GetRecords(int Count, /* out */ int &RecsOut, int Options, const WideString CommandText, const OleVariant &Params, OleVariant &OwnerData);
	OleVariant __fastcall AS_ApplyUpdates(const OleVariant &Delta, int MaxErrors, /* out */ int &ErrorCount);
	Classes::TStream* __fastcall GetXMLStream(bool &Owned);
	...
	bool __fastcall GetErrorResponse(int ErrorCount, AnsiString XMLErrors, Httpapp::TWebRequest* Request, Httpapp::TWebResponse* Response);
...
public:
	...
	virtual AnsiString __fastcall RequestRecords(System::TObject* Sender, Httpapp::TWebRequest* Request, /* out */ int &RecCount, OleVariant &OwnerData, TXMLOptions XMLOptions);
	virtual bool __fastcall RequestUpdate(System::TObject* Sender, Httpapp::TWebRequest* Request, Httpapp::TWebResponse* Response);
...
private:
	...
	void *__IGetXMLStream;	/* Webcomp::IGetXMLStream */
	
public:
	operator IGetXMLStream*(void) { return (IGetXMLStream*)&__IGetXMLStream; }
...
__interface INTERFACE_UUID("{0BC29A90-0EEC-11D3-AFED-00C04FB16EC3}") INotifyConnectionChange  : public IInterface 
{
