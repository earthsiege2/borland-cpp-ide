...
// (DO NOT EDIT: machine generated header) 'DRIntf.pas' rev: 6.00
...
extern PACKAGE AnsiString __fastcall QualifyTableName(Dbtables::TDatabase* Database, const AnsiString TableName);
extern PACKAGE AnsiString __fastcall QualifyTableNameByName(const AnsiString SessionName, const AnsiString DatabaseName, const AnsiString TableName);
...
extern PACKAGE TAttrID __fastcall NewAttr(Db::TField* Field, const TFieldID &FieldID, const AnsiString AttrName, const TAttrID &Parent);
extern PACKAGE void __fastcall UpdateAttr(Db::TField* Field, const TFieldID &FieldID, const TAttrID &AttrID);
extern PACKAGE void __fastcall UpdateField(Db::TField* Field, const TFieldID &FieldID, const TAttrID &AttrID);
extern PACKAGE Db::TField* __fastcall CreateField(Classes::TComponent* Owner, Db::TDataSet* Dataset, const AnsiString FullName, const AnsiString Origin, const TFieldID &FieldID, const TAttrID &AttrID);
...
extern PACKAGE void __fastcall UpdateConstraints(Dbtables::TDBDataSet* Dataset, Db::TCheckConstraints* Constraints);
