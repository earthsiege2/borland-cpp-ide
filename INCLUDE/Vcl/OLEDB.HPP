...
// (DO NOT EDIT: machine generated header) 'OleDB.pas' rev: 6.00
...
typedef System::PByte *PPByteArray;
...
__interface INTERFACE_UUID("{0FB15084-AF41-11CE-BD2B-204C4F4F5020}") ITransaction  : public IInterface 
{
	
public:
	virtual HRESULT __stdcall Commit(BOOL fRetaining, unsigned grfTC, unsigned grfRM) = 0 ;
	virtual HRESULT __stdcall Abort(PBoid pboidReason, BOOL fRetaining, BOOL fAsync) = 0 ;
	virtual HRESULT __stdcall GetTransactionInfo(/* out */ XACTTRANSINFO &pinfo) = 0 ;
};

__interface ITransactionSC;
typedef System::DelphiInterface<ITransactionSC> _di_ITransactionSC;
__interface INTERFACE_UUID("{0FB15084-AF41-11CE-BD2B-204C4F4F5020}") ITransactionSC  : public IInterface 
{
	
public:
	virtual HRESULT __safecall Commit(BOOL fRetaining, unsigned grfTC, unsigned grfRM) = 0 ;
	virtual HRESULT __safecall Abort(PBoid pboidReason, BOOL fRetaining, BOOL fAsync) = 0 ;
...
__interface INTERFACE_UUID("{3A6AD9E0-23B9-11CF-AD60-00AA00A74CCD}") ITransactionOptions  : public IInterface 
{
...
__interface INTERFACE_UUID("{3A6AD9E0-23B9-11CF-AD60-00AA00A74CCD}") ITransactionOptionsSC  : public IInterface 
{
...
__interface INTERFACE_UUID("{3A6AD9E1-23B9-11CF-AD60-00AA00A74CCD}") ITransactionDispenser  : public IInterface 
{
...
__interface INTERFACE_UUID("{3A6AD9E1-23B9-11CF-AD60-00AA00A74CCD}") ITransactionDispenserSC  : public IInterface 
{
...
__interface INTERFACE_UUID("{3A6AD9E2-23B9-11CF-AD60-00AA00A74CCD}") ITransactionOutcomeEvents  : public IInterface 
{
...
__interface INTERFACE_UUID("{3A6AD9E2-23B9-11CF-AD60-00AA00A74CCD}") ITransactionOutcomeEventsSC  : public IInterface 
{
...
__interface INTERFACE_UUID("{0C733A8C-2A1C-11CE-ADE5-00AA0044773D}") IAccessor  : public IInterface 
{
	
public:
	virtual HRESULT __stdcall AddRefAccessor(unsigned HACCESSOR, PUINT pcRefCount) = 0 ;
	virtual HRESULT __stdcall CreateAccessor(unsigned dwAccessorFlags, unsigned cBindings, PDBBindingArray rgBindings, unsigned cbRowSize, unsigned &phAccessor, PUintArray rgStatus) = 0 ;
	virtual HRESULT __stdcall GetBindings(unsigned HACCESSOR, PUINT pdwAccessorFlags, unsigned &pcBindings, /* out */ PDBBinding &prgBindings) = 0 ;
...
__interface INTERFACE_UUID("{0C733A8C-2A1C-11CE-ADE5-00AA0044773D}") IAccessorSC  : public IInterface 
{
	
public:
	virtual HRESULT __safecall AddRefAccessor(unsigned HACCESSOR, PUINT pcRefCount) = 0 ;
	virtual HRESULT __safecall CreateAccessor(unsigned dwAccessorFlags, unsigned cBindings, PDBBindingArray rgBindings, unsigned cbRowSize, unsigned &phAccessor, PUintArray rgStatus) = 0 ;
	virtual HRESULT __safecall GetBindings(unsigned HACCESSOR, PUINT pdwAccessorFlags, unsigned &pcBindings, /* out */ PDBBinding &prgBindings) = 0 ;
...
__interface INTERFACE_UUID("{0C733A7C-2A1C-11CE-ADE5-00AA0044773D}") IRowset  : public IInterface 
{
	
public:
	virtual HRESULT __stdcall AddRefRows(unsigned cRows, PUintArray rghRows, PUintArray rgRefCounts, PUintArray rgRowStatus) = 0 ;
	virtual HRESULT __stdcall GetData(unsigned HROW, unsigned HACCESSOR, void * pData) = 0 ;
	virtual HRESULT __stdcall GetNextRows(unsigned hReserved, int lRowsOffset, int cRows, /* out */ unsigned &pcRowsObtained, PUintArray &prghRows) = 0 ;
	virtual HRESULT __stdcall ReleaseRows(unsigned cRows, PUintArray rghRows, PUintArray rgRowOptions, PUintArray rgRefCounts, PUintArray rgRowStatus) = 0 ;
...
__interface INTERFACE_UUID("{0C733A7C-2A1C-11CE-ADE5-00AA0044773D}") IRowsetSC  : public IInterface 
{
	
public:
	virtual HRESULT __safecall AddRefRows(unsigned cRows, PUintArray rghRows, PUintArray rgRefCounts, PUintArray rgRowStatus) = 0 ;
	virtual HRESULT __safecall GetData(unsigned HROW, unsigned HACCESSOR, void * pData) = 0 ;
	virtual HRESULT __safecall GetNextRows(unsigned hReserved, int lRowsOffset, int cRows, /* out */ unsigned &pcRowsObtained, PUintArray &prghRows) = 0 ;
	virtual HRESULT __safecall ReleaseRows(unsigned cRows, PUintArray rghRows, PUintArray rgRowOptions, PUintArray rgRefCounts, PUintArray rgRowStatus) = 0 ;
...
__interface INTERFACE_UUID("{0C733A55-2A1C-11CE-ADE5-00AA0044773D}") IRowsetInfo  : public IInterface 
{
...
public:
	...
	virtual HRESULT __stdcall GetReferencedRowset(unsigned iOrdinal, const GUID &riid, /* out */ System::_di_IInterface &ppReferencedRowset) = 0 ;
...
__interface INTERFACE_UUID("{0C733A55-2A1C-11CE-ADE5-00AA0044773D}") IRowsetInfoSC  : public IInterface 
{
...
public:
	...
	virtual HRESULT __safecall GetReferencedRowset(unsigned iOrdinal, const GUID &riid, /* out */ System::_di_IInterface &ppReferencedRowset) = 0 ;
...
public:
	virtual HRESULT __stdcall Compare(unsigned hReserved, unsigned cbBookmark1, System::PByte pBookmark1, unsigned cbBookmark2, System::PByte pBookmark2, /* out */ unsigned &pComparison) = 0 ;
	virtual HRESULT __stdcall GetRowsAt(unsigned hReserved1, unsigned hReserved2, unsigned cbBookmark, System::PByte pBookmark, int lRowsOffset, int cRows, /* out */ unsigned &pcRowsObtained, /* out */ PHROW &prghRows) = 0 ;
	virtual HRESULT __stdcall GetRowsByBookmark(unsigned hReserved, unsigned cRows, PUintArray rgcbBookmarks, PPByteArray rgpBookmarks, PUintArray rghRows, PUintArray rgRowStatus) = 0 ;
	virtual HRESULT __stdcall Hash(unsigned hReserved, unsigned cBookmarks, PUintArray rgcbBookmarks, PPByteArray rgpBookmarks, PUintArray rgHashedValues, PUintArray rgBookmarkStatus) = 0 ;
};
...
public:
	virtual HRESULT __safecall Compare(unsigned hReserved, unsigned cbBookmark1, System::PByte pBookmark1, unsigned cbBookmark2, System::PByte pBookmark2, /* out */ unsigned &pComparison) = 0 ;
	virtual HRESULT __safecall GetRowsAt(unsigned hReserved1, unsigned hReserved2, unsigned cbBookmark, System::PByte pBookmark, int lRowsOffset, int cRows, /* out */ unsigned &pcRowsObtained, /* out */ PHROW &prghRows) = 0 ;
	virtual HRESULT __safecall GetRowsByBookmark(unsigned hReserved, unsigned cRows, PUintArray rgcbBookmarks, PPByteArray rgpBookmarks, PUintArray rghRows, PUintArray rgRowStatus) = 0 ;
	virtual HRESULT __safecall Hash(unsigned hReserved, unsigned cBookmarks, PUintArray rgcbBookmarks, PPByteArray rgpBookmarks, PUintArray rgHashedValues, PUintArray rgBookmarkStatus) = 0 ;
};

__interface IRowsetResynch;
typedef System::DelphiInterface<IRowsetResynch> _di_IRowsetResynch;
__interface INTERFACE_UUID("{0C733A84-2A1C-11CE-ADE5-00AA0044773D}") IRowsetResynch  : public IInterface 
{
	
public:
	virtual HRESULT __stdcall GetVisibleData(unsigned HROW, unsigned HACCESSOR, /* out */ void * &pData) = 0 ;
	virtual HRESULT __stdcall ResynchRows(unsigned cRows, PUintArray rghRows, PUINT pcRowsResynched, /* out */ PHROW &prghRowsResynched, PPDBROWSTATUS prgRowStatus) = 0 ;
};

__interface IRowsetResynchSC;
typedef System::DelphiInterface<IRowsetResynchSC> _di_IRowsetResynchSC;
__interface INTERFACE_UUID("{0C733A84-2A1C-11CE-ADE5-00AA0044773D}") IRowsetResynchSC  : public IInterface 
{
	
public:
	virtual HRESULT __safecall GetVisibleData(unsigned HROW, unsigned HACCESSOR, /* out */ void * &pData) = 0 ;
	virtual HRESULT __safecall ResynchRows(unsigned cRows, PUintArray rghRows, PUINT pcRowsResynched, /* out */ PHROW &prghRowsResynched, PPDBROWSTATUS prgRowStatus) = 0 ;
};
...
public:
	virtual HRESULT __stdcall GetApproximatePosition(unsigned hReserved, unsigned cbBookmark, System::PByte pBookmark, PUINT pulPosition, PUINT pcRows) = 0 ;
	virtual HRESULT __stdcall GetRowsAtRatio(unsigned hReserved1, unsigned hReserved2, unsigned ulNumerator, unsigned ulDenominator, int cRows, /* out */ unsigned &pcRowsObtained, PHROW &prghRows) = 0 ;
};
...
public:
	virtual HRESULT __safecall GetApproximatePosition(unsigned hReserved, unsigned cbBookmark, System::PByte pBookmark, PUINT pulPosition, PUINT pcRows) = 0 ;
	virtual HRESULT __safecall GetRowsAtRatio(unsigned hReserved1, unsigned hReserved2, unsigned ulNumerator, unsigned ulDenominator, int cRows, /* out */ unsigned &pcRowsObtained, PHROW &prghRows) = 0 ;
};

__interface IRowsetChange;
typedef System::DelphiInterface<IRowsetChange> _di_IRowsetChange;
__interface INTERFACE_UUID("{0C733A05-2A1C-11CE-ADE5-00AA0044773D}") IRowsetChange  : public IInterface 
{
	
public:
	virtual HRESULT __stdcall DeleteRows(unsigned hReserved, unsigned cRows, PUintArray rghRows, PUintArray rgRowStatus) = 0 ;
	virtual HRESULT __stdcall SetData(unsigned HROW, unsigned HACCESSOR, void * pData) = 0 ;
	virtual HRESULT __stdcall InsertRow(unsigned hReserved, unsigned HACCESSOR, void * pData, PHROW phRow) = 0 ;
};

__interface IRowsetChangeSC;
typedef System::DelphiInterface<IRowsetChangeSC> _di_IRowsetChangeSC;
__interface INTERFACE_UUID("{0C733A05-2A1C-11CE-ADE5-00AA0044773D}") IRowsetChangeSC  : public IInterface 
{
	
public:
	virtual HRESULT __safecall DeleteRows(unsigned hReserved, unsigned cRows, PUintArray rghRows, PUintArray rgRowStatus) = 0 ;
	virtual HRESULT __safecall SetData(unsigned HROW, unsigned HACCESSOR, void * pData) = 0 ;
	virtual HRESULT __safecall InsertRow(unsigned hReserved, unsigned HACCESSOR, void * pData, PHROW phRow) = 0 ;
};
...
public:
	...
	virtual HRESULT __stdcall GetPendingRows(unsigned hReserved, unsigned dwRowStatus, PUINT pcPendingRows, PPHROW prgPendingRows, PPDBPENDINGSTATUS prgPendingStatus) = 0 ;
	virtual HRESULT __stdcall GetRowStatus(unsigned hReserved, unsigned cRows, PUintArray rghRows, PUintArray rgPendingStatus) = 0 ;
	virtual HRESULT __stdcall Undo(unsigned hReserved, unsigned cRows, PUintArray rghRows, PUINT pcRowsUndone, PPHROW prgRowsUndone, PPDBROWSTATUS prgRowStatus) = 0 ;
	virtual HRESULT __stdcall Update(unsigned hReserved, unsigned cRows, PUintArray rghRows, PUINT pcRows, PPHROW prgRows, PPDBROWSTATUS prgRowStatus) = 0 ;
};
...
public:
	...
	virtual HRESULT __safecall GetPendingRows(unsigned hReserved, unsigned dwRowStatus, PUINT pcPendingRows, PPHROW prgPendingRows, PPDBPENDINGSTATUS prgPendingStatus) = 0 ;
	virtual HRESULT __safecall GetRowStatus(unsigned hReserved, unsigned cRows, PUintArray rghRows, PUintArray rgPendingStatus) = 0 ;
	virtual HRESULT __safecall Undo(unsigned hReserved, unsigned cRows, PUintArray rghRows, PUINT pcRowsUndone, PPHROW prgRowsUndone, PPDBROWSTATUS prgRowStatus) = 0 ;
	virtual HRESULT __safecall Update(unsigned hReserved, unsigned cRows, PUintArray rghRows, PUINT pcRows, PPHROW prgRows, PPDBROWSTATUS prgRowStatus) = 0 ;
};

__interface IRowsetIndex;
typedef System::DelphiInterface<IRowsetIndex> _di_IRowsetIndex;
__interface INTERFACE_UUID("{0C733A82-2A1C-11CE-ADE5-00AA0044773D}") IRowsetIndex  : public IInterface 
{
	
public:
	virtual HRESULT __stdcall GetIndexInfo(unsigned &pcKeyColumns, /* out */ PDBIndexColumnDesc &prgIndexColumnDesc, unsigned &pcIndexProperties, /* out */ PDBPropSet &prgIndexProperties) = 0 ;
	virtual HRESULT __stdcall Seek(unsigned HACCESSOR, unsigned cKeyValues, void * pData, unsigned dwSeekOptions) = 0 ;
	virtual HRESULT __stdcall SetRange(unsigned HACCESSOR, unsigned cStartKeyColumns, void * pStartData, unsigned cEndKeyColumns, void * pEndData, unsigned dwRangeOptions) = 0 ;
};

__interface IRowsetIndexSC;
typedef System::DelphiInterface<IRowsetIndexSC> _di_IRowsetIndexSC;
__interface INTERFACE_UUID("{0C733A82-2A1C-11CE-ADE5-00AA0044773D}") IRowsetIndexSC  : public IInterface 
{
	
public:
	virtual HRESULT __safecall GetIndexInfo(unsigned &pcKeyColumns, /* out */ PDBIndexColumnDesc &prgIndexColumnDesc, unsigned &pcIndexProperties, /* out */ PDBPropSet &prgIndexProperties) = 0 ;
	virtual HRESULT __safecall Seek(unsigned HACCESSOR, unsigned cKeyValues, void * pData, unsigned dwSeekOptions) = 0 ;
	virtual HRESULT __safecall SetRange(unsigned HACCESSOR, unsigned cStartKeyColumns, void * pStartData, unsigned cEndKeyColumns, void * pEndData, unsigned dwRangeOptions) = 0 ;
};

__interface IMultipleResults;
typedef System::DelphiInterface<IMultipleResults> _di_IMultipleResults;
__interface INTERFACE_UUID("{0C733A90-2A1C-11CE-ADE5-00AA0044773D}") IMultipleResults  : public IInterface 
{
	
public:
	virtual HRESULT __stdcall GetResult(const System::_di_IInterface punkOuter, int reserved, const GUID &riid, System::PInteger pcRowsAffected, PIUnknown ppRowset) = 0 ;
};

__interface IMultipleResultsSC;
typedef System::DelphiInterface<IMultipleResultsSC> _di_IMultipleResultsSC;
__interface INTERFACE_UUID("{0C733A90-2A1C-11CE-ADE5-00AA0044773D}") IMultipleResultsSC  : public IInterface 
{
	
public:
	virtual HRESULT __safecall GetResult(const System::_di_IInterface punkOuter, int reserved, const GUID &riid, System::PInteger pcRowsAffected, PIUnknown ppRowset) = 0 ;
};

__interface IConvertType;
typedef System::DelphiInterface<IConvertType> _di_IConvertType;
__interface INTERFACE_UUID("{0C733A88-2A1C-11CE-ADE5-00AA0044773D}") IConvertType  : public IInterface 
{
...
__interface INTERFACE_UUID("{0C733A88-2A1C-11CE-ADE5-00AA0044773D}") IConvertTypeSC  : public IInterface 
{
...
__interface INTERFACE_UUID("{0C733A26-2A1C-11CE-ADE5-00AA0044773D}") ICommandPrepare  : public IInterface 
{
...
__interface INTERFACE_UUID("{0C733A26-2A1C-11CE-ADE5-00AA0044773D}") ICommandPrepareSC  : public IInterface 
{
...
__interface INTERFACE_UUID("{0C733A79-2A1C-11CE-ADE5-00AA0044773D}") ICommandProperties  : public IInterface 
{
...
__interface INTERFACE_UUID("{0C733A79-2A1C-11CE-ADE5-00AA0044773D}") ICommandPropertiesSC  : public IInterface 
{
...
__interface INTERFACE_UUID("{0C733A63-2A1C-11CE-ADE5-00AA0044773D}") ICommand  : public IInterface 
{
	
public:
	virtual HRESULT __stdcall Cancel(void) = 0 ;
	virtual HRESULT __stdcall Execute(const System::_di_IInterface punkOuter, const GUID &riid, DBPARAMS &pParams, System::PInteger pcRowsAffected, PIUnknown ppRowset) = 0 ;
...
__interface INTERFACE_UUID("{0C733A63-2A1C-11CE-ADE5-00AA0044773D}") ICommandSC  : public IInterface 
{
	
public:
	virtual HRESULT __safecall Cancel(void) = 0 ;
	virtual HRESULT __safecall Execute(const System::_di_IInterface punkOuter, const GUID &riid, DBPARAMS &pParams, System::PInteger pcRowsAffected, PIUnknown ppRowset) = 0 ;
...
__interface INTERFACE_UUID("{0C733A64-2A1C-11CE-ADE5-00AA0044773D}") ICommandWithParameters  : public IInterface 
{
	
public:
	virtual HRESULT __stdcall GetParameterInfo(unsigned &pcParams, /* out */ PDBParamInfo &prgParamInfo, Activex::PPOleStr ppNamesBuffer) = 0 ;
	virtual HRESULT __stdcall MapParameterNames(unsigned cParamNames, Activex::POleStrList rgParamNames, PUintArray rgParamOrdinals) = 0 ;
	virtual HRESULT __stdcall SetParameterInfo(unsigned cParams, PUintArray rgParamOrdinals, PDBParamBindInfoArray rgParamBindInfo) = 0 ;
};

__interface ICommandWithParametersSC;
typedef System::DelphiInterface<ICommandWithParametersSC> _di_ICommandWithParametersSC;
__interface INTERFACE_UUID("{0C733A64-2A1C-11CE-ADE5-00AA0044773D}") ICommandWithParametersSC  : public IInterface 
{
	
public:
	virtual HRESULT __safecall GetParameterInfo(unsigned &pcParams, /* out */ PDBParamInfo &prgParamInfo, Activex::PPOleStr ppNamesBuffer) = 0 ;
	virtual HRESULT __safecall MapParameterNames(unsigned cParamNames, Activex::POleStrList rgParamNames, PUintArray rgParamOrdinals) = 0 ;
	virtual HRESULT __safecall SetParameterInfo(unsigned cParams, PUintArray rgParamOrdinals, PDBParamBindInfoArray rgParamBindInfo) = 0 ;
};
...
public:
	...
	virtual HRESULT __stdcall SetCommandText(const GUID &guidDialect, wchar_t * pwszCommand) = 0 ;
};
...
public:
	...
	virtual HRESULT __safecall SetCommandText(const GUID &guidDialect, wchar_t * pwszCommand) = 0 ;
};

__interface IColumnsRowset;
typedef System::DelphiInterface<IColumnsRowset> _di_IColumnsRowset;
__interface INTERFACE_UUID("{0C733A10-2A1C-11CE-ADE5-00AA0044773D}") IColumnsRowset  : public IInterface 
{
	
public:
	virtual HRESULT __stdcall GetAvailableColumns(unsigned &pcOptColumns, PDBID &prgOptColumns) = 0 ;
	virtual HRESULT __stdcall GetColumnsRowset(const System::_di_IInterface punkOuter, unsigned cOptColumns, PDBIDArray rgOptColumns, const GUID &riid, unsigned cPropertySets, PDBPropSetArray rgPropertySets, /* out */ System::_di_IInterface &pColRowset) = 0 ;
};

__interface IColumnsRowsetSC;
typedef System::DelphiInterface<IColumnsRowsetSC> _di_IColumnsRowsetSC;
__interface INTERFACE_UUID("{0C733A10-2A1C-11CE-ADE5-00AA0044773D}") IColumnsRowsetSC  : public IInterface 
{
	
public:
	virtual HRESULT __safecall GetAvailableColumns(unsigned &pcOptColumns, PDBID &prgOptColumns) = 0 ;
	virtual HRESULT __safecall GetColumnsRowset(const System::_di_IInterface punkOuter, unsigned cOptColumns, PDBIDArray rgOptColumns, const GUID &riid, unsigned cPropertySets, PDBPropSetArray rgPropertySets, /* out */ System::_di_IInterface &pColRowset) = 0 ;
};

__interface IColumnsInfo;
typedef System::DelphiInterface<IColumnsInfo> _di_IColumnsInfo;
__interface INTERFACE_UUID("{0C733A11-2A1C-11CE-ADE5-00AA0044773D}") IColumnsInfo  : public IInterface 
{
	
public:
	virtual HRESULT __stdcall GetColumnInfo(unsigned &pcColumns, /* out */ PDBColumnInfo &prgInfo, /* out */ wchar_t * &ppStringsBuffer) = 0 ;
	virtual HRESULT __stdcall MapColumnIDs(unsigned cColumnIDs, PDBIDArray rgColumnIDs, PUintArray rgColumns) = 0 ;
};

__interface IColumnsInfoSC;
typedef System::DelphiInterface<IColumnsInfoSC> _di_IColumnsInfoSC;
__interface INTERFACE_UUID("{0C733A11-2A1C-11CE-ADE5-00AA0044773D}") IColumnsInfoSC  : public IInterface 
{
	
public:
	virtual HRESULT __safecall GetColumnInfo(unsigned &pcColumns, /* out */ PDBColumnInfo &prgInfo, /* out */ wchar_t * &ppStringsBuffer) = 0 ;
	virtual HRESULT __safecall MapColumnIDs(unsigned cColumnIDs, PDBIDArray rgColumnIDs, PUintArray rgColumns) = 0 ;
};

__interface IDBCreateCommand;
typedef System::DelphiInterface<IDBCreateCommand> _di_IDBCreateCommand;
__interface INTERFACE_UUID("{0C733A1D-2A1C-11CE-ADE5-00AA0044773D}") IDBCreateCommand  : public IInterface 
{
...
__interface INTERFACE_UUID("{0C733A1D-2A1C-11CE-ADE5-00AA0044773D}") IDBCreateCommandSC  : public IInterface 
{
...
__interface INTERFACE_UUID("{0C733A5D-2A1C-11CE-ADE5-00AA0044773D}") IDBCreateSession  : public IInterface 
{
...
__interface INTERFACE_UUID("{0C733A5D-2A1C-11CE-ADE5-00AA0044773D}") IDBCreateSessionSC  : public IInterface 
{
...
__interface INTERFACE_UUID("{0C733A1E-2A1C-11CE-ADE5-00AA0044773D}") ISourcesRowset  : public IInterface 
{
...
__interface INTERFACE_UUID("{0C733A1E-2A1C-11CE-ADE5-00AA0044773D}") ISourcesRowsetSC  : public IInterface 
{
...
__interface INTERFACE_UUID("{0C733A8A-2A1C-11CE-ADE5-00AA0044773D}") IDBProperties  : public IInterface 
{
	
public:
	virtual HRESULT __stdcall GetProperties(unsigned cPropertyIDSets, PDBPropIDSetArray rgPropertyIDSets, unsigned &pcPropertySets, /* out */ PDBPropSet &prgPropertySets) = 0 ;
	virtual HRESULT __stdcall GetPropertyInfo(unsigned cPropertyIDSets, PDBPropIDSetArray rgPropertyIDSets, unsigned &pcPropertyInfoSets, /* out */ PDBPropInfoSet &prgPropertyInfoSets, Activex::PPOleStr ppDescBuffer) = 0 ;
	virtual HRESULT __stdcall SetProperties(unsigned cPropertySets, PDBPropSetArray rgPropertySets) = 0 ;
};

__interface IDBPropertiesSC;
typedef System::DelphiInterface<IDBPropertiesSC> _di_IDBPropertiesSC;
__interface INTERFACE_UUID("{0C733A8A-2A1C-11CE-ADE5-00AA0044773D}") IDBPropertiesSC  : public IInterface 
{
	
public:
	virtual HRESULT __safecall GetProperties(unsigned cPropertyIDSets, PDBPropIDSetArray rgPropertyIDSets, unsigned &pcPropertySets, /* out */ PDBPropSet &prgPropertySets) = 0 ;
	virtual HRESULT __safecall GetPropertyInfo(unsigned cPropertyIDSets, PDBPropIDSetArray rgPropertyIDSets, unsigned &pcPropertyInfoSets, /* out */ PDBPropInfoSet &prgPropertyInfoSets, Activex::PPOleStr ppDescBuffer) = 0 ;
...
__interface INTERFACE_UUID("{0C733A8B-2A1C-11CE-ADE5-00AA0044773D}") IDBInitialize  : public IInterface 
{
...
__interface INTERFACE_UUID("{0C733A8B-2A1C-11CE-ADE5-00AA0044773D}") IDBInitializeSC  : public IInterface 
{
...
__interface INTERFACE_UUID("{0C733A89-2A1C-11CE-ADE5-00AA0044773D}") IDBInfo  : public IInterface 
{
	
public:
	virtual HRESULT __stdcall GetKeywords(/* out */ wchar_t * &ppwszKeywords) = 0 ;
	virtual HRESULT __stdcall GetLiteralInfo(unsigned cLiterals, PUintArray rgLiterals, unsigned &pcLiteralInfo, /* out */ PDBLiteralInfo &prgLiteralInfo, /* out */ wchar_t * &ppCharBuffer) = 0 ;
};

__interface IDBInfoSC;
typedef System::DelphiInterface<IDBInfoSC> _di_IDBInfoSC;
__interface INTERFACE_UUID("{0C733A89-2A1C-11CE-ADE5-00AA0044773D}") IDBInfoSC  : public IInterface 
{
	
public:
	virtual HRESULT __safecall GetKeywords(/* out */ wchar_t * &ppwszKeywords) = 0 ;
	virtual HRESULT __safecall GetLiteralInfo(unsigned cLiterals, PUintArray rgLiterals, unsigned &pcLiteralInfo, /* out */ PDBLiteralInfo &prgLiteralInfo, /* out */ wchar_t * &ppCharBuffer) = 0 ;
};

__interface IDBDataSourceAdmin;
typedef System::DelphiInterface<IDBDataSourceAdmin> _di_IDBDataSourceAdmin;
__interface INTERFACE_UUID("{0C733A7A-2A1C-11CE-ADE5-00AA0044773D}") IDBDataSourceAdmin  : public IInterface 
{
...
public:
	...
	virtual HRESULT __stdcall GetCreationProperties(unsigned cPropertyIDSets, PDBPropIDSetArray rgPropertyIDSets, PUINT pcPropertyInfoSets, /* out */ PDBPropInfoSet &prgPropertyInfoSets, Activex::PPOleStr ppDescBuffer) = 0 ;
...
__interface INTERFACE_UUID("{0C733A7A-2A1C-11CE-ADE5-00AA0044773D}") IDBDataSourceAdminSC  : public IInterface 
{
...
public:
	...
	virtual HRESULT __safecall GetCreationProperties(unsigned cPropertyIDSets, PDBPropIDSetArray rgPropertyIDSets, PUINT pcPropertyInfoSets, /* out */ PDBPropInfoSet &prgPropertyInfoSets, Activex::PPOleStr ppDescBuffer) = 0 ;
...
__interface INTERFACE_UUID("{0C733A85-2A1C-11CE-ADE5-00AA0044773D}") ISessionProperties  : public IInterface 
{
...
__interface INTERFACE_UUID("{0C733A85-2A1C-11CE-ADE5-00AA0044773D}") ISessionPropertiesSC  : public IInterface 
{
...
__interface INTERFACE_UUID("{0C733A68-2A1C-11CE-ADE5-00AA0044773D}") IIndexDefinition  : public IInterface 
{
	
public:
	virtual HRESULT __stdcall CreateIndex(DBID &pTableID, PDBID pIndexID, unsigned cIndexColumnDescs, PDBIndexColumnDescArray rgIndexColumnDescs, unsigned cPropertySets, PDBPropSetArray rgPropertySets, PPDBID ppIndexID) = 0 ;
...
__interface INTERFACE_UUID("{0C733A68-2A1C-11CE-ADE5-00AA0044773D}") IIndexDefinitionSC  : public IInterface 
{
	
public:
	virtual HRESULT __safecall CreateIndex(DBID &pTableID, PDBID pIndexID, unsigned cIndexColumnDescs, PDBIndexColumnDescArray rgIndexColumnDescs, unsigned cPropertySets, PDBPropSetArray rgPropertySets, PPDBID ppIndexID) = 0 ;
...
__interface INTERFACE_UUID("{0C733A86-2A1C-11CE-ADE5-00AA0044773D}") ITableDefinition  : public IInterface 
{
	
public:
	virtual HRESULT __stdcall CreateTable(const System::_di_IInterface punkOuter, PDBID pTableID, unsigned cColumnDescs, PDBColumnDescArray rgColumnDescs, const GUID &riid, unsigned cPropertySets, PDBPropSetArray rgPropertySets, PPDBID ppTableID, PIUnknown ppRowset) = 0 ;
...
__interface INTERFACE_UUID("{0C733A86-2A1C-11CE-ADE5-00AA0044773D}") ITableDefinitionSC  : public IInterface 
{
	
public:
	virtual HRESULT __safecall CreateTable(const System::_di_IInterface punkOuter, PDBID pTableID, unsigned cColumnDescs, PDBColumnDescArray rgColumnDescs, const GUID &riid, unsigned cPropertySets, PDBPropSetArray rgPropertySets, PPDBID ppTableID, PIUnknown ppRowset) = 0 ;
...
__interface INTERFACE_UUID("{0C733A69-2A1C-11CE-ADE5-00AA0044773D}") IOpenRowset  : public IInterface 
{
...
__interface INTERFACE_UUID("{0C733A69-2A1C-11CE-ADE5-00AA0044773D}") IOpenRowsetSC  : public IInterface 
{
...
__interface INTERFACE_UUID("{0C733A66-2A1C-11CE-ADE5-00AA0044773D}") IErrorLookup  : public IInterface 
{
	
public:
	virtual HRESULT __stdcall GetErrorDescription(HRESULT hrError, unsigned dwLookupID, Activex::PDispParams pdispparams, unsigned lcid, /* out */ WideString &pbstrSource, /* out */ WideString &pbstrDescription) = 0 ;
	virtual HRESULT __stdcall GetHelpInfo(HRESULT hrError, unsigned dwLookupID, unsigned lcid, /* out */ WideString &pbstrHelpFile, /* out */ unsigned &pdwHelpContext) = 0 ;
...
__interface INTERFACE_UUID("{0C733A66-2A1C-11CE-ADE5-00AA0044773D}") IErrorLookupSC  : public IInterface 
{
	
public:
	virtual HRESULT __safecall GetErrorDescription(HRESULT hrError, unsigned dwLookupID, Activex::PDispParams pdispparams, unsigned lcid, /* out */ WideString &pbstrSource, /* out */ WideString &pbstrDescription) = 0 ;
	virtual HRESULT __safecall GetHelpInfo(HRESULT hrError, unsigned dwLookupID, unsigned lcid, /* out */ WideString &pbstrHelpFile, /* out */ unsigned &pdwHelpContext) = 0 ;
...
__interface INTERFACE_UUID("{0C733A74-2A1C-11CE-ADE5-00AA0044773D}") ISQLErrorInfoSC  : public IInterface 
{
	
public:
	virtual HRESULT __safecall GetSQLInfo(/* out */ WideString &pbstrSQLState, /* out */ int &plNativeError) = 0 ;
};

__interface IGetDataSource;
typedef System::DelphiInterface<IGetDataSource> _di_IGetDataSource;
__interface INTERFACE_UUID("{0C733A75-2A1C-11CE-ADE5-00AA0044773D}") IGetDataSource  : public IInterface 
{
...
__interface INTERFACE_UUID("{0C733A75-2A1C-11CE-ADE5-00AA0044773D}") IGetDataSourceSC  : public IInterface 
{
...
__interface INTERFACE_UUID("{0C733A5E-2A1C-11CE-ADE5-00AA0044773D}") ITransactionJoin  : public IInterface 
{
...
__interface INTERFACE_UUID("{0C733A5E-2A1C-11CE-ADE5-00AA0044773D}") ITransactionJoinSC  : public IInterface 
{
...
__interface INTERFACE_UUID("{0C733A60-2A1C-11CE-ADE5-00AA0044773D}") ITransactionObject  : public IInterface 
{
...
__interface INTERFACE_UUID("{0C733A60-2A1C-11CE-ADE5-00AA0044773D}") ITransactionObjectSC  : public IInterface 
{
...
__interface INTERFACE_UUID("{0C733A95-2A1C-11CE-ADE5-00AA0044773D}") IDBAsynchStatus  : public IInterface 
{
	
public:
	virtual HRESULT __stdcall Abort(unsigned HCHAPTER, unsigned eOperation) = 0 ;
	virtual HRESULT __stdcall GetStatus(unsigned HCHAPTER, unsigned eOperation, PUINT pulProgress, PUINT pulProgressMax, PDBASYNCHPHASE peAsynchPhase, Activex::PPOleStr ppwszStatusText) = 0 ;
};

__interface IDBAsynchStatusSC;
typedef System::DelphiInterface<IDBAsynchStatusSC> _di_IDBAsynchStatusSC;
__interface INTERFACE_UUID("{0C733A95-2A1C-11CE-ADE5-00AA0044773D}") IDBAsynchStatusSC  : public IInterface 
{
	
public:
	virtual HRESULT __safecall Abort(unsigned HCHAPTER, unsigned eOperation) = 0 ;
	virtual HRESULT __safecall GetStatus(unsigned HCHAPTER, unsigned eOperation, PUINT pulProgress, PUINT pulProgressMax, PDBASYNCHPHASE peAsynchPhase, Activex::PPOleStr ppwszStatusText) = 0 ;
};

__interface IRowsetFind;
typedef System::DelphiInterface<IRowsetFind> _di_IRowsetFind;
__interface INTERFACE_UUID("{0C733A9D-2A1C-11CE-ADE5-00AA0044773D}") IRowsetFind  : public IInterface 
{
	
public:
	virtual HRESULT __stdcall FindNextRow(unsigned HCHAPTER, unsigned HACCESSOR, void * pFindValue, unsigned CompareOp, unsigned cbBookmark, System::PByte pBookmark, int lRowsOffset, int cRows, unsigned &pcRowsObtained, /* out */ PHROW &prghRows) = 0 ;
};

__interface IRowsetFindSC;
typedef System::DelphiInterface<IRowsetFindSC> _di_IRowsetFindSC;
__interface INTERFACE_UUID("{0C733A9D-2A1C-11CE-ADE5-00AA0044773D}") IRowsetFindSC  : public IInterface 
{
	
public:
	virtual HRESULT __safecall FindNextRow(unsigned HCHAPTER, unsigned HACCESSOR, void * pFindValue, unsigned CompareOp, unsigned cbBookmark, System::PByte pBookmark, int lRowsOffset, int cRows, unsigned &pcRowsObtained, /* out */ PHROW &prghRows) = 0 ;
};

__interface IRowPosition;
typedef System::DelphiInterface<IRowPosition> _di_IRowPosition;
__interface INTERFACE_UUID("{0C733A94-2A1C-11CE-ADE5-00AA0044773D}") IRowPosition  : public IInterface 
{
	
public:
	virtual HRESULT __stdcall ClearRowPosition(void) = 0 ;
	virtual HRESULT __stdcall GetRowPosition(/* out */ unsigned &phChapter, /* out */ unsigned &phRow, /* out */ unsigned &pdwPositionFlags) = 0 ;
	...
	virtual HRESULT __stdcall SetRowPosition(unsigned HCHAPTER, unsigned HROW, unsigned dwPositionFlags) = 0 ;
};

__interface IRowPositionSC;
typedef System::DelphiInterface<IRowPositionSC> _di_IRowPositionSC;
__interface INTERFACE_UUID("{0C733A94-2A1C-11CE-ADE5-00AA0044773D}") IRowPositionSC  : public IInterface 
{
	
public:
	virtual HRESULT __safecall ClearRowPosition(void) = 0 ;
	virtual HRESULT __safecall GetRowPosition(/* out */ unsigned &phChapter, /* out */ unsigned &phRow, /* out */ unsigned &pdwPositionFlags) = 0 ;
	...
	virtual HRESULT __safecall SetRowPosition(unsigned HCHAPTER, unsigned HROW, unsigned dwPositionFlags) = 0 ;
};

__interface IRowPositionChange;
typedef System::DelphiInterface<IRowPositionChange> _di_IRowPositionChange;
__interface INTERFACE_UUID("{0997A571-126E-11D0-9F8A-00A0C9A0631E}") IRowPositionChange  : public IInterface 
{
...
__interface INTERFACE_UUID("{0997A571-126E-11D0-9F8A-00A0C9A0631E}") IRowPositionChangeSC  : public IInterface 
{
...
__interface INTERFACE_UUID("{0C733A97-2A1C-11CE-ADE5-00AA0044773D}") IViewRowset  : public IInterface 
{
...
__interface INTERFACE_UUID("{0C733A97-2A1C-11CE-ADE5-00AA0044773D}") IViewRowsetSC  : public IInterface 
{
...
__interface INTERFACE_UUID("{0C733A98-2A1C-11CE-ADE5-00AA0044773D}") IViewChapter  : public IInterface 
{
...
__interface INTERFACE_UUID("{0C733A98-2A1C-11CE-ADE5-00AA0044773D}") IViewChapterSC  : public IInterface 
{
...
__interface INTERFACE_UUID("{0C733A9A-2A1C-11CE-ADE5-00AA0044773D}") IViewSort  : public IInterface 
{
	
public:
	virtual HRESULT __stdcall GetSortOrder(/* out */ unsigned &pcValues, /* out */ PUintArray &prgColumns, /* out */ PUintArray &prgOrders) = 0 ;
	virtual HRESULT __stdcall SetSortOrder(unsigned cValues, PUintArray rgColumns, PUintArray rgOrders) = 0 ;
};

__interface IViewSortSC;
typedef System::DelphiInterface<IViewSortSC> _di_IViewSortSC;
__interface INTERFACE_UUID("{0C733A9A-2A1C-11CE-ADE5-00AA0044773D}") IViewSortSC  : public IInterface 
{
	
public:
	virtual HRESULT __safecall GetSortOrder(/* out */ unsigned &pcValues, /* out */ PUintArray &prgColumns, /* out */ PUintArray &prgOrders) = 0 ;
	virtual HRESULT __safecall SetSortOrder(unsigned cValues, PUintArray rgColumns, PUintArray rgOrders) = 0 ;
};

__interface IViewFilter;
typedef System::DelphiInterface<IViewFilter> _di_IViewFilter;
__interface INTERFACE_UUID("{0C733A9B-2A1C-11CE-ADE5-00AA0044773D}") IViewFilter  : public IInterface 
{
	
public:
	virtual HRESULT __stdcall GetFilter(unsigned HACCESSOR, /* out */ unsigned &pcRows, /* out */ PDBCOMPAREOP &pCompareOps, void * pCriteriaData) = 0 ;
	virtual HRESULT __stdcall GetFilterBindings(/* out */ unsigned &pcBindings, /* out */ PDBBinding &prgBindings) = 0 ;
	virtual HRESULT __stdcall SetFilter(unsigned HACCESSOR, unsigned cRows, unsigned &CompareOps, void * pCriteriaData) = 0 ;
};

__interface IViewFilterSC;
typedef System::DelphiInterface<IViewFilterSC> _di_IViewFilterSC;
__interface INTERFACE_UUID("{0C733A9B-2A1C-11CE-ADE5-00AA0044773D}") IViewFilterSC  : public IInterface 
{
	
public:
	virtual HRESULT __safecall GetFilter(unsigned HACCESSOR, /* out */ unsigned &pcRows, /* out */ PDBCOMPAREOP &pCompareOps, void * pCriteriaData) = 0 ;
	virtual HRESULT __safecall GetFilterBindings(/* out */ unsigned &pcBindings, /* out */ PDBBinding &prgBindings) = 0 ;
	virtual HRESULT __safecall SetFilter(unsigned HACCESSOR, unsigned cRows, unsigned &CompareOps, void * pCriteriaData) = 0 ;
};

__interface IRowsetView;
typedef System::DelphiInterface<IRowsetView> _di_IRowsetView;
__interface INTERFACE_UUID("{0C733A99-2A1C-11CE-ADE5-00AA0044773D}") IRowsetView  : public IInterface 
{
...
public:
	...
	virtual HRESULT __stdcall GetView(unsigned HCHAPTER, const GUID &riid, /* out */ unsigned &phChapterSource, /* out */ System::_di_IInterface &ppView) = 0 ;
};

__interface IRowsetViewSC;
typedef System::DelphiInterface<IRowsetViewSC> _di_IRowsetViewSC;
__interface INTERFACE_UUID("{0C733A99-2A1C-11CE-ADE5-00AA0044773D}") IRowsetViewSC  : public IInterface 
{
...
public:
	...
	virtual HRESULT __safecall GetView(unsigned HCHAPTER, const GUID &riid, /* out */ unsigned &phChapterSource, /* out */ System::_di_IInterface &ppView) = 0 ;
};

__interface IMDFind;
typedef System::DelphiInterface<IMDFind> _di_IMDFind;
__interface INTERFACE_UUID("{A07CCCD2-8148-11D0-87BB-00C04FC33942}") IMDFind  : public IInterface 
{
	
public:
	virtual HRESULT __stdcall FindCell(unsigned ulStartingOrdinal, unsigned cMembers, Activex::PPOleStr rgpwszMember, /* out */ unsigned &pulCellOrdinal) = 0 ;
	virtual HRESULT __stdcall FindTuple(unsigned ulAxisIdentifier, unsigned ulStartingOrdinal, unsigned cMembers, Activex::PPOleStr rgpwszMember, /* out */ unsigned &pulTupleOrdinal) = 0 ;
};

__interface IMDFindSC;
typedef System::DelphiInterface<IMDFindSC> _di_IMDFindSC;
__interface INTERFACE_UUID("{A07CCCD2-8148-11D0-87BB-00C04FC33942}") IMDFindSC  : public IInterface 
{
	
public:
	virtual HRESULT __safecall FindCell(unsigned ulStartingOrdinal, unsigned cMembers, Activex::PPOleStr rgpwszMember, /* out */ unsigned &pulCellOrdinal) = 0 ;
	virtual HRESULT __safecall FindTuple(unsigned ulAxisIdentifier, unsigned ulStartingOrdinal, unsigned cMembers, Activex::PPOleStr rgpwszMember, /* out */ unsigned &pulTupleOrdinal) = 0 ;
};

__interface IMDRangeRowset;
typedef System::DelphiInterface<IMDRangeRowset> _di_IMDRangeRowset;
__interface INTERFACE_UUID("{0C733AA0-2A1C-11CE-ADE5-00AA0044773D}") IMDRangeRowset  : public IInterface 
{
	
public:
	virtual HRESULT __stdcall GetRangeRowset(const System::_di_IInterface punkOuter, unsigned ulStartCell, unsigned ulEndCell, const GUID &riid, unsigned cPropertySets, PDBPropSetArray rgPropertySets, /* out */ System::_di_IInterface &ppRowset) = 0 ;
};

__interface IMDRangeRowsetSC;
typedef System::DelphiInterface<IMDRangeRowsetSC> _di_IMDRangeRowsetSC;
__interface INTERFACE_UUID("{0C733AA0-2A1C-11CE-ADE5-00AA0044773D}") IMDRangeRowsetSC  : public IInterface 
{
	
public:
	virtual HRESULT __safecall GetRangeRowset(const System::_di_IInterface punkOuter, unsigned ulStartCell, unsigned ulEndCell, const GUID &riid, unsigned cPropertySets, PDBPropSetArray rgPropertySets, /* out */ System::_di_IInterface &ppRowset) = 0 ;
};

__interface IAlterTable;
typedef System::DelphiInterface<IAlterTable> _di_IAlterTable;
__interface INTERFACE_UUID("{0C733AA5-2A1C-11CE-ADE5-00AA0044773D}") IAlterTable  : public IInterface 
{
...
__interface INTERFACE_UUID("{0C733AA5-2A1C-11CE-ADE5-00AA0044773D}") IAlterTableSC  : public IInterface 
{
...
__interface INTERFACE_UUID("{0C733AA6-2A1C-11CE-ADE5-00AA0044773D}") IAlterIndex  : public IInterface 
{
...
__interface INTERFACE_UUID("{0C733AA6-2A1C-11CE-ADE5-00AA0044773D}") IAlterIndexSC  : public IInterface 
{
...
__interface INTERFACE_UUID("{0C733AA7-2A1C-11CE-ADE5-00AA0044773D}") ICommandPersist  : public IInterface 
{
...
__interface INTERFACE_UUID("{0C733AA7-2A1C-11CE-ADE5-00AA0044773D}") ICommandPersistSC  : public IInterface 
{
...
__interface INTERFACE_UUID("{0C733AA8-2A1C-11CE-ADE5-00AA0044773D}") IRowsetChapterMember  : public IInterface 
{
...
__interface INTERFACE_UUID("{0C733AA8-2A1C-11CE-ADE5-00AA0044773D}") IRowsetChapterMemberSC  : public IInterface 
{
...
__interface INTERFACE_UUID("{0C733AA9-2A1C-11CE-ADE5-00AA0044773D}") IRowsetRefresh  : public IInterface 
{
	
public:
	virtual HRESULT __stdcall RefreshVisibleData(unsigned HCHAPTER, unsigned cRows, PUintArray rghRows, BOOL fOverWrite, PUINT pcRowsRefreshed, /* out */ PHROW &prghRowsRefreshed, PPDBROWSTATUS prgRowStatus) = 0 ;
...
__interface INTERFACE_UUID("{0C733AA9-2A1C-11CE-ADE5-00AA0044773D}") IRowsetRefreshSC  : public IInterface 
{
	
public:
	virtual HRESULT __safecall RefreshVisibleData(unsigned HCHAPTER, unsigned cRows, PUintArray rghRows, BOOL fOverWrite, PUINT pcRowsRefreshed, /* out */ PHROW &prghRowsRefreshed, PPDBROWSTATUS prgRowStatus) = 0 ;
...
__interface INTERFACE_UUID("{0C733AAA-2A1C-11CE-ADE5-00AA0044773D}") IParentRowset  : public IInterface 
{
	
public:
	virtual HRESULT __stdcall GetChildRowset(const System::_di_IInterface punkOuter, unsigned iOrdinal, const GUID &riid, /* out */ System::_di_IInterface &ppRowset) = 0 ;
};

__interface IParentRowsetSC;
typedef System::DelphiInterface<IParentRowsetSC> _di_IParentRowsetSC;
__interface INTERFACE_UUID("{0C733AAA-2A1C-11CE-ADE5-00AA0044773D}") IParentRowsetSC  : public IInterface 
{
	
public:
	virtual HRESULT __safecall GetChildRowset(const System::_di_IInterface punkOuter, unsigned iOrdinal, const GUID &riid, /* out */ System::_di_IInterface &ppRowset) = 0 ;
};

__interface ITrusteeGroupAdmin;
typedef System::DelphiInterface<ITrusteeGroupAdmin> _di_ITrusteeGroupAdmin;
__interface INTERFACE_UUID("{0C733AA2-2A1C-11CE-ADE5-00AA0044773D}") ITrusteeGroupAdmin  : public IInterface 
{
...
public:
	...
	virtual HRESULT __stdcall IsMember(PTrusteeW pMembershipTrustee, PTrusteeW pMemberTrustee, /* out */ BOOL &pfStatus) = 0 ;
...
__interface INTERFACE_UUID("{0C733AA2-2A1C-11CE-ADE5-00AA0044773D}") ITrusteeGroupAdminSC  : public IInterface 
{
...
public:
	...
	virtual HRESULT __safecall IsMember(PTrusteeW pMembershipTrustee, PTrusteeW pMemberTrustee, /* out */ BOOL &pfStatus) = 0 ;
...
__interface INTERFACE_UUID("{0C733AA3-2A1C-11CE-ADE5-00AA0044773D}") IObjectAccessControl  : public IInterface 
{
...
__interface INTERFACE_UUID("{0C733AA3-2A1C-11CE-ADE5-00AA0044773D}") IObjectAccessControlSC  : public IInterface 
{
...
__interface INTERFACE_UUID("{0C733AA4-2A1C-11CE-ADE5-00AA0044773D}") ISecurityInfo  : public IInterface 
{
...
__interface INTERFACE_UUID("{0C733AA4-2A1C-11CE-ADE5-00AA0044773D}") ISecurityInfoSC  : public IInterface 
{
...
__interface INTERFACE_UUID("{2206CCB0-19C1-11D1-89E0-00C04FD7A829}") IDBPromptInitialize  : public IInterface 
{
	
public:
	virtual HRESULT __stdcall PromptDataSource(const System::_di_IInterface pUnkOuter, HWND hWndParent, unsigned dwPromptOptions, unsigned cSourceTypeFilter, PDBSOURCETYPE rgSourceTypeFilter, wchar_t * pszProviderFilter, const GUID &riid, System::_di_IInterface &DataSource) = 0 ;
	virtual HRESULT __stdcall PromptFileName(HWND hWndParent, unsigned dwPromptOptions, wchar_t * pwszInitialDirectory, wchar_t * pwszInitialFile, wchar_t * &ppwszSelectedFile) = 0 ;
};

__interface IDBPromptInitializeSC;
typedef System::DelphiInterface<IDBPromptInitializeSC> _di_IDBPromptInitializeSC;
__interface INTERFACE_UUID("{2206CCB0-19C1-11D1-89E0-00C04FD7A829}") IDBPromptInitializeSC  : public IInterface 
{
	
public:
	virtual HRESULT __safecall PromptDataSource(const System::_di_IInterface pUnkOuter, HWND hWndParent, unsigned dwPromptOptions, unsigned cSourceTypeFilter, PDBSOURCETYPE rgSourceTypeFilter, wchar_t * pszProviderFilter, const GUID &riid, System::_di_IInterface &DataSource) = 0 ;
	virtual HRESULT __safecall PromptFileName(HWND hWndParent, unsigned dwPromptOptions, wchar_t * pwszInitialDirectory, wchar_t * pwszInitialFile, wchar_t * &ppwszSelectedFile) = 0 ;
};

__interface IDataInitialize;
typedef System::DelphiInterface<IDataInitialize> _di_IDataInitialize;
__interface INTERFACE_UUID("{2206CCB1-19C1-11D1-89E0-00C04FD7A829}") IDataInitialize  : public IInterface 
{
	
public:
	virtual HRESULT __stdcall GetDataSource(const System::_di_IInterface pUnkOuter, unsigned dwClsCtx, wchar_t * pwszInitializationString, const GUID &riid, System::_di_IInterface &DataSource) = 0 ;
	virtual HRESULT __stdcall GetInitializationString(const System::_di_IInterface DataSource, bool fIncludePassword, /* out */ wchar_t * &pwszInitString) = 0 ;
	virtual HRESULT __stdcall CreateDBInstance(const GUID &clsidProvider, const System::_di_IInterface pUnkOuter, unsigned dwClsCtx, wchar_t * pwszReserved, const GUID riid, System::_di_IInterface &DataSource) = 0 ;
	virtual HRESULT __stdcall CreateDBInstanceEx(const GUID &clsidProvider, const System::_di_IInterface pUnkOuter, unsigned dwClsCtx, wchar_t * pwszReserved, Activex::PCoServerInfo pServerInfo, unsigned cmq, Activex::PMultiQI rgmqResults) = 0 ;
	virtual HRESULT __stdcall LoadStringFromStorage(wchar_t * pwszFileName, /* out */ wchar_t * &pwszInitializationString) = 0 ;
	virtual HRESULT __stdcall WriteStringToStorage(wchar_t * pwszFileName, wchar_t * pwszInitializationString, unsigned dwCreationDisposition) = 0 ;
};

__interface IDataInitializeSC;
typedef System::DelphiInterface<IDataInitializeSC> _di_IDataInitializeSC;
__interface INTERFACE_UUID("{2206CCB1-19C1-11D1-89E0-00C04FD7A829}") IDataInitializeSC  : public IInterface 
{
	
public:
	virtual HRESULT __safecall GetDataSource(const System::_di_IInterface pUnkOuter, unsigned dwClsCtx, wchar_t * pwszInitializationString, const GUID &riid, System::_di_IInterface &DataSource) = 0 ;
	virtual HRESULT __safecall GetInitializationString(const System::_di_IInterface DataSource, bool fIncludePassword, /* out */ wchar_t * &pwszInitString) = 0 ;
	virtual HRESULT __safecall CreateDBInstance(const GUID &clsidProvider, const System::_di_IInterface pUnkOuter, unsigned dwClsCtx, wchar_t * pwszReserved, const GUID riid, System::_di_IInterface &DataSource) = 0 ;
	virtual HRESULT __safecall CreateDBInstanceEx(const GUID &clsidProvider, const System::_di_IInterface pUnkOuter, unsigned dwClsCtx, wchar_t * pwszReserved, Activex::PCoServerInfo pServerInfo, unsigned cmq, Activex::PMultiQI rgmqResults) = 0 ;
	virtual HRESULT __safecall LoadStringFromStorage(wchar_t * pwszFileName, /* out */ wchar_t * &pwszInitializationString) = 0 ;
	virtual HRESULT __safecall WriteStringToStorage(wchar_t * pwszFileName, wchar_t * pwszInitializationString, unsigned dwCreationDisposition) = 0 ;
};
...
extern PACKAGE GUID IID_ITransaction;
