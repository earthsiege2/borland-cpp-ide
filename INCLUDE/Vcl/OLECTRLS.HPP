...
// (DO NOT EDIT: machine generated header) 'OleCtrls.pas' rev: 5.00
...
public:
	...
	/* TWinControl.CreateParented */ inline __fastcall TOleControl(HWND ParentWindow) : Controls::TWinControl(
		ParentWindow) { }
	#pragma option pop
