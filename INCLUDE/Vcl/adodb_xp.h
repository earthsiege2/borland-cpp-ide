...
// *********************************************************************//
typedef Adodb_xp::SearchDirectionEnum SearchDirection;
...
// *********************************************************************//
interface _DynaCollection  : public Adodb_xp::_Collection
{
public:
...
{
public:
  virtual HRESULT STDMETHODCALLTYPE get_Properties(Adodb_xp::Properties** ppvObject/*[out,retval]*/) = 0; // [500]

#if !defined(__TLB_NO_INTERFACE_WRAPPERS)

  Adodb_xp::Properties* __fastcall get_Properties(void)
  {
    Adodb_xp::Properties* ppvObject;
    OLECHECK(this->get_Properties((Adodb_xp::Properties**)&ppvObject));
    return ppvObject;
  }


  __property   Adodb_xp::Properties* Properties = {read = get_Properties};
...
// *********************************************************************//
interface Properties  : public Adodb_xp::_Collection
{
public:
  virtual HRESULT STDMETHODCALLTYPE get_Item(VARIANT Index/*[in]*/, 
                                             Adodb_xp::Property** ppvObject/*[out,retval]*/) = 0; // [0]

#if !defined(__TLB_NO_INTERFACE_WRAPPERS)

  Adodb_xp::Property* __fastcall get_Item(VARIANT Index/*[in]*/)
  {
    Adodb_xp::Property* ppvObject;
    OLECHECK(this->get_Item(Index, (Adodb_xp::Property**)&ppvObject));
    return ppvObject;
  }
...
public:
  ...
  virtual HRESULT STDMETHODCALLTYPE get_Type(Adodb_xp::DataTypeEnum* ptype/*[out,retval]*/) = 0; // [-1]
  ...
  Adodb_xp::DataTypeEnum __fastcall get_Type(void)
  {
    Adodb_xp::DataTypeEnum ptype;
    OLECHECK(this->get_Type((Adodb_xp::DataTypeEnum*)&ptype));
    return ptype;
  }
  ...
  __property   Adodb_xp::DataTypeEnum Type = {read = get_Type};
...
// *********************************************************************//
interface Errors  : public Adodb_xp::_Collection
{
public:
  virtual HRESULT STDMETHODCALLTYPE get_Item(VARIANT Index/*[in]*/, 
                                             Adodb_xp::Error** ppvObject/*[out,retval]*/) = 0; // [0]
  virtual HRESULT STDMETHODCALLTYPE Clear(void) = 0; // [-1]

#if !defined(__TLB_NO_INTERFACE_WRAPPERS)

  Adodb_xp::Error* __fastcall get_Item(VARIANT Index/*[in]*/)
  {
    Adodb_xp::Error* ppvObject;
    OLECHECK(this->get_Item(Index, (Adodb_xp::Error**)&ppvObject));
    return ppvObject;
  }
...
// *********************************************************************//
interface Command15  : public Adodb_xp::_ADO
{
public:
  virtual HRESULT STDMETHODCALLTYPE get_ActiveConnection(Adodb_xp::Connection15** ppvObject/*[out,retval]*/) = 0; // [-1]
  virtual HRESULT STDMETHODCALLTYPE _set_ActiveConnection(Adodb_xp::Connection15* ppvObject/*[in]*/) = 0; // [1610809344]
  ...
  virtual HRESULT STDMETHODCALLTYPE Execute(VARIANT* RecordsAffected/*[out,opt]*/, 
                                            ...
                                            Adodb_xp::Recordset15** ppiRs/*[out,retval]*/) = 0; // [-1]
  virtual HRESULT STDMETHODCALLTYPE CreateParameter(BSTR Name/*[in,def,opt]*/, 
                                                    Adodb_xp::DataTypeEnum Type/*[in,def,opt]*/, 
                                                    Adodb_xp::ParameterDirectionEnum Direction/*[in,def,opt]*/, 
                                                    long Size/*[in,def,opt]*/, 
                                                    VARIANT Value/*[in,opt]*/, 
                                                    Adodb_xp::_Parameter** ppiprm/*[out,retval]*/) = 0; // [-1]
  virtual HRESULT STDMETHODCALLTYPE get_Parameters(Adodb_xp::Parameters** ppvObject/*[out,retval]*/) = 0; // [0]
  virtual HRESULT STDMETHODCALLTYPE set_CommandType(Adodb_xp::CommandTypeEnum plCmdType/*[in]*/) = 0; // [-1]
  virtual HRESULT STDMETHODCALLTYPE get_CommandType(Adodb_xp::CommandTypeEnum* plCmdType/*[out,retval]*/) = 0; // [1610809356]
  ...
  Adodb_xp::Connection15* __fastcall get_ActiveConnection(void)
  {
    Adodb_xp::Connection15* ppvObject;
    OLECHECK(this->get_ActiveConnection((Adodb_xp::Connection15**)&ppvObject));
    return ppvObject;
  }
  ...
  Adodb_xp::Recordset15* __fastcall Execute(VARIANT* RecordsAffected/*[out,opt]*/, 
                                            VARIANT* Parameters/*[in,opt]*/, 
                                            long Options/*[in,def,opt]*/)
  {
    Adodb_xp::Recordset15* ppiRs;
    OLECHECK(this->Execute(RecordsAffected, Parameters, Options, (Adodb_xp::Recordset15**)&ppiRs));
    return ppiRs;
  }

  Adodb_xp::_Parameter* __fastcall CreateParameter(BSTR Name/*[in,def,opt]*/, 
                                                   Adodb_xp::DataTypeEnum Type/*[in,def,opt]*/, 
                                                   Adodb_xp::ParameterDirectionEnum Direction/*[in,def,opt]*/, 
                                                   long Size/*[in,def,opt]*/, 
                                                   VARIANT Value/*[in,opt]*/= TNoParam())
  {
    Adodb_xp::_Parameter* ppiprm;
    OLECHECK(this->CreateParameter(Name, Type, Direction, Size, Value, (Adodb_xp::_Parameter**)&ppiprm));
    return ppiprm;
  }

  Adodb_xp::Parameters* __fastcall get_Parameters(void)
  {
    Adodb_xp::Parameters* ppvObject;
    OLECHECK(this->get_Parameters((Adodb_xp::Parameters**)&ppvObject));
    return ppvObject;
  }

  Adodb_xp::CommandTypeEnum __fastcall get_CommandType(void)
  {
    Adodb_xp::CommandTypeEnum plCmdType;
    OLECHECK(this->get_CommandType((Adodb_xp::CommandTypeEnum*)&plCmdType));
    return plCmdType;
  }
  ...
  __property   Adodb_xp::Connection15* ActiveConnection = {read = get_ActiveConnection, write = _set_ActiveConnection};
  ...
  __property   Adodb_xp::Parameters* Parameters = {read = get_Parameters};
  __property   Adodb_xp::CommandTypeEnum CommandType = {read = get_CommandType, write = set_CommandType};
  __property   BSTR            Name = {read = get_Name};
...
// *********************************************************************//
interface Connection15  : public Adodb_xp::_ADO
{
public:
  ...
  virtual HRESULT STDMETHODCALLTYPE Execute(BSTR CommandText/*[in]*/, 
                                            ...
                                            long Options/*[in,def,opt]*/, 
                                            Adodb_xp::Recordset15** ppiRset/*[out,retval]*/) = 0; // [6]
  ...
  virtual HRESULT STDMETHODCALLTYPE get_Errors(Adodb_xp::Errors** ppvObject/*[out,retval]*/) = 0; // [11]
  ...
  virtual HRESULT STDMETHODCALLTYPE get_IsolationLevel(Adodb_xp::IsolationLevelEnum* Level/*[out,retval]*/) = 0; // [13]
  virtual HRESULT STDMETHODCALLTYPE set_IsolationLevel(Adodb_xp::IsolationLevelEnum Level/*[in]*/) = 0; // [13]
  ...
  virtual HRESULT STDMETHODCALLTYPE get_CursorLocation(Adodb_xp::CursorLocationEnum* plCursorLoc/*[out,retval]*/) = 0; // [15]
  virtual HRESULT STDMETHODCALLTYPE set_CursorLocation(Adodb_xp::CursorLocationEnum plCursorLoc/*[in]*/) = 0; // [15]
  virtual HRESULT STDMETHODCALLTYPE get_Mode(Adodb_xp::ConnectModeEnum* plMode/*[out,retval]*/) = 0; // [16]
  virtual HRESULT STDMETHODCALLTYPE set_Mode(Adodb_xp::ConnectModeEnum plMode/*[in]*/) = 0; // [16]
  ...
  virtual HRESULT STDMETHODCALLTYPE OpenSchema(Adodb_xp::SchemaEnum Schema/*[in]*/, 
                                               VARIANT Restrictions/*[in,opt]*/, 
                                               VARIANT SchemaID/*[in,opt]*/, 
                                               Adodb_xp::Recordset15** pprset/*[out,retval]*/) = 0; // [19]
  ...
  Adodb_xp::Recordset15* __fastcall Execute(BSTR CommandText/*[in]*/, 
                                            VARIANT* RecordsAffected/*[out,opt]*/, 
                                            long Options/*[in,def,opt]*/)
  {
    Adodb_xp::Recordset15* ppiRset;
    OLECHECK(this->Execute(CommandText, RecordsAffected, Options, (Adodb_xp::Recordset15**)&ppiRset));
    return ppiRset;
  }
  ...
  Adodb_xp::Errors* __fastcall get_Errors(void)
  {
    Adodb_xp::Errors* ppvObject;
    OLECHECK(this->get_Errors((Adodb_xp::Errors**)&ppvObject));
    return ppvObject;
  }
  ...
  Adodb_xp::IsolationLevelEnum __fastcall get_IsolationLevel(void)
  {
    Adodb_xp::IsolationLevelEnum Level;
    OLECHECK(this->get_IsolationLevel((Adodb_xp::IsolationLevelEnum*)&Level));
    return Level;
  }
  ...
  Adodb_xp::CursorLocationEnum __fastcall get_CursorLocation(void)
  {
    Adodb_xp::CursorLocationEnum plCursorLoc;
    OLECHECK(this->get_CursorLocation((Adodb_xp::CursorLocationEnum*)&plCursorLoc));
    return plCursorLoc;
  }

  Adodb_xp::ConnectModeEnum __fastcall get_Mode(void)
  {
    Adodb_xp::ConnectModeEnum plMode;
    OLECHECK(this->get_Mode((Adodb_xp::ConnectModeEnum*)&plMode));
    return plMode;
  }
  ...
  Adodb_xp::Recordset15* __fastcall OpenSchema(Adodb_xp::SchemaEnum Schema/*[in]*/, 
                                               VARIANT Restrictions/*[in,opt]*/= TNoParam(), 
                                               VARIANT SchemaID/*[in,opt]*/= TNoParam())
  {
    Adodb_xp::Recordset15* pprset;
    OLECHECK(this->OpenSchema(Schema, Restrictions, SchemaID, (Adodb_xp::Recordset15**)&pprset));
    return pprset;
  }
  ...
  __property   Adodb_xp::Errors* Errors = {read = get_Errors};
  __property   BSTR            DefaultDatabase = {read = get_DefaultDatabase};
  __property   Adodb_xp::IsolationLevelEnum IsolationLevel = {read = get_IsolationLevel, write = set_IsolationLevel};
  __property   long            Attributes = {read = get_Attributes, write = set_Attributes};
  __property   Adodb_xp::CursorLocationEnum CursorLocation = {read = get_CursorLocation, write = set_CursorLocation};
  __property   Adodb_xp::ConnectModeEnum Mode = {read = get_Mode, write = set_Mode};
...
// *********************************************************************//
interface _Connection  : public Adodb_xp::Connection15
{
public:
...
// *********************************************************************//
interface Recordset15  : public Adodb_xp::_ADO
{
public:
  virtual HRESULT STDMETHODCALLTYPE get_AbsolutePosition(Adodb_xp::PositionEnum* pl/*[out,retval]*/) = 0; // [1000]
  virtual HRESULT STDMETHODCALLTYPE set_AbsolutePosition(Adodb_xp::PositionEnum pl/*[in]*/) = 0; // [1000]
  ...
  virtual HRESULT STDMETHODCALLTYPE get_CursorType(Adodb_xp::CursorTypeEnum* plCursorType/*[out,retval]*/) = 0; // [1005]
  virtual HRESULT STDMETHODCALLTYPE set_CursorType(Adodb_xp::CursorTypeEnum plCursorType/*[in]*/) = 0; // [1005]
  virtual HRESULT STDMETHODCALLTYPE get_EOF_(VARIANT_BOOL* pb/*[out,retval]*/) = 0; // [1006]
  virtual HRESULT STDMETHODCALLTYPE get_Fields(Adodb_xp::Fields15** ppvObject/*[out,retval]*/) = 0; // [0]
  virtual HRESULT STDMETHODCALLTYPE get_LockType(Adodb_xp::LockTypeEnum* plLockType/*[out,retval]*/) = 0; // [1008]
  virtual HRESULT STDMETHODCALLTYPE set_LockType(Adodb_xp::LockTypeEnum plLockType/*[in]*/) = 0; // [1008]
  ...
  virtual HRESULT STDMETHODCALLTYPE Delete(Adodb_xp::AffectEnum AffectRecords/*[in,def,opt]*/) = 0; // [1015]
  ...
  virtual HRESULT STDMETHODCALLTYPE Open(VARIANT Source/*[in,opt]*/, 
                                         ...
                                         Adodb_xp::CursorTypeEnum CursorType/*[in,def,opt]*/, 
                                         Adodb_xp::LockTypeEnum LockType/*[in,def,opt]*/, 
                                         long Options/*[in,def,opt]*/) = 0; // [1022]
  virtual HRESULT STDMETHODCALLTYPE Requery(long Options/*[in,def,opt]*/) = 0; // [1023]
  virtual HRESULT STDMETHODCALLTYPE _xResync(Adodb_xp::AffectEnum AffectRecords/*[in,def,opt]*/) = 0; // [-1]
  virtual HRESULT STDMETHODCALLTYPE Update(VARIANT Fields/*[in,opt]*/= TNoParam(), 
                                           VARIANT Values/*[in,opt]*/= TNoParam()) = 0; // [1025]
  virtual HRESULT STDMETHODCALLTYPE get_AbsolutePage(Adodb_xp::PositionEnum* pl/*[out,retval]*/) = 0; // [1047]
  virtual HRESULT STDMETHODCALLTYPE set_AbsolutePage(Adodb_xp::PositionEnum pl/*[in]*/) = 0; // [1047]
  virtual HRESULT STDMETHODCALLTYPE get_EditMode(Adodb_xp::EditModeEnum* pl/*[out,retval]*/) = 0; // [1026]
  ...
  virtual HRESULT STDMETHODCALLTYPE _xClone(Adodb_xp::Recordset15** ppvObject/*[out,retval]*/) = 0; // [-1]
  virtual HRESULT STDMETHODCALLTYPE UpdateBatch(Adodb_xp::AffectEnum AffectRecords/*[in,def,opt]*/) = 0; // [1035]
  virtual HRESULT STDMETHODCALLTYPE CancelBatch(Adodb_xp::AffectEnum AffectRecords/*[in,def,opt]*/) = 0; // [1049]
  virtual HRESULT STDMETHODCALLTYPE get_CursorLocation(Adodb_xp::CursorLocationEnum* plCursorLoc/*[out,retval]*/) = 0; // [1051]
  virtual HRESULT STDMETHODCALLTYPE set_CursorLocation(Adodb_xp::CursorLocationEnum plCursorLoc/*[in]*/) = 0; // [1051]
  virtual HRESULT STDMETHODCALLTYPE NextRecordset(VARIANT* RecordsAffected/*[out,opt]*/, 
                                                  Adodb_xp::Recordset15** ppiRs/*[out,retval]*/) = 0; // [1052]
  virtual HRESULT STDMETHODCALLTYPE Supports(Adodb_xp::CursorOptionEnum CursorOptions/*[in]*/, 
  ...
  virtual HRESULT STDMETHODCALLTYPE get_MarshalOptions(Adodb_xp::MarshalOptionsEnum* peMarshal/*[out,retval]*/) = 0; // [1053]
  virtual HRESULT STDMETHODCALLTYPE set_MarshalOptions(Adodb_xp::MarshalOptionsEnum peMarshal/*[in]*/) = 0; // [1053]
  virtual HRESULT STDMETHODCALLTYPE Find(BSTR Criteria/*[in]*/, long SkipRecords/*[in,def,opt]*/, 
                                         Adodb_xp::SearchDirectionEnum SearchDirection/*[in,def,opt]*/, 
                                         VARIANT Start/*[in,opt]*/= TNoParam()) = 0; // [1058]

#if !defined(__TLB_NO_INTERFACE_WRAPPERS)

  Adodb_xp::PositionEnum __fastcall get_AbsolutePosition(void)
  {
    Adodb_xp::PositionEnum pl;
    OLECHECK(this->get_AbsolutePosition((Adodb_xp::PositionEnum*)&pl));
    return pl;
  }
  ...
  Adodb_xp::CursorTypeEnum __fastcall get_CursorType(void)
  {
    Adodb_xp::CursorTypeEnum plCursorType;
    OLECHECK(this->get_CursorType((Adodb_xp::CursorTypeEnum*)&plCursorType));
    return plCursorType;
  }
  ...
  Adodb_xp::Fields15* __fastcall get_Fields(void)
  {
    Adodb_xp::Fields15* ppvObject;
    OLECHECK(this->get_Fields((Adodb_xp::Fields15**)&ppvObject));
    return ppvObject;
  }

  Adodb_xp::LockTypeEnum __fastcall get_LockType(void)
  {
    Adodb_xp::LockTypeEnum plLockType;
    OLECHECK(this->get_LockType((Adodb_xp::LockTypeEnum*)&plLockType));
    return plLockType;
  }
  ...
  Adodb_xp::PositionEnum __fastcall get_AbsolutePage(void)
  {
    Adodb_xp::PositionEnum pl;
    OLECHECK(this->get_AbsolutePage((Adodb_xp::PositionEnum*)&pl));
    return pl;
  }

  Adodb_xp::EditModeEnum __fastcall get_EditMode(void)
  {
    Adodb_xp::EditModeEnum pl;
    OLECHECK(this->get_EditMode((Adodb_xp::EditModeEnum*)&pl));
    return pl;
  }
  ...
  Adodb_xp::Recordset15* __fastcall _xClone(void)
  {
    Adodb_xp::Recordset15* ppvObject;
    OLECHECK(this->_xClone((Adodb_xp::Recordset15**)&ppvObject));
    return ppvObject;
  }
  ...
  Adodb_xp::Recordset15* __fastcall NextRecordset(VARIANT* RecordsAffected/*[out,opt]*/= TNoParam())
  {
    Adodb_xp::Recordset15* ppiRs;
    OLECHECK(this->NextRecordset(RecordsAffected, (Adodb_xp::Recordset15**)&ppiRs));
    return ppiRs;
  }

  VARIANT_BOOL __fastcall Supports(Adodb_xp::CursorOptionEnum CursorOptions/*[in]*/)
  {
    VARIANT_BOOL pb;
  ...
  Adodb_xp::MarshalOptionsEnum __fastcall get_MarshalOptions(void)
  {
    Adodb_xp::MarshalOptionsEnum peMarshal;
    OLECHECK(this->get_MarshalOptions((Adodb_xp::MarshalOptionsEnum*)&peMarshal));
    return peMarshal;
  }


  __property   Adodb_xp::PositionEnum AbsolutePosition = {read = get_AbsolutePosition, write = set_AbsolutePosition};
  ...
  __property   Adodb_xp::CursorTypeEnum CursorType = {read = get_CursorType, write = set_CursorType};
  __property   VARIANT_BOOL    EOF_ = {read = get_EOF_};
  __property   Adodb_xp::Fields15* Fields = {read = get_Fields};
  __property   Adodb_xp::LockTypeEnum LockType = {read = get_LockType, write = set_LockType};
  ...
  __property   Adodb_xp::PositionEnum AbsolutePage = {read = get_AbsolutePage, write = set_AbsolutePage};
  __property   Adodb_xp::EditModeEnum EditMode = {read = get_EditMode};
  ...
  __property   long            State = {read = get_State};
  __property   Adodb_xp::CursorLocationEnum CursorLocation = {read = get_CursorLocation, write = set_CursorLocation};
  __property   Adodb_xp::MarshalOptionsEnum MarshalOptions = {read = get_MarshalOptions, write = set_MarshalOptions};
...
// *********************************************************************//
interface Recordset20  : public Adodb_xp::Recordset15
{
public:
  ...
  virtual HRESULT STDMETHODCALLTYPE Save(BSTR FileName/*[in,opt]*/, 
                                         Adodb_xp::PersistFormatEnum PersistFormat/*[in,def,opt]*/) = 0; // [1057]
  ...
  virtual HRESULT STDMETHODCALLTYPE GetString(Adodb_xp::StringFormatEnum StringFormat/*[in,def,opt]*/, 
  ...
  virtual HRESULT STDMETHODCALLTYPE CompareBookmarks(VARIANT Bookmark1/*[in]*/, 
                                                     ...
                                                     Adodb_xp::CompareEnum* pCompare/*[out,retval]*/) = 0; // [1065]
  virtual HRESULT STDMETHODCALLTYPE Clone(Adodb_xp::LockTypeEnum LockType/*[in,def,opt]*/, 
                                          Adodb_xp::Recordset15** ppvObject/*[out,retval]*/) = 0; // [1034]
  virtual HRESULT STDMETHODCALLTYPE Resync(Adodb_xp::AffectEnum AffectRecords/*[in,def,opt]*/, 
                                           Adodb_xp::ResyncEnum ResyncValues/*[in,def,opt]*/) = 0; // [1024]
  ...
  BSTR __fastcall GetString(Adodb_xp::StringFormatEnum StringFormat/*[in,def,opt]*/, 
  ...
  Adodb_xp::CompareEnum __fastcall CompareBookmarks(VARIANT Bookmark1/*[in]*/, 
                                                    VARIANT Bookmark2/*[in]*/)
  {
    Adodb_xp::CompareEnum pCompare;
    OLECHECK(this->CompareBookmarks(Bookmark1, Bookmark2, (Adodb_xp::CompareEnum*)&pCompare));
    return pCompare;
  }

  Adodb_xp::Recordset15* __fastcall Clone(Adodb_xp::LockTypeEnum LockType/*[in,def,opt]*/)
  {
    Adodb_xp::Recordset15* ppvObject;
    OLECHECK(this->Clone(LockType, (Adodb_xp::Recordset15**)&ppvObject));
    return ppvObject;
  }
...
// *********************************************************************//
interface _Recordset  : public Adodb_xp::Recordset20
{
public:
  virtual HRESULT STDMETHODCALLTYPE Seek(VARIANT KeyValues/*[in]*/, 
                                         Adodb_xp::SeekEnum SeekOption/*[in,def,opt]*/) = 0; // [1066]
...
// *********************************************************************//
interface Fields15  : public Adodb_xp::_Collection
{
public:
  virtual HRESULT STDMETHODCALLTYPE get_Item(VARIANT Index/*[in]*/, 
                                             Adodb_xp::Field** ppvObject/*[out,retval]*/) = 0; // [0]

#if !defined(__TLB_NO_INTERFACE_WRAPPERS)

  Adodb_xp::Field* __fastcall get_Item(VARIANT Index/*[in]*/)
  {
    Adodb_xp::Field* ppvObject;
    OLECHECK(this->get_Item(Index, (Adodb_xp::Field**)&ppvObject));
    return ppvObject;
  }
...
// *********************************************************************//
interface Fields  : public Adodb_xp::Fields15
{
public:
  virtual HRESULT STDMETHODCALLTYPE Append(BSTR Name/*[in]*/, Adodb_xp::DataTypeEnum Type/*[in]*/, 
                                           long DefinedSize/*[in,def,opt]*/, 
                                           Adodb_xp::FieldAttributeEnum Attrib/*[in,def,opt]*/) = 0; // [1610874880]
...
// *********************************************************************//
interface Field  : public Adodb_xp::_ADO
{
public:
  ...
  virtual HRESULT STDMETHODCALLTYPE get_Type(Adodb_xp::DataTypeEnum* pDataType/*[out,retval]*/) = 0; // [1102]
  ...
  virtual HRESULT STDMETHODCALLTYPE set_Type(Adodb_xp::DataTypeEnum pDataType/*[in]*/) = 0; // [1102]
  ...
  Adodb_xp::DataTypeEnum __fastcall get_Type(void)
  {
    Adodb_xp::DataTypeEnum pDataType;
    OLECHECK(this->get_Type((Adodb_xp::DataTypeEnum*)&pDataType));
    return pDataType;
  }
  ...
  __property   BSTR            Name = {read = get_Name};
  __property   Adodb_xp::DataTypeEnum Type = {read = get_Type, write = set_Type};
...
// *********************************************************************//
interface _Parameter  : public Adodb_xp::_ADO
{
public:
  virtual HRESULT STDMETHODCALLTYPE get_Name(BSTR* pbstr/*[out,retval]*/) = 0; // [-1]
  ...
  virtual HRESULT STDMETHODCALLTYPE get_Value(VARIANT* pvar/*[out,retval]*/) = 0; // [0]
  virtual HRESULT STDMETHODCALLTYPE set_Value(VARIANT pvar/*[in]*/) = 0; // [0]
  virtual HRESULT STDMETHODCALLTYPE get_Type(Adodb_xp::DataTypeEnum* psDataType/*[out,retval]*/) = 0; // [-1]
  virtual HRESULT STDMETHODCALLTYPE set_Type(Adodb_xp::DataTypeEnum psDataType/*[in]*/) = 0; // [1610809348]
  virtual HRESULT STDMETHODCALLTYPE set_Direction(Adodb_xp::ParameterDirectionEnum plParmDirection/*[in]*/) = 0; // [-1]
  virtual HRESULT STDMETHODCALLTYPE get_Direction(Adodb_xp::ParameterDirectionEnum* plParmDirection/*[out,retval]*/) = 0; // [1610809350]
  ...
  Adodb_xp::DataTypeEnum __fastcall get_Type(void)
  {
    Adodb_xp::DataTypeEnum psDataType;
    OLECHECK(this->get_Type((Adodb_xp::DataTypeEnum*)&psDataType));
    return psDataType;
  }

  Adodb_xp::ParameterDirectionEnum __fastcall get_Direction(void)
  {
    Adodb_xp::ParameterDirectionEnum plParmDirection;
    OLECHECK(this->get_Direction((Adodb_xp::ParameterDirectionEnum*)&plParmDirection));
  ...
  __property   BSTR            Name = {read = get_Name};
  __property   Adodb_xp::DataTypeEnum Type = {read = get_Type, write = set_Type};
  __property   Adodb_xp::ParameterDirectionEnum Direction = {read = get_Direction, write = set_Direction};
  __property   unsigned_char   Precision = {read = get_Precision, write = set_Precision};
  __property   unsigned_char   NumericScale = {read = get_NumericScale, write = set_NumericScale};
...
// *********************************************************************//
interface Parameters  : public Adodb_xp::_DynaCollection
{
public:
  virtual HRESULT STDMETHODCALLTYPE get_Item(VARIANT Index/*[in]*/, 
                                             Adodb_xp::_Parameter** ppvObject/*[out,retval]*/) = 0; // [0]

#if !defined(__TLB_NO_INTERFACE_WRAPPERS)

  Adodb_xp::_Parameter* __fastcall get_Item(VARIANT Index/*[in]*/)
  {
    Adodb_xp::_Parameter* ppvObject;
    OLECHECK(this->get_Item(Index, (Adodb_xp::_Parameter**)&ppvObject));
    return ppvObject;
  }
...
// *********************************************************************//
interface _Command  : public Adodb_xp::Command15
{
public:
...
{
public:
  virtual HRESULT STDMETHODCALLTYPE InfoMessage(Adodb_xp::Error* pError/*[in]*/, 
                                                Adodb_xp::EventStatusEnum* adStatus/*[in,out]*/, 
                                                Adodb_xp::Connection15* pConnection/*[in]*/) = 0; // [0]
  virtual HRESULT STDMETHODCALLTYPE BeginTransComplete(long TransactionLevel/*[in]*/, 
                                                       Adodb_xp::Error* pError/*[in]*/, 
                                                       Adodb_xp::EventStatusEnum* adStatus/*[in,out]*/, 
                                                       Adodb_xp::Connection15* pConnection/*[in]*/) = 0; // [1]
  virtual HRESULT STDMETHODCALLTYPE CommitTransComplete(Adodb_xp::Error* pError/*[in]*/, 
                                                        Adodb_xp::EventStatusEnum* adStatus/*[in,out]*/, 
                                                        Adodb_xp::Connection15* pConnection/*[in]*/) = 0; // [3]
  virtual HRESULT STDMETHODCALLTYPE RollbackTransComplete(Adodb_xp::Error* pError/*[in]*/, 
                                                          Adodb_xp::EventStatusEnum* adStatus/*[in,out]*/, 
                                                          Adodb_xp::Connection15* pConnection/*[in]*/) = 0; // [2]
  virtual HRESULT STDMETHODCALLTYPE WillExecute(BSTR* Source/*[in,out]*/, 
                                                Adodb_xp::CursorTypeEnum* CursorType/*[in,out]*/, 
                                                Adodb_xp::LockTypeEnum* LockType/*[in,out]*/, 
                                                long* Options/*[in,out]*/, 
                                                Adodb_xp::EventStatusEnum* adStatus/*[in,out]*/, 
                                                Adodb_xp::_Command* pCommand/*[in]*/, 
                                                Adodb_xp::Recordset15* pRecordset/*[in]*/, 
                                                Adodb_xp::Connection15* pConnection/*[in]*/) = 0; // [4]
  virtual HRESULT STDMETHODCALLTYPE ExecuteComplete(long RecordsAffected/*[in]*/, 
                                                    Adodb_xp::Error* pError/*[in]*/, 
                                                    Adodb_xp::EventStatusEnum* adStatus/*[in,out]*/, 
                                                    Adodb_xp::_Command* pCommand/*[in]*/, 
                                                    Adodb_xp::Recordset15* pRecordset/*[in]*/, 
                                                    Adodb_xp::Connection15* pConnection/*[in]*/) = 0; // [5]
  virtual HRESULT STDMETHODCALLTYPE WillConnect(BSTR* ConnectionString/*[in,out]*/, 
                                                BSTR* UserID/*[in,out]*/, BSTR* Password/*[in,out]*/, 
                                                long* Options/*[in,out]*/, 
                                                Adodb_xp::EventStatusEnum* adStatus/*[in,out]*/, 
                                                Adodb_xp::Connection15* pConnection/*[in]*/) = 0; // [6]
  virtual HRESULT STDMETHODCALLTYPE ConnectComplete(Adodb_xp::Error* pError/*[in]*/, 
                                                    Adodb_xp::EventStatusEnum* adStatus/*[in,out]*/, 
                                                    Adodb_xp::Connection15* pConnection/*[in]*/) = 0; // [7]
  virtual HRESULT STDMETHODCALLTYPE Disconnect(Adodb_xp::EventStatusEnum* adStatus/*[in,out]*/, 
                                               Adodb_xp::Connection15* pConnection/*[in]*/) = 0; // [8]
};
...
public:
  virtual HRESULT STDMETHODCALLTYPE WillChangeField(long cFields/*[in]*/, VARIANT Fields/*[in]*/, 
                                                    Adodb_xp::EventStatusEnum* adStatus/*[in,out]*/, 
                                                    Adodb_xp::Recordset15* pRecordset/*[in]*/) = 0; // [9]
  virtual HRESULT STDMETHODCALLTYPE FieldChangeComplete(long cFields/*[in]*/, VARIANT Fields/*[in]*/, 
                                                        Adodb_xp::Error* pError/*[in]*/, 
                                                        Adodb_xp::EventStatusEnum* adStatus/*[in,out]*/, 
                                                        Adodb_xp::Recordset15* pRecordset/*[in]*/) = 0; // [10]
  virtual HRESULT STDMETHODCALLTYPE WillChangeRecord(Adodb_xp::EventReasonEnum adReason/*[in]*/, 
                                                     long cRecords/*[in]*/, 
                                                     Adodb_xp::EventStatusEnum* adStatus/*[in,out]*/, 
                                                     Adodb_xp::Recordset15* pRecordset/*[in]*/) = 0; // [11]
  virtual HRESULT STDMETHODCALLTYPE RecordChangeComplete(Adodb_xp::EventReasonEnum adReason/*[in]*/, 
                                                         long cRecords/*[in]*/, 
                                                         Adodb_xp::Error* pError/*[in]*/, 
                                                         Adodb_xp::EventStatusEnum* adStatus/*[in,out]*/, 
                                                         Adodb_xp::Recordset15* pRecordset/*[in]*/) = 0; // [12]
  virtual HRESULT STDMETHODCALLTYPE WillChangeRecordset(Adodb_xp::EventReasonEnum adReason/*[in]*/, 
                                                        Adodb_xp::EventStatusEnum* adStatus/*[in,out]*/, 
                                                        Adodb_xp::Recordset15* pRecordset/*[in]*/) = 0; // [13]
  virtual HRESULT STDMETHODCALLTYPE RecordsetChangeComplete(Adodb_xp::EventReasonEnum adReason/*[in]*/, 
                                                            Adodb_xp::Error* pError/*[in]*/, 
                                                            Adodb_xp::EventStatusEnum* adStatus/*[in,out]*/, 
                                                            Adodb_xp::Recordset15* pRecordset/*[in]*/) = 0; // [14]
  virtual HRESULT STDMETHODCALLTYPE WillMove(Adodb_xp::EventReasonEnum adReason/*[in]*/, 
                                             Adodb_xp::EventStatusEnum* adStatus/*[in,out]*/, 
                                             Adodb_xp::Recordset15* pRecordset/*[in]*/) = 0; // [15]
  virtual HRESULT STDMETHODCALLTYPE MoveComplete(Adodb_xp::EventReasonEnum adReason/*[in]*/, 
                                                 Adodb_xp::Error* pError/*[in]*/, 
                                                 Adodb_xp::EventStatusEnum* adStatus/*[in,out]*/, 
                                                 Adodb_xp::Recordset15* pRecordset/*[in]*/) = 0; // [16]
  virtual HRESULT STDMETHODCALLTYPE EndOfRecordset(VARIANT_BOOL* fMoreData/*[in,out]*/, 
                                                   Adodb_xp::EventStatusEnum* adStatus/*[in,out]*/, 
                                                   Adodb_xp::Recordset15* pRecordset/*[in]*/) = 0; // [17]
  virtual HRESULT STDMETHODCALLTYPE FetchProgress(long Progress/*[in]*/, long MaxProgress/*[in]*/, 
                                                  Adodb_xp::EventStatusEnum* adStatus/*[in,out]*/, 
                                                  Adodb_xp::Recordset15* pRecordset/*[in]*/) = 0; // [18]
  virtual HRESULT STDMETHODCALLTYPE FetchComplete(Adodb_xp::Error* pError/*[in]*/, 
                                                  Adodb_xp::EventStatusEnum* adStatus/*[in,out]*/, 
                                                  Adodb_xp::Recordset15* pRecordset/*[in]*/) = 0; // [19]
};
...
{
  HRESULT /*[VT_HRESULT:0]*/ __fastcall InfoMessage(Adodb_xp::Error* pError/*[in]*/, 
                                                    Adodb_xp::EventStatusEnum* adStatus/*[in,out]*/
                                                    , Adodb_xp::Connection15* pConnection/*[in]*/)
  {
    _TDispID _dispid(/* InfoMessage */ DISPID(0));
    TAutoArgs<3> _args;
    _args[1] = (LPDISPATCH)(Adodb_xp::Error*)pError /*[VT_USERDEFINED:1]*/;
    _args[2] = (int*)adStatus /*[VT_USERDEFINED:1]*/;
    _args[3] = (LPDISPATCH)(Adodb_xp::Connection15*)pConnection /*[VT_USERDEFINED:1]*/;
                                                           ...
                                                           Adodb_xp::Connection15* pConnection/*[in]*/)
  {
    ...
    _args[2] = (LPDISPATCH)(Adodb_xp::Error*)pError /*[VT_USERDEFINED:1]*/;
    _args[3] = (int*)adStatus /*[VT_USERDEFINED:1]*/;
    _args[4] = (LPDISPATCH)(Adodb_xp::Connection15*)pConnection /*[VT_USERDEFINED:1]*/;
    return OleFunction(_dispid, _args);
  }

  HRESULT /*[VT_HRESULT:0]*/ __fastcall CommitTransComplete(Adodb_xp::Error* pError/*[in]*/, 
                                                            Adodb_xp::EventStatusEnum* adStatus/*[in,out]*/
                                                            , 
                                                            Adodb_xp::Connection15* pConnection/*[in]*/)
  {
  ...
  HRESULT /*[VT_HRESULT:0]*/ __fastcall RollbackTransComplete(Adodb_xp::Error* pError/*[in]*/, 
                                                              Adodb_xp::EventStatusEnum* adStatus/*[in,out]*/
                                                              , 
                                                              Adodb_xp::Connection15* pConnection/*[in]*/)
  {
                                                    ...
                                                    Adodb_xp::Connection15* pConnection/*[in]*/)
  {
    ...
    _args[6] = (LPDISPATCH)(Adodb_xp::_Command*)pCommand /*[VT_USERDEFINED:1]*/;
    _args[7] = (LPDISPATCH)(Adodb_xp::Recordset15*)pRecordset /*[VT_USERDEFINED:1]*/;
    _args[8] = (LPDISPATCH)(Adodb_xp::Connection15*)pConnection /*[VT_USERDEFINED:1]*/;
    return OleFunction(_dispid, _args);
  }
                                                        ...
                                                        Adodb_xp::Connection15* pConnection/*[in]*/)
  {
    ...
    _args[2] = (LPDISPATCH)(Adodb_xp::Error*)pError /*[VT_USERDEFINED:1]*/;
    _args[3] = (int*)adStatus /*[VT_USERDEFINED:1]*/;
    _args[4] = (LPDISPATCH)(Adodb_xp::_Command*)pCommand /*[VT_USERDEFINED:1]*/;
    _args[5] = (LPDISPATCH)(Adodb_xp::Recordset15*)pRecordset /*[VT_USERDEFINED:1]*/;
    _args[6] = (LPDISPATCH)(Adodb_xp::Connection15*)pConnection /*[VT_USERDEFINED:1]*/;
    return OleFunction(_dispid, _args);
  }
  ...
  HRESULT /*[VT_HRESULT:0]*/ __fastcall ConnectComplete(Adodb_xp::Error* pError/*[in]*/, 
                                                        Adodb_xp::EventStatusEnum* adStatus/*[in,out]*/
                                                        , 
                                                        Adodb_xp::Connection15* pConnection/*[in]*/)
  {
  ...
  HRESULT /*[VT_HRESULT:0]*/ __fastcall Disconnect(Adodb_xp::EventStatusEnum* adStatus/*[in,out]*/, 
                                                   Adodb_xp::Connection15* pConnection/*[in]*/)
  {
    _TDispID _dispid(/* Disconnect */ DISPID(8));
    TAutoArgs<2> _args;
    _args[1] = (int*)adStatus /*[VT_USERDEFINED:1]*/;
    _args[2] = (LPDISPATCH)(Adodb_xp::Connection15*)pConnection /*[VT_USERDEFINED:1]*/;
    return OleFunction(_dispid, _args);
  }
...
interface RecordsetEvents : public TDispWrapper<IDispatch>
{
                                                        ...
                                                        , Adodb_xp::Recordset15* pRecordset/*[in]*/)
  {
    ...
    _args[3] = (int*)adStatus /*[VT_USERDEFINED:1]*/;
    _args[4] = (LPDISPATCH)(Adodb_xp::Recordset15*)pRecordset /*[VT_USERDEFINED:1]*/;
    return OleFunction(_dispid, _args);
  }
                                                            ...
                                                            Adodb_xp::Recordset15* pRecordset/*[in]*/)
  {
    ...
    _args[1] = cFields /*[VT_I4:0]*/;
    _args[2] = Fields /*[VT_VARIANT:0]*/;
    _args[3] = (LPDISPATCH)(Adodb_xp::Error*)pError /*[VT_USERDEFINED:1]*/;
    _args[4] = (int*)adStatus /*[VT_USERDEFINED:1]*/;
    _args[5] = (LPDISPATCH)(Adodb_xp::Recordset15*)pRecordset /*[VT_USERDEFINED:1]*/;
    return OleFunction(_dispid, _args);
  }

  HRESULT /*[VT_HRESULT:0]*/ __fastcall WillChangeRecord(Adodb_xp::EventReasonEnum adReason/*[in]*/
                                                         , long cRecords/*[in]*/, 
                                                         Adodb_xp::EventStatusEnum* adStatus/*[in,out]*/
                                                         , Adodb_xp::Recordset15* pRecordset/*[in]*/)
  {
  ...
  HRESULT /*[VT_HRESULT:0]*/ __fastcall RecordChangeComplete(Adodb_xp::EventReasonEnum adReason/*[in]*/
                                                             , long cRecords/*[in]*/, 
                                                             Adodb_xp::Error* pError/*[in]*/, 
                                                             Adodb_xp::EventStatusEnum* adStatus/*[in,out]*/
                                                             , 
  ...
  HRESULT /*[VT_HRESULT:0]*/ __fastcall WillChangeRecordset(Adodb_xp::EventReasonEnum adReason/*[in]*/
                                                            , 
                                                            Adodb_xp::EventStatusEnum* adStatus/*[in,out]*/
                                                            , 
                                                            Adodb_xp::Recordset15* pRecordset/*[in]*/)
  {
    ...
    _args[1] = (int)adReason /*[VT_USERDEFINED:0]*/;
    _args[2] = (int*)adStatus /*[VT_USERDEFINED:1]*/;
    _args[3] = (LPDISPATCH)(Adodb_xp::Recordset15*)pRecordset /*[VT_USERDEFINED:1]*/;
    return OleFunction(_dispid, _args);
  }

  HRESULT /*[VT_HRESULT:0]*/ __fastcall RecordsetChangeComplete(Adodb_xp::EventReasonEnum adReason/*[in]*/
                                                                , Adodb_xp::Error* pError/*[in]*/, 
                                                                Adodb_xp::EventStatusEnum* adStatus/*[in,out]*/
                                                                , 
                                                                Adodb_xp::Recordset15* pRecordset/*[in]*/)
  ...
  HRESULT /*[VT_HRESULT:0]*/ __fastcall WillMove(Adodb_xp::EventReasonEnum adReason/*[in]*/, 
                                                 Adodb_xp::EventStatusEnum* adStatus/*[in,out]*/, 
                                                 Adodb_xp::Recordset15* pRecordset/*[in]*/)
  {
  ...
  HRESULT /*[VT_HRESULT:0]*/ __fastcall MoveComplete(Adodb_xp::EventReasonEnum adReason/*[in]*/, 
                                                     Adodb_xp::Error* pError/*[in]*/, 
                                                     Adodb_xp::EventStatusEnum* adStatus/*[in,out]*/
                                                     , Adodb_xp::Recordset15* pRecordset/*[in]*/)
  {
  ...
  HRESULT /*[VT_HRESULT:0]*/ __fastcall FetchComplete(Adodb_xp::Error* pError/*[in]*/, 
                                                      Adodb_xp::EventStatusEnum* adStatus/*[in,out]*/
                                                      , Adodb_xp::Recordset15* pRecordset/*[in]*/)
  {
...
// *********************************************************************//
interface ADOConnectionConstruction  : public Adodb_xp::ADOConnectionConstruction15
{
public:
};
...
// *********************************************************************//
interface Field15  : public Adodb_xp::_ADO
{
public:
  virtual HRESULT STDMETHODCALLTYPE get_ActualSize(long* pl/*[out,retval]*/) = 0; // [1109]
  virtual HRESULT STDMETHODCALLTYPE get_Attributes(long* pl/*[out,retval]*/) = 0; // [1036]
...
public:
  ...
  HRESULT /*[VT_HRESULT:0]*/ __fastcall get_Properties(Adodb_xp::Properties** ppvObject/*[out,retval]*/);
  Adodb_xp::Properties* __fastcall get_Properties(void);
...
public:
  ...
  HRESULT /*[VT_HRESULT:0]*/ __fastcall get_Item(VARIANT Index/*[in]*/, 
                                                 Adodb_xp::Property** ppvObject/*[out,retval]*/);
  Adodb_xp::Property* __fastcall get_Item(VARIANT Index/*[in]*/);
  HRESULT /*[VT_HRESULT:0]*/ __fastcall get_Count(long* c/*[out,retval]*/);
  long            __fastcall get_Count(void);
  HRESULT /*[VT_HRESULT:0]*/ __fastcall _NewEnum(LPUNKNOWN* ppvObject/*[out,retval]*/);
...
public:
  ...
  BSTR            __fastcall get_Name(void);
  HRESULT /*[VT_HRESULT:0]*/ __fastcall get_Type(Adodb_xp::DataTypeEnum* ptype/*[out,retval]*/);
  Adodb_xp::DataTypeEnum __fastcall get_Type(void);
...
public:
  ...
  HRESULT /*[VT_HRESULT:0]*/ __fastcall get_Item(VARIANT Index/*[in]*/, 
                                                 Adodb_xp::Error** ppvObject/*[out,retval]*/);
  Adodb_xp::Error* __fastcall get_Item(VARIANT Index/*[in]*/);
...
public:
  ...
  HRESULT /*[VT_HRESULT:0]*/ __fastcall get_ActiveConnection(Adodb_xp::Connection15** ppvObject/*[out,retval]*/);
  Adodb_xp::Connection15* __fastcall get_ActiveConnection(void);
  HRESULT /*[VT_HRESULT:0]*/ __fastcall _set_ActiveConnection(Adodb_xp::Connection15* ppvObject/*[in]*/);
  ...
  HRESULT /*[VT_HRESULT:0]*/ __fastcall Execute(VARIANT* RecordsAffected/*[out,opt]*/, 
                                                VARIANT* Parameters/*[in,opt]*/, 
                                                long Options/*[in,def,opt]*/, 
                                                Adodb_xp::Recordset15** ppiRs/*[out,retval]*/);
  Adodb_xp::Recordset15* __fastcall Execute(VARIANT* RecordsAffected/*[out,opt]*/, 
                                            VARIANT* Parameters/*[in,opt]*/, 
                                            long Options/*[in,def,opt]*/);
  HRESULT /*[VT_HRESULT:0]*/ __fastcall CreateParameter(BSTR Name/*[in,def,opt]*/, 
                                                        ...
                                                        , long Size/*[in,def,opt]*/, 
                                                        VARIANT Value/*[in,opt]*/, 
                                                        Adodb_xp::_Parameter** ppiprm/*[out,retval]*/);
  Adodb_xp::_Parameter* __fastcall CreateParameter(BSTR Name/*[in,def,opt]*/, 
                                                   Adodb_xp::DataTypeEnum Type/*[in,def,opt]*/, 
                                                   Adodb_xp::ParameterDirectionEnum Direction/*[in,def,opt]*/, 
                                                   long Size/*[in,def,opt]*/, 
                                                   VARIANT Value/*[in,opt]*/= TNoParam());
  HRESULT /*[VT_HRESULT:0]*/ __fastcall get_Parameters(Adodb_xp::Parameters** ppvObject/*[out,retval]*/);
  Adodb_xp::Parameters* __fastcall get_Parameters(void);
  HRESULT /*[VT_HRESULT:0]*/ __fastcall set_CommandType(Adodb_xp::CommandTypeEnum plCmdType/*[in]*/);
  HRESULT /*[VT_HRESULT:0]*/ __fastcall get_CommandType(Adodb_xp::CommandTypeEnum* plCmdType/*[out,retval]*/);
  Adodb_xp::CommandTypeEnum __fastcall get_CommandType(void);
...
public:
  ...
  HRESULT         __fastcall Execute(BSTR CommandText/*[in]*/, VARIANT* RecordsAffected/*[out,opt]*/, 
                                     long Options/*[in,def,opt]*/, 
                                     Adodb_xp::Recordset15** ppiRset/*[out,retval]*/);
  Adodb_xp::Recordset15* __fastcall Execute(BSTR CommandText/*[in]*/, 
                                            VARIANT* RecordsAffected/*[out,opt]*/, 
                                            long Options/*[in,def,opt]*/);
  ...
  HRESULT         __fastcall get_Errors(Adodb_xp::Errors** ppvObject/*[out,retval]*/);
  HRESULT         __fastcall get_Errors(Adodb_xp::ErrorsPtr* ppvObject/*[out,retval]*/);
  Adodb_xp::ErrorsPtr __fastcall get_Errors(void);
  HRESULT         __fastcall get_DefaultDatabase(BSTR* pbstr/*[out,retval]*/);
  BSTR            __fastcall get_DefaultDatabase(void);
  HRESULT         __fastcall set_DefaultDatabase(BSTR pbstr/*[in]*/);
  HRESULT         __fastcall get_IsolationLevel(Adodb_xp::IsolationLevelEnum* Level/*[out,retval]*/);
  Adodb_xp::IsolationLevelEnum __fastcall get_IsolationLevel(void);
  HRESULT         __fastcall set_IsolationLevel(Adodb_xp::IsolationLevelEnum Level/*[in]*/);
  HRESULT         __fastcall get_Attributes(long* plAttr/*[out,retval]*/);
  long            __fastcall get_Attributes(void);
  HRESULT         __fastcall set_Attributes(long plAttr/*[in]*/);
  HRESULT         __fastcall get_CursorLocation(Adodb_xp::CursorLocationEnum* plCursorLoc/*[out,retval]*/);
  Adodb_xp::CursorLocationEnum __fastcall get_CursorLocation(void);
  HRESULT         __fastcall set_CursorLocation(Adodb_xp::CursorLocationEnum plCursorLoc/*[in]*/);
  HRESULT         __fastcall get_Mode(Adodb_xp::ConnectModeEnum* plMode/*[out,retval]*/);
  Adodb_xp::ConnectModeEnum __fastcall get_Mode(void);
  HRESULT         __fastcall set_Mode(Adodb_xp::ConnectModeEnum plMode/*[in]*/);
  ...
  long            __fastcall get_State(void);
  HRESULT         __fastcall OpenSchema(Adodb_xp::SchemaEnum Schema/*[in]*/, 
                                        VARIANT Restrictions/*[in,opt]*/, 
                                        VARIANT SchemaID/*[in,opt]*/, 
                                        Adodb_xp::Recordset15** pprset/*[out,retval]*/);
  Adodb_xp::Recordset15* __fastcall OpenSchema(Adodb_xp::SchemaEnum Schema/*[in]*/, 
                                               VARIANT Restrictions/*[in,opt]*/= TNoParam(), 
                                               VARIANT SchemaID/*[in,opt]*/= TNoParam());
  ...
  __property   long            ConnectionTimeout = {read = get_ConnectionTimeout, write = set_ConnectionTimeout};
  __property   BSTR            Version = {read = get_Version};
  __property   Adodb_xp::ErrorsPtr Errors = {read = get_Errors};
  __property   BSTR            DefaultDatabase = {read = get_DefaultDatabase};
  __property   Adodb_xp::IsolationLevelEnum IsolationLevel = {read = get_IsolationLevel, write = set_IsolationLevel};
  __property   long            Attributes = {read = get_Attributes, write = set_Attributes};
  __property   Adodb_xp::CursorLocationEnum CursorLocation = {read = get_CursorLocation, write = set_CursorLocation};
...
public:
  ...
  HRESULT /*[VT_HRESULT:0]*/ __fastcall Open(BSTR ConnectionString/*[in,def,opt]*/, 
                                             ...
                                             long Options/*[in,def,opt]*/);
  HRESULT /*[VT_HRESULT:0]*/ __fastcall get_Errors(Adodb_xp::Errors** ppvObject/*[out,retval]*/);
  Adodb_xp::Errors* __fastcall get_Errors(void);
  ...
  HRESULT /*[VT_HRESULT:0]*/ __fastcall get_IsolationLevel(Adodb_xp::IsolationLevelEnum* Level/*[out,retval]*/);
  Adodb_xp::IsolationLevelEnum __fastcall get_IsolationLevel(void);
  HRESULT /*[VT_HRESULT:0]*/ __fastcall set_IsolationLevel(Adodb_xp::IsolationLevelEnum Level/*[in]*/);
  ...
  HRESULT /*[VT_HRESULT:0]*/ __fastcall get_CursorLocation(Adodb_xp::CursorLocationEnum* plCursorLoc/*[out,retval]*/);
  Adodb_xp::CursorLocationEnum __fastcall get_CursorLocation(void);
  HRESULT /*[VT_HRESULT:0]*/ __fastcall set_CursorLocation(Adodb_xp::CursorLocationEnum plCursorLoc/*[in]*/);
  HRESULT /*[VT_HRESULT:0]*/ __fastcall get_Mode(Adodb_xp::ConnectModeEnum* plMode/*[out,retval]*/);
  Adodb_xp::ConnectModeEnum __fastcall get_Mode(void);
  HRESULT /*[VT_HRESULT:0]*/ __fastcall set_Mode(Adodb_xp::ConnectModeEnum plMode/*[in]*/);
  ...
  long            __fastcall get_State(void);
  HRESULT /*[VT_HRESULT:0]*/ __fastcall OpenSchema(Adodb_xp::SchemaEnum Schema/*[in]*/, 
                                                   VARIANT Restrictions/*[in,opt]*/, 
                                                   VARIANT SchemaID/*[in,opt]*/, 
                                                   Adodb_xp::Recordset15** pprset/*[out,retval]*/);
  Adodb_xp::Recordset15* __fastcall OpenSchema(Adodb_xp::SchemaEnum Schema/*[in]*/, 
...
public:
  ...
  HRESULT         __fastcall get_AbsolutePosition(Adodb_xp::PositionEnum* pl/*[out,retval]*/);
  Adodb_xp::PositionEnum __fastcall get_AbsolutePosition(void);
  HRESULT         __fastcall set_AbsolutePosition(Adodb_xp::PositionEnum pl/*[in]*/);
  ...
  HRESULT         __fastcall get_CursorType(Adodb_xp::CursorTypeEnum* plCursorType/*[out,retval]*/);
  Adodb_xp::CursorTypeEnum __fastcall get_CursorType(void);
  HRESULT         __fastcall set_CursorType(Adodb_xp::CursorTypeEnum plCursorType/*[in]*/);
  ...
  HRESULT         __fastcall get_Fields(Adodb_xp::Fields15** ppvObject/*[out,retval]*/);
  HRESULT         __fastcall get_Fields(Adodb_xp::Fields15Ptr* ppvObject/*[out,retval]*/);
  Adodb_xp::Fields15Ptr __fastcall get_Fields(void);
  HRESULT         __fastcall get_LockType(Adodb_xp::LockTypeEnum* plLockType/*[out,retval]*/);
  Adodb_xp::LockTypeEnum __fastcall get_LockType(void);
  HRESULT         __fastcall set_LockType(Adodb_xp::LockTypeEnum plLockType/*[in]*/);
  ...
  HRESULT         __fastcall Close(void);
  HRESULT         __fastcall Delete(Adodb_xp::AffectEnum AffectRecords/*[in,def,opt]*/);
  ...
  HRESULT         __fastcall _xResync(Adodb_xp::AffectEnum AffectRecords/*[in,def,opt]*/);
  HRESULT         __fastcall Update(VARIANT Fields/*[in,opt]*/= TNoParam(), 
                                    VARIANT Values/*[in,opt]*/= TNoParam());
  HRESULT         __fastcall get_AbsolutePage(Adodb_xp::PositionEnum* pl/*[out,retval]*/);
  Adodb_xp::PositionEnum __fastcall get_AbsolutePage(void);
  HRESULT         __fastcall set_AbsolutePage(Adodb_xp::PositionEnum pl/*[in]*/);
  HRESULT         __fastcall get_EditMode(Adodb_xp::EditModeEnum* pl/*[out,retval]*/);
  Adodb_xp::EditModeEnum __fastcall get_EditMode(void);
  ...
  HRESULT         __fastcall get_State(long* plObjState/*[out,retval]*/);
  long            __fastcall get_State(void);
  HRESULT         __fastcall _xClone(Adodb_xp::Recordset15** ppvObject/*[out,retval]*/);
  Adodb_xp::Recordset15* __fastcall _xClone(void);
  HRESULT         __fastcall UpdateBatch(Adodb_xp::AffectEnum AffectRecords/*[in,def,opt]*/);
  HRESULT         __fastcall CancelBatch(Adodb_xp::AffectEnum AffectRecords/*[in,def,opt]*/);
  HRESULT         __fastcall get_CursorLocation(Adodb_xp::CursorLocationEnum* plCursorLoc/*[out,retval]*/);
  Adodb_xp::CursorLocationEnum __fastcall get_CursorLocation(void);
  HRESULT         __fastcall set_CursorLocation(Adodb_xp::CursorLocationEnum plCursorLoc/*[in]*/);
  HRESULT         __fastcall NextRecordset(VARIANT* RecordsAffected/*[out,opt]*/, 
                                           Adodb_xp::Recordset15** ppiRs/*[out,retval]*/);
  Adodb_xp::Recordset15* __fastcall NextRecordset(VARIANT* RecordsAffected/*[out,opt]*/= TNoParam());
  HRESULT         __fastcall Supports(Adodb_xp::CursorOptionEnum CursorOptions/*[in]*/, 
  ...
  HRESULT         __fastcall get_MarshalOptions(Adodb_xp::MarshalOptionsEnum* peMarshal/*[out,retval]*/);
  Adodb_xp::MarshalOptionsEnum __fastcall get_MarshalOptions(void);
  HRESULT         __fastcall set_MarshalOptions(Adodb_xp::MarshalOptionsEnum peMarshal/*[in]*/);
  ...
  __property   Adodb_xp::Fields15Ptr Fields = {read = get_Fields};
  __property   Adodb_xp::LockTypeEnum LockType = {read = get_LockType, write = set_LockType};
  __property   long            MaxRecords = {read = get_MaxRecords, write = set_MaxRecords};
  __property   long            RecordCount = {read = get_RecordCount};
  __property   LPDISPATCH      Source = {write = _set_Source};
...
public:
  ...
  HRESULT /*[VT_HRESULT:0]*/ __fastcall get_AbsolutePosition(Adodb_xp::PositionEnum* pl/*[out,retval]*/);
  Adodb_xp::PositionEnum __fastcall get_AbsolutePosition(void);
  HRESULT /*[VT_HRESULT:0]*/ __fastcall set_AbsolutePosition(Adodb_xp::PositionEnum pl/*[in]*/);
  ...
  HRESULT /*[VT_HRESULT:0]*/ __fastcall get_CursorType(Adodb_xp::CursorTypeEnum* plCursorType/*[out,retval]*/);
  Adodb_xp::CursorTypeEnum __fastcall get_CursorType(void);
  HRESULT /*[VT_HRESULT:0]*/ __fastcall set_CursorType(Adodb_xp::CursorTypeEnum plCursorType/*[in]*/);
  HRESULT /*[VT_HRESULT:0]*/ __fastcall get_EOF_(VARIANT_BOOL* pb/*[out,retval]*/);
  VARIANT_BOOL    __fastcall get_EOF_(void);
  HRESULT /*[VT_HRESULT:0]*/ __fastcall get_Fields(Adodb_xp::Fields15** ppvObject/*[out,retval]*/);
  Adodb_xp::Fields15* __fastcall get_Fields(void);
  HRESULT /*[VT_HRESULT:0]*/ __fastcall get_LockType(Adodb_xp::LockTypeEnum* plLockType/*[out,retval]*/);
  Adodb_xp::LockTypeEnum __fastcall get_LockType(void);
  HRESULT /*[VT_HRESULT:0]*/ __fastcall set_LockType(Adodb_xp::LockTypeEnum plLockType/*[in]*/);
  ...
  HRESULT /*[VT_HRESULT:0]*/ __fastcall Close();
  HRESULT /*[VT_HRESULT:0]*/ __fastcall Delete(Adodb_xp::AffectEnum AffectRecords/*[in,def,opt]*/);
  ...
  HRESULT /*[VT_HRESULT:0]*/ __fastcall _xResync(Adodb_xp::AffectEnum AffectRecords/*[in,def,opt]*/);
  HRESULT /*[VT_HRESULT:0]*/ __fastcall Update(VARIANT Fields/*[in,opt]*/= TNoParam(), 
                                               VARIANT Values/*[in,opt]*/= TNoParam());
  HRESULT /*[VT_HRESULT:0]*/ __fastcall get_AbsolutePage(Adodb_xp::PositionEnum* pl/*[out,retval]*/);
  Adodb_xp::PositionEnum __fastcall get_AbsolutePage(void);
  HRESULT /*[VT_HRESULT:0]*/ __fastcall set_AbsolutePage(Adodb_xp::PositionEnum pl/*[in]*/);
  HRESULT /*[VT_HRESULT:0]*/ __fastcall get_EditMode(Adodb_xp::EditModeEnum* pl/*[out,retval]*/);
  Adodb_xp::EditModeEnum __fastcall get_EditMode(void);
  ...
  HRESULT /*[VT_HRESULT:0]*/ __fastcall get_State(long* plObjState/*[out,retval]*/);
  long            __fastcall get_State(void);
  HRESULT /*[VT_HRESULT:0]*/ __fastcall _xClone(Adodb_xp::Recordset15** ppvObject/*[out,retval]*/);
  Adodb_xp::Recordset15* __fastcall _xClone(void);
  HRESULT /*[VT_HRESULT:0]*/ __fastcall UpdateBatch(Adodb_xp::AffectEnum AffectRecords/*[in,def,opt]*/);
  HRESULT /*[VT_HRESULT:0]*/ __fastcall CancelBatch(Adodb_xp::AffectEnum AffectRecords/*[in,def,opt]*/);
  HRESULT /*[VT_HRESULT:0]*/ __fastcall get_CursorLocation(Adodb_xp::CursorLocationEnum* plCursorLoc/*[out,retval]*/);
  Adodb_xp::CursorLocationEnum __fastcall get_CursorLocation(void);
  HRESULT /*[VT_HRESULT:0]*/ __fastcall set_CursorLocation(Adodb_xp::CursorLocationEnum plCursorLoc/*[in]*/);
  HRESULT /*[VT_HRESULT:0]*/ __fastcall NextRecordset(VARIANT* RecordsAffected/*[out,opt]*/, 
                                                      Adodb_xp::Recordset15** ppiRs/*[out,retval]*/);
  Adodb_xp::Recordset15* __fastcall NextRecordset(VARIANT* RecordsAffected/*[out,opt]*/= TNoParam());
  HRESULT /*[VT_HRESULT:0]*/ __fastcall Supports(Adodb_xp::CursorOptionEnum CursorOptions/*[in]*/, 
                                                 VARIANT_BOOL* pb/*[out,retval]*/);
  VARIANT_BOOL    __fastcall Supports(Adodb_xp::CursorOptionEnum CursorOptions/*[in]*/);
  ...
  HRESULT /*[VT_HRESULT:0]*/ __fastcall get_MarshalOptions(Adodb_xp::MarshalOptionsEnum* peMarshal/*[out,retval]*/);
  Adodb_xp::MarshalOptionsEnum __fastcall get_MarshalOptions(void);
  HRESULT /*[VT_HRESULT:0]*/ __fastcall set_MarshalOptions(Adodb_xp::MarshalOptionsEnum peMarshal/*[in]*/);
...
public:
  ...
  HRESULT /*[VT_HRESULT:0]*/ __fastcall Save(BSTR FileName/*[in,opt]*/, 
                                             Adodb_xp::PersistFormatEnum PersistFormat/*[in,def,opt]*/);
  ...
  VARIANT_BOOL    __fastcall get_StayInSync(void);
  HRESULT /*[VT_HRESULT:0]*/ __fastcall GetString(Adodb_xp::StringFormatEnum StringFormat/*[in,def,opt]*/
                                                  , long NumRows/*[in,def,opt]*/, 
                                                  BSTR ColumnDelimeter/*[in,opt]*/, 
                                                  BSTR RowDelimeter/*[in,opt]*/, 
                                                  BSTR NullExpr/*[in,opt]*/, 
  ...
  HRESULT /*[VT_HRESULT:0]*/ __fastcall CompareBookmarks(VARIANT Bookmark1/*[in]*/, 
                                                         VARIANT Bookmark2/*[in]*/, 
                                                         Adodb_xp::CompareEnum* pCompare/*[out,retval]*/);
  Adodb_xp::CompareEnum __fastcall CompareBookmarks(VARIANT Bookmark1/*[in]*/, 
                                                    VARIANT Bookmark2/*[in]*/);
  HRESULT /*[VT_HRESULT:0]*/ __fastcall Clone(Adodb_xp::LockTypeEnum LockType/*[in,def,opt]*/, 
                                              Adodb_xp::Recordset15** ppvObject/*[out,retval]*/);
  Adodb_xp::Recordset15* __fastcall Clone(Adodb_xp::LockTypeEnum LockType/*[in,def,opt]*/);
  HRESULT /*[VT_HRESULT:0]*/ __fastcall Resync(Adodb_xp::AffectEnum AffectRecords/*[in,def,opt]*/, 
                                               Adodb_xp::ResyncEnum ResyncValues/*[in,def,opt]*/);
  HRESULT /*[VT_HRESULT:0]*/ __fastcall get_AbsolutePosition(Adodb_xp::PositionEnum* pl/*[out,retval]*/);
  Adodb_xp::PositionEnum __fastcall get_AbsolutePosition(void);
  HRESULT /*[VT_HRESULT:0]*/ __fastcall set_AbsolutePosition(Adodb_xp::PositionEnum pl/*[in]*/);
  HRESULT /*[VT_HRESULT:0]*/ __fastcall _set_ActiveConnection(LPDISPATCH pvar/*[in]*/);
...
public:
  ...
  HRESULT /*[VT_HRESULT:0]*/ __fastcall Seek(VARIANT KeyValues/*[in]*/, 
                                             Adodb_xp::SeekEnum SeekOption/*[in,def,opt]*/);
...
public:
  ...
  HRESULT /*[VT_HRESULT:0]*/ __fastcall get_Item(VARIANT Index/*[in]*/, 
                                                 Adodb_xp::Field** ppvObject/*[out,retval]*/);
  Adodb_xp::Field* __fastcall get_Item(VARIANT Index/*[in]*/);
  HRESULT /*[VT_HRESULT:0]*/ __fastcall get_Count(long* c/*[out,retval]*/);
  long            __fastcall get_Count(void);
  HRESULT /*[VT_HRESULT:0]*/ __fastcall _NewEnum(LPUNKNOWN* ppvObject/*[out,retval]*/);
...
public:
  ...
  HRESULT /*[VT_HRESULT:0]*/ __fastcall Append(BSTR Name/*[in]*/, 
                                               Adodb_xp::DataTypeEnum Type/*[in]*/, 
                                               long DefinedSize/*[in,def,opt]*/, 
                                               Adodb_xp::FieldAttributeEnum Attrib/*[in,def,opt]*/);
  HRESULT /*[VT_HRESULT:0]*/ __fastcall Delete(VARIANT Index/*[in]*/);
  HRESULT /*[VT_HRESULT:0]*/ __fastcall get_Item(VARIANT Index/*[in]*/, 
                                                 Adodb_xp::Field** ppvObject/*[out,retval]*/);
  Adodb_xp::Field* __fastcall get_Item(VARIANT Index/*[in]*/);
...
public:
  ...
  HRESULT /*[VT_HRESULT:0]*/ __fastcall get_Name(BSTR* pbstr/*[out,retval]*/);
  BSTR            __fastcall get_Name(void);
  HRESULT /*[VT_HRESULT:0]*/ __fastcall get_Type(Adodb_xp::DataTypeEnum* pDataType/*[out,retval]*/);
  Adodb_xp::DataTypeEnum __fastcall get_Type(void);
  ...
  HRESULT /*[VT_HRESULT:0]*/ __fastcall set_Type(Adodb_xp::DataTypeEnum pDataType/*[in]*/);
...
public:
  ...
  HRESULT         __fastcall get_Type(Adodb_xp::DataTypeEnum* psDataType/*[out,retval]*/);
  Adodb_xp::DataTypeEnum __fastcall get_Type(void);
  HRESULT         __fastcall set_Type(Adodb_xp::DataTypeEnum psDataType/*[in]*/);
  HRESULT         __fastcall set_Direction(Adodb_xp::ParameterDirectionEnum plParmDirection/*[in]*/);
  HRESULT         __fastcall get_Direction(Adodb_xp::ParameterDirectionEnum* plParmDirection/*[out,retval]*/);
  Adodb_xp::ParameterDirectionEnum __fastcall get_Direction(void);
...
public:
  ...
  VARIANT         __fastcall get_Value(void);
  HRESULT /*[VT_HRESULT:0]*/ __fastcall set_Value(VARIANT pvar/*[in]*/);
  HRESULT /*[VT_HRESULT:0]*/ __fastcall get_Type(Adodb_xp::DataTypeEnum* psDataType/*[out,retval]*/);
  Adodb_xp::DataTypeEnum __fastcall get_Type(void);
  HRESULT /*[VT_HRESULT:0]*/ __fastcall set_Type(Adodb_xp::DataTypeEnum psDataType/*[in]*/);
  HRESULT /*[VT_HRESULT:0]*/ __fastcall set_Direction(Adodb_xp::ParameterDirectionEnum plParmDirection/*[in]*/);
  HRESULT /*[VT_HRESULT:0]*/ __fastcall get_Direction(Adodb_xp::ParameterDirectionEnum* plParmDirection/*[out,retval]*/);
  Adodb_xp::ParameterDirectionEnum __fastcall get_Direction(void);
  HRESULT /*[VT_HRESULT:0]*/ __fastcall set_Precision(unsigned_char pbPrecision/*[in]*/);
  HRESULT /*[VT_HRESULT:0]*/ __fastcall get_Precision(unsigned_char* pbPrecision/*[out,retval]*/);
  unsigned_char   __fastcall get_Precision(void);
...
public:
  ...
  HRESULT /*[VT_HRESULT:0]*/ __fastcall get_Item(VARIANT Index/*[in]*/, 
                                                 Adodb_xp::_Parameter** ppvObject/*[out,retval]*/);
  Adodb_xp::_Parameter* __fastcall get_Item(VARIANT Index/*[in]*/);
  HRESULT /*[VT_HRESULT:0]*/ __fastcall Append(LPDISPATCH Object/*[in]*/);
  HRESULT /*[VT_HRESULT:0]*/ __fastcall Delete(VARIANT Index/*[in]*/);
  HRESULT /*[VT_HRESULT:0]*/ __fastcall get_Count(long* c/*[out,retval]*/);
...
// *********************************************************************//
template <class T> HRESULT /*[VT_HRESULT:0]*/ __fastcall
_ADODispT<T>::get_Properties(Adodb_xp::Properties** ppvObject/*[out,retval]*/)
{
  _TDispID _dispid(*this, OLETEXT("Properties"), DISPID(500));
  TAutoArgs<0> _args;
  return OutRetValSetterPtr((LPDISPATCH*)(Adodb_xp::Properties**)ppvObject /*[VT_USERDEFINED:2]*/, _args, OlePropertyGet(_dispid, _args));
}

template <class T> Adodb_xp::Properties* __fastcall
_ADODispT<T>::get_Properties(void)
{
  Adodb_xp::Properties* ppvObject;
  this->get_Properties((Adodb_xp::Properties**)&ppvObject);
  return ppvObject;
}
...
// *********************************************************************//
template <class T> HRESULT /*[VT_HRESULT:0]*/ __fastcall
PropertiesDispT<T>::get_Item(VARIANT Index/*[in]*/, Adodb_xp::Property** ppvObject/*[out,retval]*/)
{
  _TDispID _dispid(*this, OLETEXT("Item"), DISPID(0));
  TAutoArgs<1> _args;
  _args[1] = Index /*[VT_VARIANT:0]*/;
  return OutRetValSetterPtr((LPDISPATCH*)(Adodb_xp::Property**)ppvObject /*[VT_USERDEFINED:2]*/, _args, OlePropertyGet(_dispid, _args));
}

template <class T> Adodb_xp::Property* __fastcall
PropertiesDispT<T>::get_Item(VARIANT Index/*[in]*/)
{
  Adodb_xp::Property* ppvObject;
  this->get_Item(Index, (Adodb_xp::Property**)&ppvObject);
  return ppvObject;
}
...
template <class T> HRESULT /*[VT_HRESULT:0]*/ __fastcall
PropertyDispT<T>::get_Type(Adodb_xp::DataTypeEnum* ptype/*[out,retval]*/)
{
...
{
  Adodb_xp::DataTypeEnum ptype;
  this->get_Type((Adodb_xp::DataTypeEnum*)&ptype);
  return ptype;
}
...
// *********************************************************************//
template <class T> HRESULT /*[VT_HRESULT:0]*/ __fastcall
ErrorsDispT<T>::get_Item(VARIANT Index/*[in]*/, Adodb_xp::Error** ppvObject/*[out,retval]*/)
{
  _TDispID _dispid(*this, OLETEXT("Item"), DISPID(0));
  TAutoArgs<1> _args;
  _args[1] = Index /*[VT_VARIANT:0]*/;
  return OutRetValSetterPtr((LPDISPATCH*)(Adodb_xp::Error**)ppvObject /*[VT_USERDEFINED:2]*/, _args, OlePropertyGet(_dispid, _args));
}
...
{
  Adodb_xp::Error* ppvObject;
  this->get_Item(Index, (Adodb_xp::Error**)&ppvObject);
  return ppvObject;
}
...
// *********************************************************************//
template <class T> HRESULT /*[VT_HRESULT:0]*/ __fastcall
Command15DispT<T>::get_ActiveConnection(Adodb_xp::Connection15** ppvObject/*[out,retval]*/)
{
  _TDispID _dispid(*this, OLETEXT("ActiveConnection"), DISPID(DISPID_UNKNOWN/*[1610809344]*/));
  TAutoArgs<0> _args;
  return OutRetValSetterPtr((LPDISPATCH*)(Adodb_xp::Connection15**)ppvObject /*[VT_USERDEFINED:2]*/, _args, OlePropertyGet(_dispid, _args));
}

template <class T> Adodb_xp::Connection15* __fastcall
Command15DispT<T>::get_ActiveConnection(void)
{
  Adodb_xp::Connection15* ppvObject;
  this->get_ActiveConnection((Adodb_xp::Connection15**)&ppvObject);
  return ppvObject;
}

template <class T> HRESULT /*[VT_HRESULT:0]*/ __fastcall
Command15DispT<T>::_set_ActiveConnection(Adodb_xp::Connection15* ppvObject/*[in]*/)
{
  _TDispID _dispid(*this, OLETEXT("ActiveConnection"), DISPID(1610809344));
  TAutoArgs<1> _args;
  _args[1] = (LPDISPATCH)(Adodb_xp::Connection15*)ppvObject /*[VT_USERDEFINED:1]*/;
  return OlePropertyPut(_dispid, _args);
}
                           ...
                           Adodb_xp::Recordset15** ppiRs/*[out,retval]*/)
{
  ...
  return OutRetValSetterPtr((LPDISPATCH*)(Adodb_xp::Recordset15**)ppiRs /*[VT_USERDEFINED:2]*/, _args, OleFunction(_dispid, _args));
}

template <class T> Adodb_xp::Recordset15* __fastcall
Command15DispT<T>::Execute(VARIANT* RecordsAffected/*[out,opt]*/, VARIANT* Parameters/*[in,opt]*/, 
                           long Options/*[in,def,opt]*/)
{
  Adodb_xp::Recordset15* ppiRs;
  this->Execute(RecordsAffected, Parameters, Options, (Adodb_xp::Recordset15**)&ppiRs);
  return ppiRs;
}
                                   ...
                                   Adodb_xp::_Parameter** ppiprm/*[out,retval]*/)
{
  ...
  return OutRetValSetterPtr((LPDISPATCH*)(Adodb_xp::_Parameter**)ppiprm /*[VT_USERDEFINED:2]*/, _args, OleFunction(_dispid, _args));
}

template <class T> Adodb_xp::_Parameter* __fastcall
Command15DispT<T>::CreateParameter(BSTR Name/*[in,def,opt]*/, 
                                   Adodb_xp::DataTypeEnum Type/*[in,def,opt]*/, 
                                   Adodb_xp::ParameterDirectionEnum Direction/*[in,def,opt]*/, 
                                   long Size/*[in,def,opt]*/, VARIANT Value/*[in,opt]*/)
{
  Adodb_xp::_Parameter* ppiprm;
  this->CreateParameter(Name, Type, Direction, Size, Value, (Adodb_xp::_Parameter**)&ppiprm);
  return ppiprm;
}

template <class T> HRESULT /*[VT_HRESULT:0]*/ __fastcall
Command15DispT<T>::get_Parameters(Adodb_xp::Parameters** ppvObject/*[out,retval]*/)
{
  _TDispID _dispid(*this, OLETEXT("Parameters"), DISPID(0));
  TAutoArgs<0> _args;
  return OutRetValSetterPtr((LPDISPATCH*)(Adodb_xp::Parameters**)ppvObject /*[VT_USERDEFINED:2]*/, _args, OlePropertyGet(_dispid, _args));
}

template <class T> Adodb_xp::Parameters* __fastcall
Command15DispT<T>::get_Parameters(void)
{
  Adodb_xp::Parameters* ppvObject;
  this->get_Parameters((Adodb_xp::Parameters**)&ppvObject);
  return ppvObject;
}

template <class T> HRESULT /*[VT_HRESULT:0]*/ __fastcall
Command15DispT<T>::set_CommandType(Adodb_xp::CommandTypeEnum plCmdType/*[in]*/)
{
...
template <class T> HRESULT /*[VT_HRESULT:0]*/ __fastcall
Command15DispT<T>::get_CommandType(Adodb_xp::CommandTypeEnum* plCmdType/*[out,retval]*/)
{
...
template <class T> Adodb_xp::CommandTypeEnum __fastcall
Command15DispT<T>::get_CommandType(void)
{
  Adodb_xp::CommandTypeEnum plCmdType;
  this->get_CommandType((Adodb_xp::CommandTypeEnum*)&plCmdType);
  return plCmdType;
}
...
template <class T> HRESULT /*[VT_HRESULT:0]*/ __fastcall
Command15DispT<T>::get_Properties(Adodb_xp::Properties** ppvObject/*[out,retval]*/)
{
  _TDispID _dispid(*this, OLETEXT("Properties"), DISPID(500));
  TAutoArgs<0> _args;
  return OutRetValSetterPtr((LPDISPATCH*)(Adodb_xp::Properties**)ppvObject /*[VT_USERDEFINED:2]*/, _args, OlePropertyGet(_dispid, _args));
...
{
  Adodb_xp::Recordset15* ppiRset;
  OLECHECK(this->Execute(, (Adodb_xp::Recordset15**)&ppiRset));
  return ppiRset;
}
...
template <class T> HRESULT __fastcall
TCOMConnection15T<T>::get_Errors(Adodb_xp::Errors** ppvObject/*[out,retval]*/)
{
  return (*this)->get_Errors(ppvObject);
}

template <class T> HRESULT __fastcall
TCOMConnection15T<T>::get_Errors(Adodb_xp::ErrorsPtr* ppvObject/*[out,retval]*/)
{
  return (*this)->get_Errors(Errors**)ppvObject);
}

template <class T> Adodb_xp::ErrorsPtr __fastcall
TCOMConnection15T<T>::get_Errors(void)
{
  Adodb_xp::Errors* ppvObject;
  OLECHECK(this->get_Errors((Adodb_xp::Errors**)&ppvObject));
  return (Adodb_xp::ErrorsPtr)ppvObject;
}
...
template <class T> HRESULT __fastcall
TCOMConnection15T<T>::get_IsolationLevel(Adodb_xp::IsolationLevelEnum* Level/*[out,retval]*/)
{
  return (*this)->get_IsolationLevel(Level);
}

template <class T> Adodb_xp::IsolationLevelEnum __fastcall
...
template <class T> HRESULT __fastcall
TCOMConnection15T<T>::set_IsolationLevel(Adodb_xp::IsolationLevelEnum Level/*[in]*/)
{
...
template <class T> HRESULT __fastcall
TCOMConnection15T<T>::get_CursorLocation(Adodb_xp::CursorLocationEnum* plCursorLoc/*[out,retval]*/)
{
  return (*this)->get_CursorLocation(plCursorLoc);
}

template <class T> Adodb_xp::CursorLocationEnum __fastcall
...
template <class T> HRESULT __fastcall
TCOMConnection15T<T>::set_CursorLocation(Adodb_xp::CursorLocationEnum plCursorLoc/*[in]*/)
{
  return (*this)->set_CursorLocation(plCursorLoc);
}

template <class T> HRESULT __fastcall
TCOMConnection15T<T>::get_Mode(Adodb_xp::ConnectModeEnum* plMode/*[out,retval]*/)
{
  return (*this)->get_Mode(plMode);
}

template <class T> Adodb_xp::ConnectModeEnum __fastcall
...
template <class T> HRESULT __fastcall
TCOMConnection15T<T>::set_Mode(Adodb_xp::ConnectModeEnum plMode/*[in]*/)
{
...
template <class T> HRESULT __fastcall
TCOMConnection15T<T>::OpenSchema(Adodb_xp::SchemaEnum Schema/*[in]*/, 
...
{
  Adodb_xp::Recordset15* pprset;
  OLECHECK(this->OpenSchema(, (Adodb_xp::Recordset15**)&pprset));
  return pprset;
}
                              ...
                              Adodb_xp::Recordset15** ppiRset/*[out,retval]*/)
{
  ...
  _args[3] = Options /*[VT_I4:0]*/;
  return OutRetValSetterPtr((LPDISPATCH*)(Adodb_xp::Recordset15**)ppiRset /*[VT_USERDEFINED:2]*/, _args, OleFunction(_dispid, _args));
}
...
{
  Adodb_xp::Recordset15* ppiRset;
  this->Execute(CommandText, RecordsAffected, Options, (Adodb_xp::Recordset15**)&ppiRset);
  return ppiRset;
}
...
template <class T> HRESULT /*[VT_HRESULT:0]*/ __fastcall
Connection15DispT<T>::get_Errors(Adodb_xp::Errors** ppvObject/*[out,retval]*/)
{
  _TDispID _dispid(*this, OLETEXT("Errors"), DISPID(11));
  TAutoArgs<0> _args;
  return OutRetValSetterPtr((LPDISPATCH*)(Adodb_xp::Errors**)ppvObject /*[VT_USERDEFINED:2]*/, _args, OlePropertyGet(_dispid, _args));
}

template <class T> Adodb_xp::Errors* __fastcall
Connection15DispT<T>::get_Errors(void)
{
  Adodb_xp::Errors* ppvObject;
  this->get_Errors((Adodb_xp::Errors**)&ppvObject);
  return ppvObject;
}
...
template <class T> HRESULT /*[VT_HRESULT:0]*/ __fastcall
Connection15DispT<T>::get_IsolationLevel(Adodb_xp::IsolationLevelEnum* Level/*[out,retval]*/)
{
...
{
  Adodb_xp::IsolationLevelEnum Level;
  this->get_IsolationLevel((Adodb_xp::IsolationLevelEnum*)&Level);
  return Level;
}

template <class T> HRESULT /*[VT_HRESULT:0]*/ __fastcall
Connection15DispT<T>::set_IsolationLevel(Adodb_xp::IsolationLevelEnum Level/*[in]*/)
{
  _TDispID _dispid(*this, OLETEXT("IsolationLevel"), DISPID(13));
  TAutoArgs<1> _args;
...
template <class T> HRESULT /*[VT_HRESULT:0]*/ __fastcall
Connection15DispT<T>::get_CursorLocation(Adodb_xp::CursorLocationEnum* plCursorLoc/*[out,retval]*/)
{
...
{
  Adodb_xp::CursorLocationEnum plCursorLoc;
  this->get_CursorLocation((Adodb_xp::CursorLocationEnum*)&plCursorLoc);
  return plCursorLoc;
}

template <class T> HRESULT /*[VT_HRESULT:0]*/ __fastcall
Connection15DispT<T>::set_CursorLocation(Adodb_xp::CursorLocationEnum plCursorLoc/*[in]*/)
{
  _TDispID _dispid(*this, OLETEXT("CursorLocation"), DISPID(15));
  TAutoArgs<1> _args;
...
template <class T> HRESULT /*[VT_HRESULT:0]*/ __fastcall
Connection15DispT<T>::get_Mode(Adodb_xp::ConnectModeEnum* plMode/*[out,retval]*/)
{
...
{
  Adodb_xp::ConnectModeEnum plMode;
  this->get_Mode((Adodb_xp::ConnectModeEnum*)&plMode);
  return plMode;
}

template <class T> HRESULT /*[VT_HRESULT:0]*/ __fastcall
Connection15DispT<T>::set_Mode(Adodb_xp::ConnectModeEnum plMode/*[in]*/)
{
  _TDispID _dispid(*this, OLETEXT("Mode"), DISPID(16));
  TAutoArgs<1> _args;
...
template <class T> HRESULT /*[VT_HRESULT:0]*/ __fastcall
Connection15DispT<T>::OpenSchema(Adodb_xp::SchemaEnum Schema/*[in]*/, 
                                 VARIANT Restrictions/*[in,opt]*/, VARIANT SchemaID/*[in,opt]*/, 
                                 Adodb_xp::Recordset15** pprset/*[out,retval]*/)
{
  ...
  return OutRetValSetterPtr((LPDISPATCH*)(Adodb_xp::Recordset15**)pprset /*[VT_USERDEFINED:2]*/, _args, OleFunction(_dispid, _args));
}
...
{
  Adodb_xp::Recordset15* pprset;
  this->OpenSchema(Schema, Restrictions, SchemaID, (Adodb_xp::Recordset15**)&pprset);
  return pprset;
}

template <class T> HRESULT /*[VT_HRESULT:0]*/ __fastcall
Connection15DispT<T>::get_Properties(Adodb_xp::Properties** ppvObject/*[out,retval]*/)
{
  _TDispID _dispid(*this, OLETEXT("Properties"), DISPID(500));
  TAutoArgs<0> _args;
  return OutRetValSetterPtr((LPDISPATCH*)(Adodb_xp::Properties**)ppvObject /*[VT_USERDEFINED:2]*/, _args, OlePropertyGet(_dispid, _args));
...
template <class T> HRESULT /*[VT_HRESULT:0]*/ __fastcall
_ConnectionDispT<T>::get_Errors(Adodb_xp::Errors** ppvObject/*[out,retval]*/)
{
  _TDispID _dispid(*this, OLETEXT("Errors"), DISPID(11));
  TAutoArgs<0> _args;
  return OutRetValSetterPtr((LPDISPATCH*)(Adodb_xp::Errors**)ppvObject /*[VT_USERDEFINED:2]*/, _args, OlePropertyGet(_dispid, _args));
...
template <class T> HRESULT /*[VT_HRESULT:0]*/ __fastcall
_ConnectionDispT<T>::get_IsolationLevel(Adodb_xp::IsolationLevelEnum* Level/*[out,retval]*/)
{
  _TDispID _dispid(*this, OLETEXT("IsolationLevel"), DISPID(13));
  TAutoArgs<0> _args;
  return OutRetValSetterPtr((int*)Level /*[VT_USERDEFINED:1]*/, _args, OlePropertyGet(_dispid, _args));
...
template <class T> HRESULT /*[VT_HRESULT:0]*/ __fastcall
_ConnectionDispT<T>::set_IsolationLevel(Adodb_xp::IsolationLevelEnum Level/*[in]*/)
{
  _TDispID _dispid(*this, OLETEXT("IsolationLevel"), DISPID(13));
  TAutoArgs<1> _args;
  _args[1] = (int)Level /*[VT_USERDEFINED:0]*/;
...
template <class T> HRESULT /*[VT_HRESULT:0]*/ __fastcall
_ConnectionDispT<T>::get_CursorLocation(Adodb_xp::CursorLocationEnum* plCursorLoc/*[out,retval]*/)
{
  _TDispID _dispid(*this, OLETEXT("CursorLocation"), DISPID(15));
  TAutoArgs<0> _args;
  return OutRetValSetterPtr((int*)plCursorLoc /*[VT_USERDEFINED:1]*/, _args, OlePropertyGet(_dispid, _args));
...
template <class T> HRESULT /*[VT_HRESULT:0]*/ __fastcall
_ConnectionDispT<T>::set_CursorLocation(Adodb_xp::CursorLocationEnum plCursorLoc/*[in]*/)
{
  _TDispID _dispid(*this, OLETEXT("CursorLocation"), DISPID(15));
  TAutoArgs<1> _args;
  _args[1] = (int)plCursorLoc /*[VT_USERDEFINED:0]*/;
...
template <class T> HRESULT /*[VT_HRESULT:0]*/ __fastcall
_ConnectionDispT<T>::get_Mode(Adodb_xp::ConnectModeEnum* plMode/*[out,retval]*/)
{
  _TDispID _dispid(*this, OLETEXT("Mode"), DISPID(16));
  TAutoArgs<0> _args;
  return OutRetValSetterPtr((int*)plMode /*[VT_USERDEFINED:1]*/, _args, OlePropertyGet(_dispid, _args));
...
template <class T> HRESULT /*[VT_HRESULT:0]*/ __fastcall
_ConnectionDispT<T>::set_Mode(Adodb_xp::ConnectModeEnum plMode/*[in]*/)
{
  _TDispID _dispid(*this, OLETEXT("Mode"), DISPID(16));
  TAutoArgs<1> _args;
  _args[1] = (int)plMode /*[VT_USERDEFINED:0]*/;
...
template <class T> HRESULT /*[VT_HRESULT:0]*/ __fastcall
_ConnectionDispT<T>::OpenSchema(Adodb_xp::SchemaEnum Schema/*[in]*/, 
                                VARIANT Restrictions/*[in,opt]*/, VARIANT SchemaID/*[in,opt]*/, 
                                Adodb_xp::Recordset15** pprset/*[out,retval]*/)
{
  _TDispID _dispid(*this, OLETEXT("OpenSchema"), DISPID(19));
...
template <class T> HRESULT /*[VT_HRESULT:0]*/ __fastcall
_ConnectionDispT<T>::get_Properties(Adodb_xp::Properties** ppvObject/*[out,retval]*/)
{
  _TDispID _dispid(*this, OLETEXT("Properties"), DISPID(500));
  TAutoArgs<0> _args;
  return OutRetValSetterPtr((LPDISPATCH*)(Adodb_xp::Properties**)ppvObject /*[VT_USERDEFINED:2]*/, _args, OlePropertyGet(_dispid, _args));
...
// *********************************************************************//
template <class T> HRESULT __fastcall
TCOMRecordset15T<T>::get_AbsolutePosition(Adodb_xp::PositionEnum* pl/*[out,retval]*/)
{
  return (*this)->get_AbsolutePosition(pl);
}

template <class T> Adodb_xp::PositionEnum __fastcall
...
template <class T> HRESULT __fastcall
TCOMRecordset15T<T>::set_AbsolutePosition(Adodb_xp::PositionEnum pl/*[in]*/)
{
...
template <class T> HRESULT __fastcall
TCOMRecordset15T<T>::get_CursorType(Adodb_xp::CursorTypeEnum* plCursorType/*[out,retval]*/)
{
  return (*this)->get_CursorType(plCursorType);
}

template <class T> Adodb_xp::CursorTypeEnum __fastcall
...
template <class T> HRESULT __fastcall
TCOMRecordset15T<T>::set_CursorType(Adodb_xp::CursorTypeEnum plCursorType/*[in]*/)
{
...
template <class T> HRESULT __fastcall
TCOMRecordset15T<T>::get_Fields(Adodb_xp::Fields15** ppvObject/*[out,retval]*/)
{
  return (*this)->get_Fields(ppvObject);
}

template <class T> HRESULT __fastcall
TCOMRecordset15T<T>::get_Fields(Adodb_xp::Fields15Ptr* ppvObject/*[out,retval]*/)
{
  return (*this)->get_Fields(Fields15**)ppvObject);
}

template <class T> Adodb_xp::Fields15Ptr __fastcall
TCOMRecordset15T<T>::get_Fields(void)
{
  Adodb_xp::Fields15* ppvObject;
  OLECHECK(this->get_Fields((Adodb_xp::Fields15**)&ppvObject));
  return (Adodb_xp::Fields15Ptr)ppvObject;
}

template <class T> HRESULT __fastcall
TCOMRecordset15T<T>::get_LockType(Adodb_xp::LockTypeEnum* plLockType/*[out,retval]*/)
{
  return (*this)->get_LockType(plLockType);
}

template <class T> Adodb_xp::LockTypeEnum __fastcall
...
template <class T> HRESULT __fastcall
TCOMRecordset15T<T>::set_LockType(Adodb_xp::LockTypeEnum plLockType/*[in]*/)
{
...
template <class T> HRESULT __fastcall
TCOMRecordset15T<T>::Delete(Adodb_xp::AffectEnum AffectRecords/*[in,def,opt]*/)
{
...
template <class T> HRESULT __fastcall
TCOMRecordset15T<T>::_xResync(Adodb_xp::AffectEnum AffectRecords/*[in,def,opt]*/)
{
...
template <class T> HRESULT __fastcall
TCOMRecordset15T<T>::get_AbsolutePage(Adodb_xp::PositionEnum* pl/*[out,retval]*/)
{
...
template <class T> HRESULT __fastcall
TCOMRecordset15T<T>::set_AbsolutePage(Adodb_xp::PositionEnum pl/*[in]*/)
{
  return (*this)->set_AbsolutePage(pl);
}

template <class T> HRESULT __fastcall
TCOMRecordset15T<T>::get_EditMode(Adodb_xp::EditModeEnum* pl/*[out,retval]*/)
{
  return (*this)->get_EditMode(pl);
}

template <class T> Adodb_xp::EditModeEnum __fastcall
...
template <class T> HRESULT __fastcall
TCOMRecordset15T<T>::_xClone(Adodb_xp::Recordset15** ppvObject/*[out,retval]*/)
{
...
template <class T> HRESULT __fastcall
TCOMRecordset15T<T>::UpdateBatch(Adodb_xp::AffectEnum AffectRecords/*[in,def,opt]*/)
{
  return (*this)->UpdateBatch(AffectRecords);
}

template <class T> HRESULT __fastcall
TCOMRecordset15T<T>::CancelBatch(Adodb_xp::AffectEnum AffectRecords/*[in,def,opt]*/)
{
  return (*this)->CancelBatch(AffectRecords);
}

template <class T> HRESULT __fastcall
TCOMRecordset15T<T>::get_CursorLocation(Adodb_xp::CursorLocationEnum* plCursorLoc/*[out,retval]*/)
{
  return (*this)->get_CursorLocation(plCursorLoc);
}
...
template <class T> HRESULT __fastcall
TCOMRecordset15T<T>::set_CursorLocation(Adodb_xp::CursorLocationEnum plCursorLoc/*[in]*/)
{
  return (*this)->set_CursorLocation(plCursorLoc);
}
...
{
  Adodb_xp::Recordset15* ppiRs;
  OLECHECK(this->NextRecordset(, (Adodb_xp::Recordset15**)&ppiRs));
  return ppiRs;
}

template <class T> HRESULT __fastcall
TCOMRecordset15T<T>::Supports(Adodb_xp::CursorOptionEnum CursorOptions/*[in]*/, 
                              VARIANT_BOOL* pb/*[out,retval]*/)
{
...
template <class T> HRESULT __fastcall
TCOMRecordset15T<T>::get_MarshalOptions(Adodb_xp::MarshalOptionsEnum* peMarshal/*[out,retval]*/)
{
  return (*this)->get_MarshalOptions(peMarshal);
}

template <class T> Adodb_xp::MarshalOptionsEnum __fastcall
...
template <class T> HRESULT __fastcall
TCOMRecordset15T<T>::set_MarshalOptions(Adodb_xp::MarshalOptionsEnum peMarshal/*[in]*/)
{
...
// *********************************************************************//
template <class T> HRESULT /*[VT_HRESULT:0]*/ __fastcall
Recordset15DispT<T>::get_AbsolutePosition(Adodb_xp::PositionEnum* pl/*[out,retval]*/)
{
...
{
  Adodb_xp::PositionEnum pl;
  this->get_AbsolutePosition((Adodb_xp::PositionEnum*)&pl);
  return pl;
}

template <class T> HRESULT /*[VT_HRESULT:0]*/ __fastcall
Recordset15DispT<T>::set_AbsolutePosition(Adodb_xp::PositionEnum pl/*[in]*/)
{
  _TDispID _dispid(*this, OLETEXT("AbsolutePosition"), DISPID(1000));
  TAutoArgs<1> _args;
...
template <class T> HRESULT /*[VT_HRESULT:0]*/ __fastcall
Recordset15DispT<T>::get_CursorType(Adodb_xp::CursorTypeEnum* plCursorType/*[out,retval]*/)
{
...
{
  Adodb_xp::CursorTypeEnum plCursorType;
  this->get_CursorType((Adodb_xp::CursorTypeEnum*)&plCursorType);
  return plCursorType;
}

template <class T> HRESULT /*[VT_HRESULT:0]*/ __fastcall
Recordset15DispT<T>::set_CursorType(Adodb_xp::CursorTypeEnum plCursorType/*[in]*/)
{
  _TDispID _dispid(*this, OLETEXT("CursorType"), DISPID(1005));
  TAutoArgs<1> _args;
...
template <class T> HRESULT /*[VT_HRESULT:0]*/ __fastcall
Recordset15DispT<T>::get_Fields(Adodb_xp::Fields15** ppvObject/*[out,retval]*/)
{
  _TDispID _dispid(*this, OLETEXT("Fields"), DISPID(0));
  TAutoArgs<0> _args;
  return OutRetValSetterPtr((LPDISPATCH*)(Adodb_xp::Fields15**)ppvObject /*[VT_USERDEFINED:2]*/, _args, OlePropertyGet(_dispid, _args));
}

template <class T> Adodb_xp::Fields15* __fastcall
Recordset15DispT<T>::get_Fields(void)
{
  Adodb_xp::Fields15* ppvObject;
  this->get_Fields((Adodb_xp::Fields15**)&ppvObject);
  return ppvObject;
}

template <class T> HRESULT /*[VT_HRESULT:0]*/ __fastcall
Recordset15DispT<T>::get_LockType(Adodb_xp::LockTypeEnum* plLockType/*[out,retval]*/)
{
...
{
  Adodb_xp::LockTypeEnum plLockType;
  this->get_LockType((Adodb_xp::LockTypeEnum*)&plLockType);
  return plLockType;
}

template <class T> HRESULT /*[VT_HRESULT:0]*/ __fastcall
Recordset15DispT<T>::set_LockType(Adodb_xp::LockTypeEnum plLockType/*[in]*/)
{
  _TDispID _dispid(*this, OLETEXT("LockType"), DISPID(1008));
  TAutoArgs<1> _args;
...
template <class T> HRESULT /*[VT_HRESULT:0]*/ __fastcall
Recordset15DispT<T>::Delete(Adodb_xp::AffectEnum AffectRecords/*[in,def,opt]*/)
{
...
template <class T> HRESULT /*[VT_HRESULT:0]*/ __fastcall
Recordset15DispT<T>::_xResync(Adodb_xp::AffectEnum AffectRecords/*[in,def,opt]*/)
{
...
template <class T> HRESULT /*[VT_HRESULT:0]*/ __fastcall
Recordset15DispT<T>::get_AbsolutePage(Adodb_xp::PositionEnum* pl/*[out,retval]*/)
{
...
{
  Adodb_xp::PositionEnum pl;
  this->get_AbsolutePage((Adodb_xp::PositionEnum*)&pl);
  return pl;
}

template <class T> HRESULT /*[VT_HRESULT:0]*/ __fastcall
Recordset15DispT<T>::set_AbsolutePage(Adodb_xp::PositionEnum pl/*[in]*/)
{
  _TDispID _dispid(*this, OLETEXT("AbsolutePage"), DISPID(1047));
  TAutoArgs<1> _args;
  _args[1] = (int)pl /*[VT_USERDEFINED:0]*/;
...
template <class T> HRESULT /*[VT_HRESULT:0]*/ __fastcall
Recordset15DispT<T>::get_EditMode(Adodb_xp::EditModeEnum* pl/*[out,retval]*/)
{
...
{
  Adodb_xp::EditModeEnum pl;
  this->get_EditMode((Adodb_xp::EditModeEnum*)&pl);
  return pl;
}
...
template <class T> HRESULT /*[VT_HRESULT:0]*/ __fastcall
Recordset15DispT<T>::_xClone(Adodb_xp::Recordset15** ppvObject/*[out,retval]*/)
{
  _TDispID _dispid(*this, OLETEXT("_xClone"), DISPID(DISPID_UNKNOWN/*[1610809392]*/));
  TAutoArgs<0> _args;
  return OutRetValSetterPtr((LPDISPATCH*)(Adodb_xp::Recordset15**)ppvObject /*[VT_USERDEFINED:2]*/, _args, OleFunction(_dispid, _args));
}
...
{
  Adodb_xp::Recordset15* ppvObject;
  this->_xClone((Adodb_xp::Recordset15**)&ppvObject);
  return ppvObject;
}

template <class T> HRESULT /*[VT_HRESULT:0]*/ __fastcall
Recordset15DispT<T>::UpdateBatch(Adodb_xp::AffectEnum AffectRecords/*[in,def,opt]*/)
{
...
template <class T> HRESULT /*[VT_HRESULT:0]*/ __fastcall
Recordset15DispT<T>::CancelBatch(Adodb_xp::AffectEnum AffectRecords/*[in,def,opt]*/)
{
...
template <class T> HRESULT /*[VT_HRESULT:0]*/ __fastcall
Recordset15DispT<T>::get_CursorLocation(Adodb_xp::CursorLocationEnum* plCursorLoc/*[out,retval]*/)
{
...
template <class T> HRESULT /*[VT_HRESULT:0]*/ __fastcall
Recordset15DispT<T>::set_CursorLocation(Adodb_xp::CursorLocationEnum plCursorLoc/*[in]*/)
{
  _TDispID _dispid(*this, OLETEXT("CursorLocation"), DISPID(1051));
  TAutoArgs<1> _args;
  _args[1] = (int)plCursorLoc /*[VT_USERDEFINED:0]*/;
...
{
  Adodb_xp::Recordset15* ppiRs;
  this->NextRecordset(RecordsAffected, (Adodb_xp::Recordset15**)&ppiRs);
  return ppiRs;
}

template <class T> HRESULT /*[VT_HRESULT:0]*/ __fastcall
Recordset15DispT<T>::Supports(Adodb_xp::CursorOptionEnum CursorOptions/*[in]*/, 
                              VARIANT_BOOL* pb/*[out,retval]*/)
{
...
template <class T> HRESULT /*[VT_HRESULT:0]*/ __fastcall
Recordset15DispT<T>::get_MarshalOptions(Adodb_xp::MarshalOptionsEnum* peMarshal/*[out,retval]*/)
{
...
{
  Adodb_xp::MarshalOptionsEnum peMarshal;
  this->get_MarshalOptions((Adodb_xp::MarshalOptionsEnum*)&peMarshal);
  return peMarshal;
}

template <class T> HRESULT /*[VT_HRESULT:0]*/ __fastcall
Recordset15DispT<T>::set_MarshalOptions(Adodb_xp::MarshalOptionsEnum peMarshal/*[in]*/)
{
  _TDispID _dispid(*this, OLETEXT("MarshalOptions"), DISPID(1053));
  TAutoArgs<1> _args;
...
template <class T> HRESULT /*[VT_HRESULT:0]*/ __fastcall
Recordset15DispT<T>::get_Properties(Adodb_xp::Properties** ppvObject/*[out,retval]*/)
{
  _TDispID _dispid(*this, OLETEXT("Properties"), DISPID(500));
  TAutoArgs<0> _args;
  return OutRetValSetterPtr((LPDISPATCH*)(Adodb_xp::Properties**)ppvObject /*[VT_USERDEFINED:2]*/, _args, OlePropertyGet(_dispid, _args));
...
template <class T> HRESULT /*[VT_HRESULT:0]*/ __fastcall
Recordset20DispT<T>::GetString(Adodb_xp::StringFormatEnum StringFormat/*[in,def,opt]*/, 
                               long NumRows/*[in,def,opt]*/, BSTR ColumnDelimeter/*[in,opt]*/, 
                               BSTR RowDelimeter/*[in,opt]*/, BSTR NullExpr/*[in,opt]*/, 
                               BSTR* pRetString/*[out,retval]*/)
{
...
template <class T> Adodb_xp::CompareEnum __fastcall
Recordset20DispT<T>::CompareBookmarks(VARIANT Bookmark1/*[in]*/, VARIANT Bookmark2/*[in]*/)
{
  Adodb_xp::CompareEnum pCompare;
  this->CompareBookmarks(Bookmark1, Bookmark2, (Adodb_xp::CompareEnum*)&pCompare);
  return pCompare;
}

template <class T> HRESULT /*[VT_HRESULT:0]*/ __fastcall
Recordset20DispT<T>::Clone(Adodb_xp::LockTypeEnum LockType/*[in,def,opt]*/, 
                           Adodb_xp::Recordset15** ppvObject/*[out,retval]*/)
{
...
{
  Adodb_xp::Recordset15* ppvObject;
  this->Clone(LockType, (Adodb_xp::Recordset15**)&ppvObject);
  return ppvObject;
}

template <class T> HRESULT /*[VT_HRESULT:0]*/ __fastcall
Recordset20DispT<T>::Resync(Adodb_xp::AffectEnum AffectRecords/*[in,def,opt]*/, 
                            Adodb_xp::ResyncEnum ResyncValues/*[in,def,opt]*/)
{
...
template <class T> HRESULT /*[VT_HRESULT:0]*/ __fastcall
Recordset20DispT<T>::get_AbsolutePosition(Adodb_xp::PositionEnum* pl/*[out,retval]*/)
{
  _TDispID _dispid(*this, OLETEXT("AbsolutePosition"), DISPID(1000));
  TAutoArgs<0> _args;
  return OutRetValSetterPtr((int*)pl /*[VT_USERDEFINED:1]*/, _args, OlePropertyGet(_dispid, _args));
...
template <class T> HRESULT /*[VT_HRESULT:0]*/ __fastcall
Recordset20DispT<T>::set_AbsolutePosition(Adodb_xp::PositionEnum pl/*[in]*/)
{
  _TDispID _dispid(*this, OLETEXT("AbsolutePosition"), DISPID(1000));
  TAutoArgs<1> _args;
  _args[1] = (int)pl /*[VT_USERDEFINED:0]*/;
...
template <class T> HRESULT /*[VT_HRESULT:0]*/ __fastcall
Recordset20DispT<T>::get_CursorType(Adodb_xp::CursorTypeEnum* plCursorType/*[out,retval]*/)
{
  _TDispID _dispid(*this, OLETEXT("CursorType"), DISPID(1005));
  TAutoArgs<0> _args;
  return OutRetValSetterPtr((int*)plCursorType /*[VT_USERDEFINED:1]*/, _args, OlePropertyGet(_dispid, _args));
...
template <class T> HRESULT /*[VT_HRESULT:0]*/ __fastcall
Recordset20DispT<T>::set_CursorType(Adodb_xp::CursorTypeEnum plCursorType/*[in]*/)
{
  _TDispID _dispid(*this, OLETEXT("CursorType"), DISPID(1005));
  TAutoArgs<1> _args;
  _args[1] = (int)plCursorType /*[VT_USERDEFINED:0]*/;
...
template <class T> HRESULT /*[VT_HRESULT:0]*/ __fastcall
Recordset20DispT<T>::get_Fields(Adodb_xp::Fields15** ppvObject/*[out,retval]*/)
{
  _TDispID _dispid(*this, OLETEXT("Fields"), DISPID(0));
  TAutoArgs<0> _args;
  return OutRetValSetterPtr((LPDISPATCH*)(Adodb_xp::Fields15**)ppvObject /*[VT_USERDEFINED:2]*/, _args, OlePropertyGet(_dispid, _args));
...
template <class T> HRESULT /*[VT_HRESULT:0]*/ __fastcall
Recordset20DispT<T>::get_LockType(Adodb_xp::LockTypeEnum* plLockType/*[out,retval]*/)
{
  _TDispID _dispid(*this, OLETEXT("LockType"), DISPID(1008));
  TAutoArgs<0> _args;
  return OutRetValSetterPtr((int*)plLockType /*[VT_USERDEFINED:1]*/, _args, OlePropertyGet(_dispid, _args));
...
template <class T> HRESULT /*[VT_HRESULT:0]*/ __fastcall
Recordset20DispT<T>::set_LockType(Adodb_xp::LockTypeEnum plLockType/*[in]*/)
{
  _TDispID _dispid(*this, OLETEXT("LockType"), DISPID(1008));
  TAutoArgs<1> _args;
  _args[1] = (int)plLockType /*[VT_USERDEFINED:0]*/;
...
template <class T> HRESULT /*[VT_HRESULT:0]*/ __fastcall
Recordset20DispT<T>::Delete(Adodb_xp::AffectEnum AffectRecords/*[in,def,opt]*/)
{
  _TDispID _dispid(*this, OLETEXT("Delete"), DISPID(1015));
  TAutoArgs<1> _args;
  _args[1] = (int)AffectRecords /*[VT_USERDEFINED:0]*/;
...
template <class T> HRESULT /*[VT_HRESULT:0]*/ __fastcall
Recordset20DispT<T>::_xResync(Adodb_xp::AffectEnum AffectRecords/*[in,def,opt]*/)
{
  _TDispID _dispid(*this, OLETEXT("_xResync"), DISPID(DISPID_UNKNOWN/*[1610809378]*/));
  TAutoArgs<1> _args;
  _args[1] = (int)AffectRecords /*[VT_USERDEFINED:0]*/;
...
template <class T> HRESULT /*[VT_HRESULT:0]*/ __fastcall
Recordset20DispT<T>::get_AbsolutePage(Adodb_xp::PositionEnum* pl/*[out,retval]*/)
{
  _TDispID _dispid(*this, OLETEXT("AbsolutePage"), DISPID(1047));
  TAutoArgs<0> _args;
  return OutRetValSetterPtr((int*)pl /*[VT_USERDEFINED:1]*/, _args, OlePropertyGet(_dispid, _args));
...
template <class T> HRESULT /*[VT_HRESULT:0]*/ __fastcall
Recordset20DispT<T>::set_AbsolutePage(Adodb_xp::PositionEnum pl/*[in]*/)
{
  _TDispID _dispid(*this, OLETEXT("AbsolutePage"), DISPID(1047));
  TAutoArgs<1> _args;
  _args[1] = (int)pl /*[VT_USERDEFINED:0]*/;
...
template <class T> HRESULT /*[VT_HRESULT:0]*/ __fastcall
Recordset20DispT<T>::get_EditMode(Adodb_xp::EditModeEnum* pl/*[out,retval]*/)
{
  _TDispID _dispid(*this, OLETEXT("EditMode"), DISPID(1026));
  TAutoArgs<0> _args;
  return OutRetValSetterPtr((int*)pl /*[VT_USERDEFINED:1]*/, _args, OlePropertyGet(_dispid, _args));
...
template <class T> HRESULT /*[VT_HRESULT:0]*/ __fastcall
Recordset20DispT<T>::_xClone(Adodb_xp::Recordset15** ppvObject/*[out,retval]*/)
{
  _TDispID _dispid(*this, OLETEXT("_xClone"), DISPID(DISPID_UNKNOWN/*[1610809392]*/));
  TAutoArgs<0> _args;
  return OutRetValSetterPtr((LPDISPATCH*)(Adodb_xp::Recordset15**)ppvObject /*[VT_USERDEFINED:2]*/, _args, OleFunction(_dispid, _args));
...
template <class T> HRESULT /*[VT_HRESULT:0]*/ __fastcall
Recordset20DispT<T>::UpdateBatch(Adodb_xp::AffectEnum AffectRecords/*[in,def,opt]*/)
{
  _TDispID _dispid(*this, OLETEXT("UpdateBatch"), DISPID(1035));
  TAutoArgs<1> _args;
  _args[1] = (int)AffectRecords /*[VT_USERDEFINED:0]*/;
...
template <class T> HRESULT /*[VT_HRESULT:0]*/ __fastcall
Recordset20DispT<T>::CancelBatch(Adodb_xp::AffectEnum AffectRecords/*[in,def,opt]*/)
{
  _TDispID _dispid(*this, OLETEXT("CancelBatch"), DISPID(1049));
  TAutoArgs<1> _args;
  _args[1] = (int)AffectRecords /*[VT_USERDEFINED:0]*/;
...
template <class T> HRESULT /*[VT_HRESULT:0]*/ __fastcall
Recordset20DispT<T>::get_CursorLocation(Adodb_xp::CursorLocationEnum* plCursorLoc/*[out,retval]*/)
{
  _TDispID _dispid(*this, OLETEXT("CursorLocation"), DISPID(1051));
  TAutoArgs<0> _args;
  return OutRetValSetterPtr((int*)plCursorLoc /*[VT_USERDEFINED:1]*/, _args, OlePropertyGet(_dispid, _args));
...
template <class T> HRESULT /*[VT_HRESULT:0]*/ __fastcall
Recordset20DispT<T>::set_CursorLocation(Adodb_xp::CursorLocationEnum plCursorLoc/*[in]*/)
{
  _TDispID _dispid(*this, OLETEXT("CursorLocation"), DISPID(1051));
  TAutoArgs<1> _args;
  _args[1] = (int)plCursorLoc /*[VT_USERDEFINED:0]*/;
...
template <class T> HRESULT /*[VT_HRESULT:0]*/ __fastcall
Recordset20DispT<T>::Supports(Adodb_xp::CursorOptionEnum CursorOptions/*[in]*/, 
                              VARIANT_BOOL* pb/*[out,retval]*/)
{
  _TDispID _dispid(*this, OLETEXT("Supports"), DISPID(1036));
  TAutoArgs<1> _args;
...
template <class T> HRESULT /*[VT_HRESULT:0]*/ __fastcall
Recordset20DispT<T>::get_MarshalOptions(Adodb_xp::MarshalOptionsEnum* peMarshal/*[out,retval]*/)
{
  _TDispID _dispid(*this, OLETEXT("MarshalOptions"), DISPID(1053));
  TAutoArgs<0> _args;
  return OutRetValSetterPtr((int*)peMarshal /*[VT_USERDEFINED:1]*/, _args, OlePropertyGet(_dispid, _args));
...
template <class T> HRESULT /*[VT_HRESULT:0]*/ __fastcall
Recordset20DispT<T>::set_MarshalOptions(Adodb_xp::MarshalOptionsEnum peMarshal/*[in]*/)
{
  _TDispID _dispid(*this, OLETEXT("MarshalOptions"), DISPID(1053));
  TAutoArgs<1> _args;
  _args[1] = (int)peMarshal /*[VT_USERDEFINED:0]*/;
...
template <class T> HRESULT /*[VT_HRESULT:0]*/ __fastcall
Recordset20DispT<T>::get_Properties(Adodb_xp::Properties** ppvObject/*[out,retval]*/)
{
  _TDispID _dispid(*this, OLETEXT("Properties"), DISPID(500));
  TAutoArgs<0> _args;
  return OutRetValSetterPtr((LPDISPATCH*)(Adodb_xp::Properties**)ppvObject /*[VT_USERDEFINED:2]*/, _args, OlePropertyGet(_dispid, _args));
...
// *********************************************************************//
template <class T> HRESULT /*[VT_HRESULT:0]*/ __fastcall
_RecordsetDispT<T>::Seek(VARIANT KeyValues/*[in]*/, Adodb_xp::SeekEnum SeekOption/*[in,def,opt]*/)
{
...
template <class T> HRESULT /*[VT_HRESULT:0]*/ __fastcall
_RecordsetDispT<T>::GetString(Adodb_xp::StringFormatEnum StringFormat/*[in,def,opt]*/, 
                              long NumRows/*[in,def,opt]*/, BSTR ColumnDelimeter/*[in,opt]*/, 
                              BSTR RowDelimeter/*[in,opt]*/, BSTR NullExpr/*[in,opt]*/, 
                              BSTR* pRetString/*[out,retval]*/)
{
...
template <class T> HRESULT /*[VT_HRESULT:0]*/ __fastcall
_RecordsetDispT<T>::Clone(Adodb_xp::LockTypeEnum LockType/*[in,def,opt]*/, 
                          Adodb_xp::Recordset15** ppvObject/*[out,retval]*/)
{
  _TDispID _dispid(*this, OLETEXT("Clone"), DISPID(1034));
  TAutoArgs<1> _args;
...
template <class T> HRESULT /*[VT_HRESULT:0]*/ __fastcall
_RecordsetDispT<T>::Resync(Adodb_xp::AffectEnum AffectRecords/*[in,def,opt]*/, 
                           Adodb_xp::ResyncEnum ResyncValues/*[in,def,opt]*/)
{
  _TDispID _dispid(*this, OLETEXT("Resync"), DISPID(1024));
  TAutoArgs<2> _args;
...
template <class T> HRESULT /*[VT_HRESULT:0]*/ __fastcall
_RecordsetDispT<T>::get_AbsolutePosition(Adodb_xp::PositionEnum* pl/*[out,retval]*/)
{
  _TDispID _dispid(*this, OLETEXT("AbsolutePosition"), DISPID(1000));
  TAutoArgs<0> _args;
  return OutRetValSetterPtr((int*)pl /*[VT_USERDEFINED:1]*/, _args, OlePropertyGet(_dispid, _args));
...
template <class T> HRESULT /*[VT_HRESULT:0]*/ __fastcall
_RecordsetDispT<T>::set_AbsolutePosition(Adodb_xp::PositionEnum pl/*[in]*/)
{
  _TDispID _dispid(*this, OLETEXT("AbsolutePosition"), DISPID(1000));
  TAutoArgs<1> _args;
  _args[1] = (int)pl /*[VT_USERDEFINED:0]*/;
...
template <class T> HRESULT /*[VT_HRESULT:0]*/ __fastcall
_RecordsetDispT<T>::get_CursorType(Adodb_xp::CursorTypeEnum* plCursorType/*[out,retval]*/)
{
  _TDispID _dispid(*this, OLETEXT("CursorType"), DISPID(1005));
  TAutoArgs<0> _args;
  return OutRetValSetterPtr((int*)plCursorType /*[VT_USERDEFINED:1]*/, _args, OlePropertyGet(_dispid, _args));
...
template <class T> HRESULT /*[VT_HRESULT:0]*/ __fastcall
_RecordsetDispT<T>::set_CursorType(Adodb_xp::CursorTypeEnum plCursorType/*[in]*/)
{
  _TDispID _dispid(*this, OLETEXT("CursorType"), DISPID(1005));
  TAutoArgs<1> _args;
  _args[1] = (int)plCursorType /*[VT_USERDEFINED:0]*/;
...
template <class T> HRESULT /*[VT_HRESULT:0]*/ __fastcall
_RecordsetDispT<T>::get_Fields(Adodb_xp::Fields15** ppvObject/*[out,retval]*/)
{
  _TDispID _dispid(*this, OLETEXT("Fields"), DISPID(0));
  TAutoArgs<0> _args;
  return OutRetValSetterPtr((LPDISPATCH*)(Adodb_xp::Fields15**)ppvObject /*[VT_USERDEFINED:2]*/, _args, OlePropertyGet(_dispid, _args));
...
template <class T> HRESULT /*[VT_HRESULT:0]*/ __fastcall
_RecordsetDispT<T>::get_LockType(Adodb_xp::LockTypeEnum* plLockType/*[out,retval]*/)
{
  _TDispID _dispid(*this, OLETEXT("LockType"), DISPID(1008));
  TAutoArgs<0> _args;
  return OutRetValSetterPtr((int*)plLockType /*[VT_USERDEFINED:1]*/, _args, OlePropertyGet(_dispid, _args));
...
template <class T> HRESULT /*[VT_HRESULT:0]*/ __fastcall
_RecordsetDispT<T>::set_LockType(Adodb_xp::LockTypeEnum plLockType/*[in]*/)
{
  _TDispID _dispid(*this, OLETEXT("LockType"), DISPID(1008));
  TAutoArgs<1> _args;
  _args[1] = (int)plLockType /*[VT_USERDEFINED:0]*/;
...
template <class T> HRESULT /*[VT_HRESULT:0]*/ __fastcall
_RecordsetDispT<T>::Delete(Adodb_xp::AffectEnum AffectRecords/*[in,def,opt]*/)
{
  _TDispID _dispid(*this, OLETEXT("Delete"), DISPID(1015));
  TAutoArgs<1> _args;
  _args[1] = (int)AffectRecords /*[VT_USERDEFINED:0]*/;
...
template <class T> HRESULT /*[VT_HRESULT:0]*/ __fastcall
_RecordsetDispT<T>::_xResync(Adodb_xp::AffectEnum AffectRecords/*[in,def,opt]*/)
{
  _TDispID _dispid(*this, OLETEXT("_xResync"), DISPID(DISPID_UNKNOWN/*[1610809378]*/));
  TAutoArgs<1> _args;
  _args[1] = (int)AffectRecords /*[VT_USERDEFINED:0]*/;
...
template <class T> HRESULT /*[VT_HRESULT:0]*/ __fastcall
_RecordsetDispT<T>::get_AbsolutePage(Adodb_xp::PositionEnum* pl/*[out,retval]*/)
{
  _TDispID _dispid(*this, OLETEXT("AbsolutePage"), DISPID(1047));
  TAutoArgs<0> _args;
  return OutRetValSetterPtr((int*)pl /*[VT_USERDEFINED:1]*/, _args, OlePropertyGet(_dispid, _args));
...
template <class T> HRESULT /*[VT_HRESULT:0]*/ __fastcall
_RecordsetDispT<T>::set_AbsolutePage(Adodb_xp::PositionEnum pl/*[in]*/)
{
  _TDispID _dispid(*this, OLETEXT("AbsolutePage"), DISPID(1047));
  TAutoArgs<1> _args;
  _args[1] = (int)pl /*[VT_USERDEFINED:0]*/;
...
template <class T> HRESULT /*[VT_HRESULT:0]*/ __fastcall
_RecordsetDispT<T>::get_EditMode(Adodb_xp::EditModeEnum* pl/*[out,retval]*/)
{
  _TDispID _dispid(*this, OLETEXT("EditMode"), DISPID(1026));
  TAutoArgs<0> _args;
  return OutRetValSetterPtr((int*)pl /*[VT_USERDEFINED:1]*/, _args, OlePropertyGet(_dispid, _args));
...
template <class T> HRESULT /*[VT_HRESULT:0]*/ __fastcall
_RecordsetDispT<T>::_xClone(Adodb_xp::Recordset15** ppvObject/*[out,retval]*/)
{
  _TDispID _dispid(*this, OLETEXT("_xClone"), DISPID(DISPID_UNKNOWN/*[1610809392]*/));
  TAutoArgs<0> _args;
  return OutRetValSetterPtr((LPDISPATCH*)(Adodb_xp::Recordset15**)ppvObject /*[VT_USERDEFINED:2]*/, _args, OleFunction(_dispid, _args));
...
template <class T> HRESULT /*[VT_HRESULT:0]*/ __fastcall
_RecordsetDispT<T>::UpdateBatch(Adodb_xp::AffectEnum AffectRecords/*[in,def,opt]*/)
{
  _TDispID _dispid(*this, OLETEXT("UpdateBatch"), DISPID(1035));
  TAutoArgs<1> _args;
  _args[1] = (int)AffectRecords /*[VT_USERDEFINED:0]*/;
...
template <class T> HRESULT /*[VT_HRESULT:0]*/ __fastcall
_RecordsetDispT<T>::CancelBatch(Adodb_xp::AffectEnum AffectRecords/*[in,def,opt]*/)
{
  _TDispID _dispid(*this, OLETEXT("CancelBatch"), DISPID(1049));
  TAutoArgs<1> _args;
  _args[1] = (int)AffectRecords /*[VT_USERDEFINED:0]*/;
...
template <class T> HRESULT /*[VT_HRESULT:0]*/ __fastcall
_RecordsetDispT<T>::get_CursorLocation(Adodb_xp::CursorLocationEnum* plCursorLoc/*[out,retval]*/)
{
  _TDispID _dispid(*this, OLETEXT("CursorLocation"), DISPID(1051));
  TAutoArgs<0> _args;
  return OutRetValSetterPtr((int*)plCursorLoc /*[VT_USERDEFINED:1]*/, _args, OlePropertyGet(_dispid, _args));
...
template <class T> HRESULT /*[VT_HRESULT:0]*/ __fastcall
_RecordsetDispT<T>::set_CursorLocation(Adodb_xp::CursorLocationEnum plCursorLoc/*[in]*/)
{
  _TDispID _dispid(*this, OLETEXT("CursorLocation"), DISPID(1051));
  TAutoArgs<1> _args;
  _args[1] = (int)plCursorLoc /*[VT_USERDEFINED:0]*/;
...
template <class T> HRESULT /*[VT_HRESULT:0]*/ __fastcall
_RecordsetDispT<T>::Supports(Adodb_xp::CursorOptionEnum CursorOptions/*[in]*/, 
                             VARIANT_BOOL* pb/*[out,retval]*/)
{
  _TDispID _dispid(*this, OLETEXT("Supports"), DISPID(1036));
  TAutoArgs<1> _args;
...
template <class T> HRESULT /*[VT_HRESULT:0]*/ __fastcall
_RecordsetDispT<T>::get_MarshalOptions(Adodb_xp::MarshalOptionsEnum* peMarshal/*[out,retval]*/)
{
  _TDispID _dispid(*this, OLETEXT("MarshalOptions"), DISPID(1053));
  TAutoArgs<0> _args;
  return OutRetValSetterPtr((int*)peMarshal /*[VT_USERDEFINED:1]*/, _args, OlePropertyGet(_dispid, _args));
...
template <class T> HRESULT /*[VT_HRESULT:0]*/ __fastcall
_RecordsetDispT<T>::set_MarshalOptions(Adodb_xp::MarshalOptionsEnum peMarshal/*[in]*/)
{
  _TDispID _dispid(*this, OLETEXT("MarshalOptions"), DISPID(1053));
  TAutoArgs<1> _args;
  _args[1] = (int)peMarshal /*[VT_USERDEFINED:0]*/;
...
template <class T> HRESULT /*[VT_HRESULT:0]*/ __fastcall
_RecordsetDispT<T>::get_Properties(Adodb_xp::Properties** ppvObject/*[out,retval]*/)
{
  _TDispID _dispid(*this, OLETEXT("Properties"), DISPID(500));
  TAutoArgs<0> _args;
  return OutRetValSetterPtr((LPDISPATCH*)(Adodb_xp::Properties**)ppvObject /*[VT_USERDEFINED:2]*/, _args, OlePropertyGet(_dispid, _args));
...
// *********************************************************************//
template <class T> HRESULT /*[VT_HRESULT:0]*/ __fastcall
Fields15DispT<T>::get_Item(VARIANT Index/*[in]*/, Adodb_xp::Field** ppvObject/*[out,retval]*/)
{
  _TDispID _dispid(*this, OLETEXT("Item"), DISPID(0));
  TAutoArgs<1> _args;
  _args[1] = Index /*[VT_VARIANT:0]*/;
  return OutRetValSetterPtr((LPDISPATCH*)(Adodb_xp::Field**)ppvObject /*[VT_USERDEFINED:2]*/, _args, OlePropertyGet(_dispid, _args));
}

template <class T> Adodb_xp::Field* __fastcall
Fields15DispT<T>::get_Item(VARIANT Index/*[in]*/)
{
  Adodb_xp::Field* ppvObject;
  this->get_Item(Index, (Adodb_xp::Field**)&ppvObject);
  return ppvObject;
}
...
// *********************************************************************//
template <class T> HRESULT /*[VT_HRESULT:0]*/ __fastcall
FieldsDispT<T>::Append(BSTR Name/*[in]*/, Adodb_xp::DataTypeEnum Type/*[in]*/, 
                       long DefinedSize/*[in,def,opt]*/, 
                       Adodb_xp::FieldAttributeEnum Attrib/*[in,def,opt]*/)
{
...
template <class T> HRESULT /*[VT_HRESULT:0]*/ __fastcall
FieldsDispT<T>::get_Item(VARIANT Index/*[in]*/, Adodb_xp::Field** ppvObject/*[out,retval]*/)
{
  _TDispID _dispid(*this, OLETEXT("Item"), DISPID(0));
  TAutoArgs<1> _args;
  _args[1] = Index /*[VT_VARIANT:0]*/;
...
template <class T> HRESULT /*[VT_HRESULT:0]*/ __fastcall
FieldDispT<T>::get_Type(Adodb_xp::DataTypeEnum* pDataType/*[out,retval]*/)
{
...
{
  Adodb_xp::DataTypeEnum pDataType;
  this->get_Type((Adodb_xp::DataTypeEnum*)&pDataType);
  return pDataType;
}
...
template <class T> HRESULT /*[VT_HRESULT:0]*/ __fastcall
FieldDispT<T>::set_Type(Adodb_xp::DataTypeEnum pDataType/*[in]*/)
{
  _TDispID _dispid(*this, OLETEXT("Type"), DISPID(1102));
  TAutoArgs<1> _args;
...
template <class T> HRESULT /*[VT_HRESULT:0]*/ __fastcall
FieldDispT<T>::get_Properties(Adodb_xp::Properties** ppvObject/*[out,retval]*/)
{
  _TDispID _dispid(*this, OLETEXT("Properties"), DISPID(500));
  TAutoArgs<0> _args;
  return OutRetValSetterPtr((LPDISPATCH*)(Adodb_xp::Properties**)ppvObject /*[VT_USERDEFINED:2]*/, _args, OlePropertyGet(_dispid, _args));
...
template <class T> HRESULT __fastcall
TCOM_ParameterT<T>::get_Type(Adodb_xp::DataTypeEnum* psDataType/*[out,retval]*/)
{
...
template <class T> HRESULT __fastcall
TCOM_ParameterT<T>::set_Type(Adodb_xp::DataTypeEnum psDataType/*[in]*/)
{
  return (*this)->set_Type(psDataType);
}

template <class T> HRESULT __fastcall
TCOM_ParameterT<T>::set_Direction(Adodb_xp::ParameterDirectionEnum plParmDirection/*[in]*/)
{
  return (*this)->set_Direction(plParmDirection);
}

template <class T> HRESULT __fastcall
TCOM_ParameterT<T>::get_Direction(Adodb_xp::ParameterDirectionEnum* plParmDirection/*[out,retval]*/)
{
...
template <class T> HRESULT /*[VT_HRESULT:0]*/ __fastcall
_ParameterDispT<T>::get_Type(Adodb_xp::DataTypeEnum* psDataType/*[out,retval]*/)
{
...
{
  Adodb_xp::DataTypeEnum psDataType;
  this->get_Type((Adodb_xp::DataTypeEnum*)&psDataType);
  return psDataType;
}

template <class T> HRESULT /*[VT_HRESULT:0]*/ __fastcall
_ParameterDispT<T>::set_Type(Adodb_xp::DataTypeEnum psDataType/*[in]*/)
{
...
template <class T> HRESULT /*[VT_HRESULT:0]*/ __fastcall
_ParameterDispT<T>::set_Direction(Adodb_xp::ParameterDirectionEnum plParmDirection/*[in]*/)
{
...
template <class T> HRESULT /*[VT_HRESULT:0]*/ __fastcall
_ParameterDispT<T>::get_Direction(Adodb_xp::ParameterDirectionEnum* plParmDirection/*[out,retval]*/)
{
...
{
  Adodb_xp::ParameterDirectionEnum plParmDirection;
  this->get_Direction((Adodb_xp::ParameterDirectionEnum*)&plParmDirection);
  return plParmDirection;
}
...
template <class T> HRESULT /*[VT_HRESULT:0]*/ __fastcall
_ParameterDispT<T>::get_Properties(Adodb_xp::Properties** ppvObject/*[out,retval]*/)
{
  _TDispID _dispid(*this, OLETEXT("Properties"), DISPID(500));
  TAutoArgs<0> _args;
  return OutRetValSetterPtr((LPDISPATCH*)(Adodb_xp::Properties**)ppvObject /*[VT_USERDEFINED:2]*/, _args, OlePropertyGet(_dispid, _args));
...
// *********************************************************************//
template <class T> HRESULT /*[VT_HRESULT:0]*/ __fastcall
ParametersDispT<T>::get_Item(VARIANT Index/*[in]*/, Adodb_xp::_Parameter** ppvObject/*[out,retval]*/)
{
  _TDispID _dispid(*this, OLETEXT("Item"), DISPID(0));
  TAutoArgs<1> _args;
  _args[1] = Index /*[VT_VARIANT:0]*/;
  return OutRetValSetterPtr((LPDISPATCH*)(Adodb_xp::_Parameter**)ppvObject /*[VT_USERDEFINED:2]*/, _args, OlePropertyGet(_dispid, _args));
}
...
{
  Adodb_xp::_Parameter* ppvObject;
  this->get_Item(Index, (Adodb_xp::_Parameter**)&ppvObject);
  return ppvObject;
}
...
template <class T> HRESULT /*[VT_HRESULT:0]*/ __fastcall
_CommandDispT<T>::get_ActiveConnection(Adodb_xp::Connection15** ppvObject/*[out,retval]*/)
{
  _TDispID _dispid(*this, OLETEXT("ActiveConnection"), DISPID(DISPID_UNKNOWN/*[1610809344]*/));
  TAutoArgs<0> _args;
  return OutRetValSetterPtr((LPDISPATCH*)(Adodb_xp::Connection15**)ppvObject /*[VT_USERDEFINED:2]*/, _args, OlePropertyGet(_dispid, _args));
...
template <class T> HRESULT /*[VT_HRESULT:0]*/ __fastcall
_CommandDispT<T>::_set_ActiveConnection(Adodb_xp::Connection15* ppvObject/*[in]*/)
{
  _TDispID _dispid(*this, OLETEXT("ActiveConnection"), DISPID(1610809344));
  TAutoArgs<1> _args;
  _args[1] = (LPDISPATCH)(Adodb_xp::Connection15*)ppvObject /*[VT_USERDEFINED:1]*/;
...
template <class T> HRESULT /*[VT_HRESULT:0]*/ __fastcall
_CommandDispT<T>::get_Parameters(Adodb_xp::Parameters** ppvObject/*[out,retval]*/)
{
  _TDispID _dispid(*this, OLETEXT("Parameters"), DISPID(0));
  TAutoArgs<0> _args;
  return OutRetValSetterPtr((LPDISPATCH*)(Adodb_xp::Parameters**)ppvObject /*[VT_USERDEFINED:2]*/, _args, OlePropertyGet(_dispid, _args));
...
template <class T> HRESULT /*[VT_HRESULT:0]*/ __fastcall
_CommandDispT<T>::set_CommandType(Adodb_xp::CommandTypeEnum plCmdType/*[in]*/)
{
  _TDispID _dispid(*this, OLETEXT("CommandType"), DISPID(DISPID_UNKNOWN/*[1610809356]*/));
  TAutoArgs<1> _args;
  _args[1] = (int)plCmdType /*[VT_USERDEFINED:0]*/;
...
template <class T> HRESULT /*[VT_HRESULT:0]*/ __fastcall
_CommandDispT<T>::get_CommandType(Adodb_xp::CommandTypeEnum* plCmdType/*[out,retval]*/)
{
  _TDispID _dispid(*this, OLETEXT("CommandType"), DISPID(1610809356));
  TAutoArgs<0> _args;
  return OutRetValSetterPtr((int*)plCmdType /*[VT_USERDEFINED:1]*/, _args, OlePropertyGet(_dispid, _args));
...
template <class T> HRESULT /*[VT_HRESULT:0]*/ __fastcall
_CommandDispT<T>::get_Properties(Adodb_xp::Properties** ppvObject/*[out,retval]*/)
{
  _TDispID _dispid(*this, OLETEXT("Properties"), DISPID(500));
  TAutoArgs<0> _args;
  return OutRetValSetterPtr((LPDISPATCH*)(Adodb_xp::Properties**)ppvObject /*[VT_USERDEFINED:2]*/, _args, OlePropertyGet(_dispid, _args));
...
// *********************************************************************//
template <class T> HRESULT /*[VT_HRESULT:0]*/ __fastcall
ConnectionEventsDispT<T>::InfoMessage(Adodb_xp::Error* pError/*[in]*/, 
                                      Adodb_xp::EventStatusEnum* adStatus/*[in,out]*/, 
                                      Adodb_xp::Connection15* pConnection/*[in]*/)
{
  _TDispID _dispid(/* InfoMessage */ DISPID(0));
...
template <class T> HRESULT /*[VT_HRESULT:0]*/ __fastcall
ConnectionEventsDispT<T>::CommitTransComplete(Adodb_xp::Error* pError/*[in]*/, 
                                              Adodb_xp::EventStatusEnum* adStatus/*[in,out]*/, 
                                              Adodb_xp::Connection15* pConnection/*[in]*/)
{
  _TDispID _dispid(/* CommitTransComplete */ DISPID(3));
...
template <class T> HRESULT /*[VT_HRESULT:0]*/ __fastcall
ConnectionEventsDispT<T>::RollbackTransComplete(Adodb_xp::Error* pError/*[in]*/, 
                                                Adodb_xp::EventStatusEnum* adStatus/*[in,out]*/, 
                                                Adodb_xp::Connection15* pConnection/*[in]*/)
{
  _TDispID _dispid(/* RollbackTransComplete */ DISPID(2));
...
template <class T> HRESULT /*[VT_HRESULT:0]*/ __fastcall
ConnectionEventsDispT<T>::ConnectComplete(Adodb_xp::Error* pError/*[in]*/, 
                                          Adodb_xp::EventStatusEnum* adStatus/*[in,out]*/, 
                                          Adodb_xp::Connection15* pConnection/*[in]*/)
{
  _TDispID _dispid(/* ConnectComplete */ DISPID(7));
...
template <class T> HRESULT /*[VT_HRESULT:0]*/ __fastcall
ConnectionEventsDispT<T>::Disconnect(Adodb_xp::EventStatusEnum* adStatus/*[in,out]*/, 
                                     Adodb_xp::Connection15* pConnection/*[in]*/)
{
  _TDispID _dispid(/* Disconnect */ DISPID(8));
  TAutoArgs<2> _args;
...
template <class T> HRESULT /*[VT_HRESULT:0]*/ __fastcall
RecordsetEventsDispT<T>::WillChangeRecord(Adodb_xp::EventReasonEnum adReason/*[in]*/, 
                                          long cRecords/*[in]*/, 
                                          Adodb_xp::EventStatusEnum* adStatus/*[in,out]*/, 
                                          Adodb_xp::Recordset15* pRecordset/*[in]*/)
{
...
template <class T> HRESULT /*[VT_HRESULT:0]*/ __fastcall
RecordsetEventsDispT<T>::RecordChangeComplete(Adodb_xp::EventReasonEnum adReason/*[in]*/, 
                                              long cRecords/*[in]*/, Adodb_xp::Error* pError/*[in]*/
                                              , Adodb_xp::EventStatusEnum* adStatus/*[in,out]*/, 
                                              Adodb_xp::Recordset15* pRecordset/*[in]*/)
{
  _TDispID _dispid(/* RecordChangeComplete */ DISPID(12));
...
template <class T> HRESULT /*[VT_HRESULT:0]*/ __fastcall
RecordsetEventsDispT<T>::WillChangeRecordset(Adodb_xp::EventReasonEnum adReason/*[in]*/, 
                                             Adodb_xp::EventStatusEnum* adStatus/*[in,out]*/, 
                                             Adodb_xp::Recordset15* pRecordset/*[in]*/)
{
  _TDispID _dispid(/* WillChangeRecordset */ DISPID(13));
...
template <class T> HRESULT /*[VT_HRESULT:0]*/ __fastcall
RecordsetEventsDispT<T>::RecordsetChangeComplete(Adodb_xp::EventReasonEnum adReason/*[in]*/, 
                                                 Adodb_xp::Error* pError/*[in]*/, 
                                                 Adodb_xp::EventStatusEnum* adStatus/*[in,out]*/, 
                                                 Adodb_xp::Recordset15* pRecordset/*[in]*/)
{
...
template <class T> HRESULT /*[VT_HRESULT:0]*/ __fastcall
RecordsetEventsDispT<T>::WillMove(Adodb_xp::EventReasonEnum adReason/*[in]*/, 
                                  Adodb_xp::EventStatusEnum* adStatus/*[in,out]*/, 
                                  Adodb_xp::Recordset15* pRecordset/*[in]*/)
{
  _TDispID _dispid(/* WillMove */ DISPID(15));
...
template <class T> HRESULT /*[VT_HRESULT:0]*/ __fastcall
RecordsetEventsDispT<T>::MoveComplete(Adodb_xp::EventReasonEnum adReason/*[in]*/, 
                                      Adodb_xp::Error* pError/*[in]*/, 
                                      Adodb_xp::EventStatusEnum* adStatus/*[in,out]*/, 
                                      Adodb_xp::Recordset15* pRecordset/*[in]*/)
{
...
template <class T> HRESULT /*[VT_HRESULT:0]*/ __fastcall
RecordsetEventsDispT<T>::FetchComplete(Adodb_xp::Error* pError/*[in]*/, 
                                       Adodb_xp::EventStatusEnum* adStatus/*[in,out]*/, 
                                       Adodb_xp::Recordset15* pRecordset/*[in]*/)
{
  _TDispID _dispid(/* FetchComplete */ DISPID(19));
...
template <class T> HRESULT /*[VT_HRESULT:0]*/ __fastcall
Field15DispT<T>::get_Type(Adodb_xp::DataTypeEnum* pDataType/*[out,retval]*/)
{
  _TDispID _dispid(*this, OLETEXT("Type"), DISPID(1102));
  TAutoArgs<0> _args;
  return OutRetValSetterPtr((int*)pDataType /*[VT_USERDEFINED:1]*/, _args, OlePropertyGet(_dispid, _args));
...
template <class T> HRESULT /*[VT_HRESULT:0]*/ __fastcall
Field15DispT<T>::get_Properties(Adodb_xp::Properties** ppvObject/*[out,retval]*/)
{
  _TDispID _dispid(*this, OLETEXT("Properties"), DISPID(500));
  TAutoArgs<0> _args;
  return OutRetValSetterPtr((LPDISPATCH*)(Adodb_xp::Properties**)ppvObject /*[VT_USERDEFINED:2]*/, _args, OlePropertyGet(_dispid, _args));
...
{
public:
  HRESULT         Fire_InfoMessage(Adodb_xp::Error* pError, Adodb_xp::EventStatusEnum* adStatus, 
                                   Adodb_xp::Connection15* pConnection);
  HRESULT         Fire_BeginTransComplete(long TransactionLevel, Adodb_xp::Error* pError, 
                                          Adodb_xp::EventStatusEnum* adStatus, 
                                          Adodb_xp::Connection15* pConnection);
  HRESULT         Fire_CommitTransComplete(Adodb_xp::Error* pError, 
                                           Adodb_xp::EventStatusEnum* adStatus, 
                                           Adodb_xp::Connection15* pConnection);
  HRESULT         Fire_RollbackTransComplete(Adodb_xp::Error* pError, 
                                             Adodb_xp::EventStatusEnum* adStatus, 
                                             Adodb_xp::Connection15* pConnection);
  HRESULT         Fire_WillExecute(BSTR* Source, Adodb_xp::CursorTypeEnum* CursorType, 
                                   Adodb_xp::LockTypeEnum* LockType, long* Options, 
                                   Adodb_xp::EventStatusEnum* adStatus, Adodb_xp::_Command* pCommand, 
                                   Adodb_xp::Recordset15* pRecordset, 
                                   Adodb_xp::Connection15* pConnection);
  HRESULT         Fire_ExecuteComplete(long RecordsAffected, Adodb_xp::Error* pError, 
                                       Adodb_xp::EventStatusEnum* adStatus, 
                                       Adodb_xp::_Command* pCommand, 
                                       Adodb_xp::Recordset15* pRecordset, 
                                       Adodb_xp::Connection15* pConnection);
  HRESULT         Fire_WillConnect(BSTR* ConnectionString, BSTR* UserID, BSTR* Password, 
                                   long* Options, Adodb_xp::EventStatusEnum* adStatus, 
                                   Adodb_xp::Connection15* pConnection);
  HRESULT         Fire_ConnectComplete(Adodb_xp::Error* pError, Adodb_xp::EventStatusEnum* adStatus, 
                                       Adodb_xp::Connection15* pConnection);
  HRESULT         Fire_Disconnect(Adodb_xp::EventStatusEnum* adStatus, 
                                  Adodb_xp::Connection15* pConnection);
protected:
...
TEvents_Connection<T>::Fire_InfoMessage(Adodb_xp::Error* pError, Adodb_xp::EventStatusEnum* adStatus, 
                                        Adodb_xp::Connection15* pConnection)
{
  T * pT = (T*)this;
  pT->Lock();
...
template <class T> HRESULT
TEvents_Connection<T>::Fire_BeginTransComplete(long TransactionLevel, Adodb_xp::Error* pError, 
                                               Adodb_xp::EventStatusEnum* adStatus, 
                                               Adodb_xp::Connection15* pConnection)
{
  T * pT = (T*)this;
...
template <class T> HRESULT
TEvents_Connection<T>::Fire_CommitTransComplete(Adodb_xp::Error* pError, 
                                                Adodb_xp::EventStatusEnum* adStatus, 
                                                Adodb_xp::Connection15* pConnection)
{
  T * pT = (T*)this;
...
template <class T> HRESULT
TEvents_Connection<T>::Fire_RollbackTransComplete(Adodb_xp::Error* pError, 
                                                  Adodb_xp::EventStatusEnum* adStatus, 
                                                  Adodb_xp::Connection15* pConnection)
{
  T * pT = (T*)this;
...
template <class T> HRESULT
TEvents_Connection<T>::Fire_WillExecute(BSTR* Source, Adodb_xp::CursorTypeEnum* CursorType, 
                                        Adodb_xp::LockTypeEnum* LockType, long* Options, 
                                        Adodb_xp::EventStatusEnum* adStatus, 
                                        Adodb_xp::_Command* pCommand, 
                                        Adodb_xp::Recordset15* pRecordset, 
...
template <class T> HRESULT
TEvents_Connection<T>::Fire_ExecuteComplete(long RecordsAffected, Adodb_xp::Error* pError, 
                                            Adodb_xp::EventStatusEnum* adStatus, 
                                            Adodb_xp::_Command* pCommand, 
                                            Adodb_xp::Recordset15* pRecordset, 
                                            Adodb_xp::Connection15* pConnection)
...
template <class T> HRESULT
TEvents_Connection<T>::Fire_ConnectComplete(Adodb_xp::Error* pError, 
                                            Adodb_xp::EventStatusEnum* adStatus, 
                                            Adodb_xp::Connection15* pConnection)
{
  T * pT = (T*)this;
...
template <class T> HRESULT
TEvents_Connection<T>::Fire_Disconnect(Adodb_xp::EventStatusEnum* adStatus, 
                                       Adodb_xp::Connection15* pConnection)
{
  T * pT = (T*)this;
  pT->Lock();
...
public:
  HRESULT         Fire_WillChangeField(long cFields, VARIANT Fields, 
                                       Adodb_xp::EventStatusEnum* adStatus, 
                                       Adodb_xp::Recordset15* pRecordset);
  HRESULT         Fire_FieldChangeComplete(long cFields, VARIANT Fields, Adodb_xp::Error* pError, 
                                           Adodb_xp::EventStatusEnum* adStatus, 
                                           Adodb_xp::Recordset15* pRecordset);
  HRESULT         Fire_WillChangeRecord(Adodb_xp::EventReasonEnum adReason, long cRecords, 
                                        Adodb_xp::EventStatusEnum* adStatus, 
                                        Adodb_xp::Recordset15* pRecordset);
  HRESULT         Fire_RecordChangeComplete(Adodb_xp::EventReasonEnum adReason, long cRecords, 
                                            Adodb_xp::Error* pError, 
                                            Adodb_xp::EventStatusEnum* adStatus, 
                                            Adodb_xp::Recordset15* pRecordset);
  HRESULT         Fire_WillChangeRecordset(Adodb_xp::EventReasonEnum adReason, 
                                           Adodb_xp::EventStatusEnum* adStatus, 
                                           Adodb_xp::Recordset15* pRecordset);
  HRESULT         Fire_RecordsetChangeComplete(Adodb_xp::EventReasonEnum adReason, 
                                               Adodb_xp::Error* pError, 
                                               Adodb_xp::EventStatusEnum* adStatus, 
                                               Adodb_xp::Recordset15* pRecordset);
  HRESULT         Fire_WillMove(Adodb_xp::EventReasonEnum adReason, 
                                Adodb_xp::EventStatusEnum* adStatus, 
                                Adodb_xp::Recordset15* pRecordset);
  HRESULT         Fire_MoveComplete(Adodb_xp::EventReasonEnum adReason, Adodb_xp::Error* pError, 
                                    Adodb_xp::EventStatusEnum* adStatus, 
                                    Adodb_xp::Recordset15* pRecordset);
  HRESULT         Fire_EndOfRecordset(VARIANT_BOOL* fMoreData, Adodb_xp::EventStatusEnum* adStatus, 
                                      Adodb_xp::Recordset15* pRecordset);
  HRESULT         Fire_FetchProgress(long Progress, long MaxProgress, 
                                     Adodb_xp::EventStatusEnum* adStatus, 
                                     Adodb_xp::Recordset15* pRecordset);
  HRESULT         Fire_FetchComplete(Adodb_xp::Error* pError, Adodb_xp::EventStatusEnum* adStatus, 
                                     Adodb_xp::Recordset15* pRecordset);
protected:
...
template <class T> HRESULT
TEvents_Recordset<T>::Fire_FieldChangeComplete(long cFields, VARIANT Fields, Adodb_xp::Error* pError, 
                                               Adodb_xp::EventStatusEnum* adStatus, 
                                               Adodb_xp::Recordset15* pRecordset)
{
  T * pT = (T*)this;
...
template <class T> HRESULT
TEvents_Recordset<T>::Fire_WillChangeRecord(Adodb_xp::EventReasonEnum adReason, long cRecords, 
                                            Adodb_xp::EventStatusEnum* adStatus, 
                                            Adodb_xp::Recordset15* pRecordset)
{
  T * pT = (T*)this;
...
template <class T> HRESULT
TEvents_Recordset<T>::Fire_RecordChangeComplete(Adodb_xp::EventReasonEnum adReason, long cRecords, 
                                                Adodb_xp::Error* pError, 
                                                Adodb_xp::EventStatusEnum* adStatus, 
                                                Adodb_xp::Recordset15* pRecordset)
{
...
template <class T> HRESULT
TEvents_Recordset<T>::Fire_WillChangeRecordset(Adodb_xp::EventReasonEnum adReason, 
                                               Adodb_xp::EventStatusEnum* adStatus, 
                                               Adodb_xp::Recordset15* pRecordset)
{
  T * pT = (T*)this;
...
template <class T> HRESULT
TEvents_Recordset<T>::Fire_RecordsetChangeComplete(Adodb_xp::EventReasonEnum adReason, 
                                                   Adodb_xp::Error* pError, 
                                                   Adodb_xp::EventStatusEnum* adStatus, 
                                                   Adodb_xp::Recordset15* pRecordset)
{
...
template <class T> HRESULT
TEvents_Recordset<T>::Fire_WillMove(Adodb_xp::EventReasonEnum adReason, 
                                    Adodb_xp::EventStatusEnum* adStatus, 
                                    Adodb_xp::Recordset15* pRecordset)
{
  T * pT = (T*)this;
...
template <class T> HRESULT
TEvents_Recordset<T>::Fire_MoveComplete(Adodb_xp::EventReasonEnum adReason, Adodb_xp::Error* pError, 
                                        Adodb_xp::EventStatusEnum* adStatus, 
                                        Adodb_xp::Recordset15* pRecordset)
{
  T * pT = (T*)this;
...
template <class T> HRESULT
TEvents_Recordset<T>::Fire_FetchComplete(Adodb_xp::Error* pError, 
                                         Adodb_xp::EventStatusEnum* adStatus, 
                                         Adodb_xp::Recordset15* pRecordset)
{
  T * pT = (T*)this;
