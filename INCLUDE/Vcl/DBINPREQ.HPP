...
// (DO NOT EDIT: machine generated header) 'DBInpReq.pas' rev: 5.00
...
public:
	...
	/* TCustomForm.Create */ inline __fastcall virtual TInputReqDialog(Classes::TComponent* AOwner) : Forms::TForm(
		AOwner) { }
	#pragma option pop
	#pragma option push -w-inl
	/* TCustomForm.CreateNew */ inline __fastcall virtual TInputReqDialog(Classes::TComponent* AOwner, 
...
public:
	#pragma option push -w-inl
	/* TWinControl.CreateParented */ inline __fastcall TInputReqDialog(HWND ParentWindow) : Forms::TForm(
		ParentWindow) { }
	#pragma option pop
