...
// (DO NOT EDIT: machine generated header) 'qrexpred.pas' rev: 5.00
...
public:
	...
	/* TCustomForm.Create */ inline __fastcall virtual TQRExprEditorForm(Classes::TComponent* AOwner) : 
		Forms::TForm(AOwner) { }
	#pragma option pop
	#pragma option push -w-inl
	/* TCustomForm.CreateNew */ inline __fastcall virtual TQRExprEditorForm(Classes::TComponent* AOwner
...
public:
	#pragma option push -w-inl
	/* TWinControl.CreateParented */ inline __fastcall TQRExprEditorForm(HWND ParentWindow) : Forms::TForm(
		ParentWindow) { }
	#pragma option pop
...
public:
	#pragma option push -w-inl
	/* TQRPrintableEditor.Create */ inline __fastcall virtual TQRExprEditor(Quickrpt::TQRPrintable* AControl
		) : Qrlabled::TQRLabelEditor(AControl) { }
	#pragma option pop
