...
// (DO NOT EDIT: machine generated header) 'Dataform.pas' rev: 5.00
...
private:
	...
	Windows::TPoint __fastcall GetMaxControlValue();
...
public:
	...
	/* TCustomForm.Create */ inline __fastcall virtual TDataForm(Classes::TComponent* AOwner) : Forms::TForm(
		AOwner) { }
	#pragma option pop
	#pragma option push -w-inl
	/* TCustomForm.CreateNew */ inline __fastcall virtual TDataForm(Classes::TComponent* AOwner, int Dummy
