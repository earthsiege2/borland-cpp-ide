...
// (DO NOT EDIT: machine generated header) 'VirtIntf.pas' rev: 5.00
...
__interface INTERFACE_UUID("{12452621-5F8A-11D1-9FB6-0020AF3D82DA}") IStreamModifyTime  : public IUnknown 
