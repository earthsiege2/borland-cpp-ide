...
// (DO NOT EDIT: machine generated header) 'ColorGrd.pas' rev: 6.00
...
public:
	#pragma option push -w-inl
	/* TWinControl.CreateParented */ inline __fastcall TColorGrid(HWND ParentWindow) : Controls::TCustomControl(ParentWindow) { }
	#pragma option pop
