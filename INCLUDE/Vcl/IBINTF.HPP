...
// (DO NOT EDIT: machine generated header) 'IBIntf.pas' rev: 5.00
...
extern PACKAGE int __stdcall isc_rollback_retaining_stub(Ibexternals::PISC_STATUS status_vector, Ibheader::PISC_TR_HANDLE 
	tran_handle);
extern PACKAGE int __stdcall isc_service_attach_stub(Ibexternals::PISC_STATUS status_vector, Word isc_arg2
	, char * isc_arg3, Ibheader::PISC_SVC_HANDLE service_handle, Word isc_arg5, char * isc_arg6);
extern PACKAGE int __stdcall isc_service_detach_stub(Ibexternals::PISC_STATUS status_vector, Ibheader::PISC_SVC_HANDLE 
	service_handle);
extern PACKAGE int __stdcall isc_service_query_stub(Ibexternals::PISC_STATUS status_vector, Ibheader::PISC_SVC_HANDLE 
	service_handle, Ibheader::PISC_SVC_HANDLE recv_handle, Word isc_arg4, char * isc_arg5, Word isc_arg6
	, char * isc_arg7, Word isc_arg8, char * isc_arg9);
extern PACKAGE int __stdcall isc_service_start_stub(Ibexternals::PISC_STATUS status_vector, Ibheader::PISC_SVC_HANDLE 
	service_handle, Ibheader::PISC_SVC_HANDLE recv_handle, Word isc_arg4, char * isc_arg5);
extern PACKAGE void __stdcall isc_encode_sql_date_stub(Ibexternals::PCTimeStructure tm_date, Ibheader::PISC_DATE 
	ib_date);
extern PACKAGE void __stdcall isc_encode_sql_time_stub(Ibexternals::PCTimeStructure tm_date, Ibheader::PISC_TIME 
	ib_time);
extern PACKAGE void __stdcall isc_encode_timestamp_stub(Ibexternals::PCTimeStructure tm_date, Ibheader::PISC_TIMESTAMP 
	ib_timestamp);
extern PACKAGE void __stdcall isc_decode_sql_date_stub(Ibheader::PISC_DATE ib_date, Ibexternals::PCTimeStructure 
	tm_date);
extern PACKAGE void __stdcall isc_decode_sql_time_stub(Ibheader::PISC_TIME ib_time, Ibexternals::PCTimeStructure 
	tm_date);
extern PACKAGE void __stdcall isc_decode_timestamp_stub(Ibheader::PISC_TIMESTAMP ib_timestamp, Ibexternals::PCTimeStructure 
	tm_date);
extern PACKAGE int __stdcall isc_install_clear_options_stub(Ibinstallheader::POPTIONS_HANDLE hOption
	);
extern PACKAGE int __stdcall isc_install_execute_stub(int hOption, char * src_dir, char * dest_dir, 
	Ibinstallheader::FP_STATUS status_func, void * status_data, Ibinstallheader::FP_ERROR error_func, void * 
	error_data, char * uninstal_file_name);
extern PACKAGE int __stdcall isc_install_get_info_stub(int info_type, int option, void * info_buffer
	, unsigned buf_len);
extern PACKAGE int __stdcall isc_install_get_message_stub(int hOption, int message_no, void * message_txt
...
extern PACKAGE int __stdcall isc_install_precheck_stub(int hOption, char * src_dir, char * dest_dir)
	;
extern PACKAGE int __stdcall isc_install_set_option_stub(Ibinstallheader::POPTIONS_HANDLE hOption, int 
	option);
extern PACKAGE int __stdcall isc_uninstall_execute_stub(char * uninstall_file_name, Ibinstallheader::FP_STATUS 
	status_func, void * status_data, Ibinstallheader::FP_ERROR error_func, void * error_data);
extern PACKAGE int __stdcall isc_uninstall_precheck_stub(char * uninstall_file_name);
extern PACKAGE int __stdcall isc_install_unset_option_stub(Ibinstallheader::POPTIONS_HANDLE hOption, 
	int option);
