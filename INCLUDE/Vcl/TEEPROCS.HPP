...
// (DO NOT EDIT: machine generated header) 'TeeProcs.pas' rev: 5.00
...
public:
	...
	/* Exception.Create */ inline __fastcall ChartException(const AnsiString Msg) : Sysutils::Exception(
		Msg) { }
	#pragma option pop
	#pragma option push -w-inl
	/* Exception.CreateFmt */ inline __fastcall ChartException(const AnsiString Msg, const System::TVarRec 
		* Args, const int Args_Size) : Sysutils::Exception(Msg, Args, Args_Size) { }
	#pragma option pop
	#pragma option push -w-inl
	/* Exception.CreateRes */ inline __fastcall ChartException(int Ident)/* overload */ : Sysutils::Exception(
		Ident) { }
	#pragma option pop
	#pragma option push -w-inl
	/* Exception.CreateResFmt */ inline __fastcall ChartException(int Ident, const System::TVarRec * Args
		, const int Args_Size)/* overload */ : Sysutils::Exception(Ident, Args, Args_Size) { }
	#pragma option pop
	#pragma option push -w-inl
	/* Exception.CreateHelp */ inline __fastcall ChartException(const AnsiString Msg, int AHelpContext)
		 : Sysutils::Exception(Msg, AHelpContext) { }
	#pragma option pop
	#pragma option push -w-inl
	/* Exception.CreateFmtHelp */ inline __fastcall ChartException(const AnsiString Msg, const System::TVarRec 
		* Args, const int Args_Size, int AHelpContext) : Sysutils::Exception(Msg, Args, Args_Size, AHelpContext
		) { }
	#pragma option pop
	#pragma option push -w-inl
	/* Exception.CreateResHelp */ inline __fastcall ChartException(int Ident, int AHelpContext)/* overload */
		 : Sysutils::Exception(Ident, AHelpContext) { }
	#pragma option pop
	#pragma option push -w-inl
	/* Exception.CreateResFmtHelp */ inline __fastcall ChartException(System::PResStringRec ResStringRec
...
enum TDateTimeStep { dtOneSecond, dtFiveSeconds, dtTenSeconds, dtFifteenSeconds, dtThirtySeconds, dtOneMinute, 
	dtFiveMinutes, dtTenMinutes, dtFifteenMinutes, dtThirtyMinutes, dtOneHour, dtTwoHours, dtSixHours, 
	dtTwelveHours, dtOneDay, dtTwoDays, dtThreeDays, dtOneWeek, dtHalfMonth, dtOneMonth, dtTwoMonths, dtThreeMonths, 
	dtFourMonths, dtSixMonths, dtOneYear, dtNone };
#pragma option pop
...
protected:
	...
	virtual void __fastcall InternalDraw(const Windows::TRect &UserRectangle) = 0 ;
	virtual void __fastcall Paint(void);
	
public:
	bool AutoRepaint;
	bool CancelMouse;
	Windows::TRect ChartRect;
	Windows::TRect PrintMargins;
	__fastcall virtual TCustomTeePanel(Classes::TComponent* AOwner);
	__fastcall virtual ~TCustomTeePanel(void);
	virtual void __fastcall Assign(Classes::TPersistent* Source);
	void __fastcall CalcMetaBounds(Windows::TRect &R, const Windows::TRect &AChartRect, int &WinWidth, 
		int &WinHeight, int &ViewWidth, int &ViewHeight);
	Windows::TRect __fastcall CalcProportionalMargins();
	bool __fastcall CanClip(void);
	virtual void __fastcall CanvasChanged(System::TObject* Sender);
	Windows::TRect __fastcall ChartPrintRect();
	...
	Graphics::TBitmap* __fastcall TeeCreateBitmap(Graphics::TColor ABackColor, const Windows::TRect &Rect
		);
	virtual void __fastcall Draw(Graphics::TCanvas* UserCanvas, const Windows::TRect &UserRect);
	virtual void __fastcall DrawPanelBevels(const Windows::TRect &Rect);
	void __fastcall DrawToMetaCanvas(Graphics::TCanvas* ACanvas, const Windows::TRect &Rect);
	...
	void __fastcall PrintPartial(const Windows::TRect &PrinterRect);
	void __fastcall PrintPartialCanvas(Graphics::TCanvas* PrintCanvas, const Windows::TRect &PrinterRect
		);
	void __fastcall PrintPortrait(void);
	void __fastcall PrintRect(const Windows::TRect &R);
	...
	void __fastcall SaveToMetafileRect(bool Enhanced, const AnsiString FileName, const Windows::TRect &
		Rect);
	void __fastcall SetBooleanProperty(bool &Variable, bool Value);
	void __fastcall SetBrushCanvas(Graphics::TColor AColor, Graphics::TBrushStyle APattern, Graphics::TColor 
		ABackColor);
	...
	Graphics::TMetafile* __fastcall TeeCreateMetafile(bool Enhanced, const Windows::TRect &Rect);
	...
	__property Windows::TRect ChartBounds = {read=FChartBounds};
...
public:
	#pragma option push -w-inl
	/* TWinControl.CreateParented */ inline __fastcall TCustomTeePanel(HWND ParentWindow) : Extctrls::TCustomPanel(
		ParentWindow) { }
	#pragma option pop
...
public:
	#pragma option push -w-inl
	/* TCustomTeeGradient.Create */ inline __fastcall TChartGradient(TCustomTeePanel* AOwner) : TCustomTeeGradient(
		AOwner) { }
	#pragma option pop
...
protected:
	...
	void __fastcall DrawBitmap(const Windows::TRect &Rect, int Z);
	virtual void __fastcall DrawImage(const Windows::TRect &R);
	virtual void __fastcall FillPanelRect(const Windows::TRect &Rect);
	virtual void __fastcall PanelPaint(const Windows::TRect &UserRect);
...
public:
	#pragma option push -w-inl
	/* TWinControl.CreateParented */ inline __fastcall TCustomTeePanelExtended(HWND ParentWindow) : TCustomTeePanel(
		ParentWindow) { }
	#pragma option pop
...
typedef void __fastcall (__closure *TDraw3DPaintEvent)(System::TObject* Sender, const Windows::TRect 
	&ARect);
...
public:
	#pragma option push -w-inl
	/* TCustomTeePanelExtended.Create */ inline __fastcall virtual TDraw3D(Classes::TComponent* AOwner)
		 : TCustomTeePanelExtended(AOwner) { }
	#pragma option pop
	#pragma option push -w-inl
...
public:
	#pragma option push -w-inl
	/* TWinControl.CreateParented */ inline __fastcall TDraw3D(HWND ParentWindow) : TCustomTeePanelExtended(
		ParentWindow) { }
	#pragma option pop
...
extern PACKAGE bool __fastcall PointInLineTolerance(const Windows::TPoint &P, int px, int py, int qx
	, int qy, int TolerancePixels);
extern PACKAGE bool __fastcall PointInLine(const Windows::TPoint &P, int px, int py, int qx, int qy)
	;
extern PACKAGE bool __fastcall PointInPolygon(const Windows::TPoint &P, const Windows::TPoint * Poly
	, const int Poly_Size);
extern PACKAGE bool __fastcall PointInTriangle(const Windows::TPoint &P, int X0, int X1, int Y0, int 
	Y1);
extern PACKAGE bool __fastcall PointInHorizTriangle(const Windows::TPoint &P, int Y0, int Y1, int X0
	, int X1);
extern PACKAGE bool __fastcall PointInEllipse(const Windows::TPoint &P, const Windows::TRect &Rect);
...
extern PACKAGE void __fastcall EnableControls(bool Enable, Controls::TControl* const * ControlArray, 
	const int ControlArray_Size);
extern PACKAGE System::TDateTime __fastcall TeeRoundDate(const System::TDateTime ADate, TDateTimeStep 
	AStep);
extern PACKAGE void __fastcall TeeDateTimeIncrement(bool IsDateTime, bool Increment, double &Value, 
	const double AnIncrement, TDateTimeStep tmpWhichDateTime);
extern PACKAGE double __fastcall TeeNextStep(const double OldStep);
extern PACKAGE void __fastcall TeeGetClassNameBitmap(Classes::TComponent* AClass, Graphics::TBitmap* 
	ABitmap);
...
extern PACKAGE AnsiString __fastcall TeeGetUniqueName(Classes::TComponent* AOwner, const AnsiString 
	AStartName);
