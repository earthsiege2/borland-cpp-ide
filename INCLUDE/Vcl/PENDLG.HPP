...
// (DO NOT EDIT: machine generated header) 'PenDlg.pas' rev: 6.00
...
extern PACKAGE void __fastcall EnableControls(bool Show, const Controls::TControl* * AControls, const int AControls_Size);
