...
// (DO NOT EDIT: machine generated header) 'IdIPWatch.pas' rev: 6.00
...
public:
	...
	/* TIdThread.Create */ inline __fastcall virtual TIdIPWatchThread(bool ACreateSuspended) : Idthread::TIdThread(ACreateSuspended) { }
	#pragma option pop
	#pragma option push -w-inl
...
static const bool IP_WATCH_ACTIVE = false;
static const bool IP_WATCH_HIST_ENABLED = true;
