...
// (DO NOT EDIT: machine generated header) 'IdTrivialFTPServer.pas' rev: 6.00
...
typedef void __fastcall (__closure *TAccessFileEvent)(System::TObject* Sender, AnsiString &FileName, const TPeerInfo &PeerInfo, bool &GrantAccess, Classes::TStream* &AStream, bool &FreeStreamOnComplete);
...
protected:
	...
	virtual void __fastcall DoReadFile(AnsiString FileName, const Idtrivialftpbase::TIdTFTPMode Mode, const TPeerInfo &PeerInfo, int RequestedBlockSize = 0x0);
	virtual void __fastcall DoWriteFile(AnsiString FileName, const Idtrivialftpbase::TIdTFTPMode Mode, const TPeerInfo &PeerInfo, int RequestedBlockSize = 0x0);
