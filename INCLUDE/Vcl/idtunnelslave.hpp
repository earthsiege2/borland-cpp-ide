...
// (DO NOT EDIT: machine generated header) 'IdTunnelSlave.pas' rev: 6.00
...
__published:
	...
	__property Idtunnelcommon::TSendTrnEventC OnBeforeTunnelConnect = {read=fOnBeforeTunnelConnect, write=fOnBeforeTunnelConnect};
