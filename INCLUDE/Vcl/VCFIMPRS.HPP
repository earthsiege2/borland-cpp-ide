...
// (DO NOT EDIT: machine generated header) 'VCFImprs.pas' rev: 5.00
...
public:
	...
	/* TOleControl.Create */ inline __fastcall virtual TVCFirstImpression(Classes::TComponent* AOwner) : 
		Olectrls::TOleControl(AOwner) { }
	#pragma option pop
	#pragma option push -w-inl
...
public:
	#pragma option push -w-inl
	/* TWinControl.CreateParented */ inline __fastcall TVCFirstImpression(HWND ParentWindow) : Olectrls::TOleControl(
		ParentWindow) { }
	#pragma option pop
