...
// (DO NOT EDIT: machine generated header) 'TeeGally.pas' rev: 5.00
...
{
//-- type declarations -------------------------------------------------------
typedef TTabControl TeeTabControlClass;
;
...
public:
	...
	/* TCustomTabControl.Create */ inline __fastcall virtual TTeeTabControl(Classes::TComponent* AOwner
		) : Comctrls::TTabControl(AOwner) { }
	#pragma option pop
	#pragma option push -w-inl
...
public:
	#pragma option push -w-inl
	/* TWinControl.CreateParented */ inline __fastcall TTeeTabControl(HWND ParentWindow) : Comctrls::TTabControl(
		ParentWindow) { }
	#pragma option pop
...
public:
	...
	#pragma option push -w-inl
	/* TWinControl.CreateParented */ inline __fastcall TTeeGalleryPanel(HWND ParentWindow) : Extctrls::TPanel(
		ParentWindow) { }
	#pragma option pop
...
public:
	...
	void __fastcall CreateGalleryList(TMetaClass* const * ASeriesList, const int ASeriesList_Size);
public:
		
	#pragma option push -w-inl
	/* TCustomForm.Create */ inline __fastcall virtual TTeeGallery(Classes::TComponent* AOwner) : Forms::TForm(
		AOwner) { }
	#pragma option pop
	#pragma option push -w-inl
	/* TCustomForm.CreateNew */ inline __fastcall virtual TTeeGallery(Classes::TComponent* AOwner, int 
...
extern PACKAGE bool __fastcall GetChartGalleryClass(Classes::TComponent* AOwner, Teengine::TChartSeries* 
	OldSeries, bool ShowFunctions, TMetaClass* &tmpClass, bool &Show3D, TMetaClass* &tmpFunctionClass);
	
extern PACKAGE Teengine::TChartSeries* __fastcall CreateNewSeriesGallery(Classes::TComponent* AOwner
	, Teengine::TChartSeries* OldSeries, Chart::TCustomChart* tmpChart, bool AllowSameType, bool ShowFunctions
	);
extern PACKAGE void __fastcall ChangeSeriesTypeGallery(Classes::TComponent* AOwner, Teengine::TChartSeries* 
	&tmpSeries);
extern PACKAGE void __fastcall ChangeAllSeriesGallery(Classes::TComponent* AOwner, Chart::TCustomChart* 
	AChart);
