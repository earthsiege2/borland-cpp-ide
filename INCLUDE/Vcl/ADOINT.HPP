...
// (DO NOT EDIT: machine generated header) 'ADOInt.pas' rev: 5.00
...
public:
	...
	virtual HRESULT __safecall Execute(/* out */ OleVariant &RecordsAffected, const OleVariant &Parameters
		, int Options, _di__Recordset &Execute_result) = 0 ;
...
public:
	...
	virtual HRESULT __safecall OpenSchema(Activex::TOleEnum Schema, const OleVariant Restrictions, const 
		OleVariant SchemaID, _di__Recordset &OpenSchema_result) = 0 ;
	#pragma option push -w-inl
...
public:
	...
	virtual HRESULT __safecall Get_CursorLocation(Activex::TOleEnum &Get_CursorLocation_result) = 0 ;
	virtual HRESULT __safecall Set_CursorLocation(Activex::TOleEnum plCursorLoc) = 0 ;
	virtual HRESULT __safecall NextRecordset(/* out */ OleVariant &RecordsAffected, _di__Recordset &NextRecordset_result
		) = 0 ;
...
public:
	...
	virtual HRESULT __safecall Set_DataSource(const _di_IUnknown ppunkDataSource) = 0 ;
	...
	/* safecall wrapper */ inline _di_IUnknown _scw_Get_DataSource() { _di_IUnknown r; HRESULT hr = Get_DataSource(
		r); System::CheckSafecallResult(hr); return r; }
	#pragma option pop
	__property _di_IUnknown DataSource = {read=_scw_Get_DataSource, write=Set_DataSource};
	#pragma option push -w-inl
...
public:
	...
	#pragma option push -w-inl
	/* safecall wrapper */ inline _di_Field _scw_Get_Item(const OleVariant Index) { _di_Field r; HRESULT hr = Get_Item(
		Index, r); System::CheckSafecallResult(hr); return r; }
	#pragma option pop
...
public:
	...
	virtual HRESULT __safecall Set_DataFormat(const _di_IUnknown ppiDF) = 0 ;
	...
	/* safecall wrapper */ inline _di_IUnknown _scw_Get_DataFormat() { _di_IUnknown r; HRESULT hr = Get_DataFormat(
		r); System::CheckSafecallResult(hr); return r; }
	#pragma option pop
	__property _di_IUnknown DataFormat = {read=_scw_Get_DataFormat, write=Set_DataFormat};
};
...
public:
	virtual HRESULT __safecall InfoMessage(const _di_Error pError, Activex::TOleEnum &adStatus, const _di__Connection 
		pConnection) = 0 ;
	virtual HRESULT __safecall BeginTransComplete(int TransactionLevel, const _di_Error pError, Activex::TOleEnum 
		&adStatus, const _di__Connection pConnection) = 0 ;
	virtual HRESULT __safecall CommitTransComplete(const _di_Error pError, Activex::TOleEnum &adStatus, 
		const _di__Connection pConnection) = 0 ;
	virtual HRESULT __safecall RollbackTransComplete(const _di_Error pError, Activex::TOleEnum &adStatus
		, const _di__Connection pConnection) = 0 ;
	virtual HRESULT __safecall WillExecute(WideString &Source, Activex::TOleEnum &CursorType, Activex::TOleEnum 
		&LockType, int &Options, Activex::TOleEnum &adStatus, const _di__Command pCommand, const _di__Recordset 
		pRecordset, const _di__Connection pConnection) = 0 ;
	virtual HRESULT __safecall ExecuteComplete(int RecordsAffected, const _di_Error pError, Activex::TOleEnum 
		&adStatus, const _di__Command pCommand, const _di__Recordset pRecordset, const _di__Connection pConnection
		) = 0 ;
	virtual HRESULT __safecall WillConnect(WideString &ConnectionString, WideString &UserID, WideString 
		&Password, int &Options, Activex::TOleEnum &adStatus, const _di__Connection pConnection) = 0 ;
	virtual HRESULT __safecall ConnectComplete(const _di_Error pError, Activex::TOleEnum &adStatus, const 
		_di__Connection pConnection) = 0 ;
	virtual HRESULT __safecall Disconnect(Activex::TOleEnum &adStatus, const _di__Connection pConnection
		) = 0 ;
};
...
public:
	virtual HRESULT __safecall WillChangeField(int cFields, const OleVariant Fields, Activex::TOleEnum 
		&adStatus, const _di__Recordset pRecordset) = 0 ;
	virtual HRESULT __safecall FieldChangeComplete(int cFields, const OleVariant Fields, const _di_Error 
		pError, Activex::TOleEnum &adStatus, const _di__Recordset pRecordset) = 0 ;
	virtual HRESULT __safecall WillChangeRecord(Activex::TOleEnum adReason, int cRecords, Activex::TOleEnum 
		&adStatus, const _di__Recordset pRecordset) = 0 ;
	virtual HRESULT __safecall RecordChangeComplete(Activex::TOleEnum adReason, int cRecords, const _di_Error 
		pError, Activex::TOleEnum &adStatus, const _di__Recordset pRecordset) = 0 ;
	virtual HRESULT __safecall WillChangeRecordset(Activex::TOleEnum adReason, Activex::TOleEnum &adStatus
		, const _di__Recordset pRecordset) = 0 ;
	virtual HRESULT __safecall RecordsetChangeComplete(Activex::TOleEnum adReason, const _di_Error pError
		, Activex::TOleEnum &adStatus, const _di__Recordset pRecordset) = 0 ;
	virtual HRESULT __safecall WillMove(Activex::TOleEnum adReason, Activex::TOleEnum &adStatus, const 
		_di__Recordset pRecordset) = 0 ;
	virtual HRESULT __safecall MoveComplete(Activex::TOleEnum adReason, const _di_Error pError, Activex::TOleEnum 
		&adStatus, const _di__Recordset pRecordset) = 0 ;
	virtual HRESULT __safecall EndOfRecordset(Word &fMoreData, Activex::TOleEnum &adStatus, const _di__Recordset 
		pRecordset) = 0 ;
	virtual HRESULT __safecall FetchProgress(int Progress, int MaxProgress, Activex::TOleEnum &adStatus
		, const _di__Recordset pRecordset) = 0 ;
	virtual HRESULT __safecall FetchComplete(const _di_Error pError, Activex::TOleEnum &adStatus, const 
		_di__Recordset pRecordset) = 0 ;
};
...
public:
	virtual HRESULT __safecall Get_DSO(_di_IUnknown &Get_DSO_result) = 0 ;
	virtual HRESULT __safecall Get_Session(_di_IUnknown &Get_Session_result) = 0 ;
	virtual HRESULT __safecall WrapDSOandSession(const _di_IUnknown pDSO, const _di_IUnknown pSession) = 0 
		;
};
...
public:
	virtual HRESULT __safecall Get_Rowset(_di_IUnknown &Get_Rowset_result) = 0 ;
	virtual HRESULT __safecall Set_Rowset(const _di_IUnknown ppRowset) = 0 ;
	virtual HRESULT __safecall Get_Chapter(int &Get_Chapter_result) = 0 ;
	virtual HRESULT __safecall Set_Chapter(int plChapter) = 0 ;
	virtual HRESULT __safecall Get_RowPosition(_di_IUnknown &Get_RowPosition_result) = 0 ;
	virtual HRESULT __safecall Set_RowPosition(const _di_IUnknown ppRowPos) = 0 ;
	#pragma option push -w-inl
	/* safecall wrapper */ inline _di_IUnknown _scw_Get_Rowset() { _di_IUnknown r; HRESULT hr = Get_Rowset(
		r); System::CheckSafecallResult(hr); return r; }
	#pragma option pop
	__property _di_IUnknown Rowset = {read=_scw_Get_Rowset, write=Set_Rowset};
	#pragma option push -w-inl
	...
	#pragma option push -w-inl
	/* safecall wrapper */ inline _di_IUnknown _scw_Get_RowPosition() { _di_IUnknown r; HRESULT hr = Get_RowPosition(
		r); System::CheckSafecallResult(hr); return r; }
	#pragma option pop
	__property _di_IUnknown RowPosition = {read=_scw_Get_RowPosition, write=Set_RowPosition};
};
...
public:
	virtual HRESULT __safecall CreateObject(const WideString bstrProgid, const WideString bstrConnection
		, OleVariant &CreateObject_result) = 0 ;
	...
	#pragma option push -w-inl
	/* safecall wrapper */ inline int _scw_Get_InternetTimeout() { int r; HRESULT hr = Get_InternetTimeout(
		r); System::CheckSafecallResult(hr); return r; }
	#pragma option pop
...
public:
	...
	/*         class method */ static _di__Connection __fastcall CreateRemote(TMetaClass* vmt, const AnsiString 
		MachineName);
public:
	#pragma option push -w-inl
...
public:
	...
	/*         class method */ static _di__Recordset __fastcall CreateRemote(TMetaClass* vmt, const AnsiString 
		MachineName);
public:
	#pragma option push -w-inl
