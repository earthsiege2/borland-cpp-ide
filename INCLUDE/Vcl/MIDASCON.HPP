...
// (DO NOT EDIT: machine generated header) 'MidasCon.pas' rev: 6.00
...
public:
	...
	/* TDCOMConnection.Create */ inline __fastcall virtual TRemoteServer(Classes::TComponent* AOwner) : Mconnect::TDCOMConnection(AOwner) { }
	#pragma option pop
