...
class PACKAGE TSpinButton : public TWinControl
{
...
//	__fastcall virtual TSpinButton(HWND Parent): TWinControl(Parent) {};
...
class PACKAGE TSpinEdit : public TCustomEdit
{
private:
	long FMinValue;
	long FMaxValue;
...
public:
	...
	__fastcall virtual TSpinEdit(HWND Parent): TCustomEdit(Parent) {};
