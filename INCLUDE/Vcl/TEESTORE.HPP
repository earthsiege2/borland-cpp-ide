...
// (DO NOT EDIT: machine generated header) 'TeeStore.pas' rev: 5.00
...
//-- var, const, procedure ---------------------------------------------------
extern PACKAGE void __fastcall LoadChartFromStreamCheck(Chart::TCustomChart* &AChart, Classes::TStream* 
	AStream, TProcTeeCheckError ACheckError);
extern PACKAGE void __fastcall LoadChartFromStream(Chart::TCustomChart* &AChart, Classes::TStream* AStream
	);
extern PACKAGE void __fastcall LoadChartFromFileCheck(Chart::TCustomChart* &AChart, const AnsiString 
	AName, TProcTeeCheckError ACheckError);
