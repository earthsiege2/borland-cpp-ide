...
// (DO NOT EDIT: machine generated header) 'IdDateTimeStamp.pas' rev: 6.00
...
public:
	...
	AnsiString __fastcall GetAsRFC882();
	...
	__property AnsiString AsRFC822 = {read=GetAsRFC882};
	...
	__property int Millisecond = {read=FMillisecond, write=FMillisecond, nodefault};
