...
// (DO NOT EDIT: machine generated header) 'ImageHlp.pas' rev: 6.00
...
typedef BOOL __stdcall (*TImagehlpStatusRoutine)(_IMAGEHLP_STATUS_REASON Reason, char * ImageName, char * DllName, unsigned Va, unsigned Parameter);
...
typedef BOOL __stdcall (*TReadProcessMemoryRoutine)(unsigned hProcess, void * lpBaseAddress, void * lpBuffer, unsigned nSize, unsigned &lpNumberOfBytesRead);
...
typedef unsigned __stdcall (*TTranslateAddressRoutine)(unsigned hProcess, unsigned hThread, PAddress lpaddr);
...
typedef BOOL __stdcall (*TSymEnumsymbolsCallback)(char * SymbolName, unsigned SymbolAddress, unsigned SymbolSize, void * UserContext);

typedef BOOL __stdcall (*TEnumloadedModulesCallback)(char * ModuleName, unsigned ModuleBase, unsigned ModuleSize, void * UserContext);

typedef BOOL __stdcall (*TSymbolRegisteredCallback)(unsigned hProcess, unsigned ActionCode, void * CallbackData, void * UserContext);
...
typedef BOOL __stdcall (*TDigestFunction)(void * refdata, System::PByte pData, unsigned dwLength);
