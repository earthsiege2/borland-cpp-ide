...
// (DO NOT EDIT: machine generated header) 'GanttEdi.pas' rev: 5.00
...
public:
	...
	/* TCustomForm.Create */ inline __fastcall virtual TGanttSeriesEditor(Classes::TComponent* AOwner) : 
		Forms::TForm(AOwner) { }
	#pragma option pop
	#pragma option push -w-inl
	/* TCustomForm.CreateNew */ inline __fastcall virtual TGanttSeriesEditor(Classes::TComponent* AOwner
...
public:
	#pragma option push -w-inl
	/* TWinControl.CreateParented */ inline __fastcall TGanttSeriesEditor(HWND ParentWindow) : Forms::TForm(
		ParentWindow) { }
	#pragma option pop
