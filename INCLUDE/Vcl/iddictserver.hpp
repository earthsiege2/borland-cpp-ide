...
// (DO NOT EDIT: machine generated header) 'IdDICTServer.pas' rev: 6.00
...
typedef void __fastcall (__closure *TIdDICTOtherEvent)(Idtcpserver::TIdPeerThread* Thread, AnsiString Command, AnsiString Parm);

typedef void __fastcall (__closure *TIdDICTDefineEvent)(Idtcpserver::TIdPeerThread* Thread, AnsiString Database, AnsiString WordToFind);

typedef void __fastcall (__closure *TIdDICTMatchEvent)(Idtcpserver::TIdPeerThread* Thread, AnsiString Database, AnsiString Strategy, AnsiString WordToFind);

typedef void __fastcall (__closure *TIdDICTShowEvent)(Idtcpserver::TIdPeerThread* Thread, AnsiString Command);

typedef void __fastcall (__closure *TIdDICTAuthEvent)(Idtcpserver::TIdPeerThread* Thread, AnsiString Username, AnsiString authstring);
