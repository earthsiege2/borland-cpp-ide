...
// (DO NOT EDIT: machine generated header) 'DdeMan.pas' rev: 6.00
...
extern PACKAGE bool __fastcall GetPasteLinkInfo(AnsiString &Service, AnsiString &Topic, AnsiString &Item);
