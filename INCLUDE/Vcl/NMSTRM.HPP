...
// (DO NOT EDIT: machine generated header) 'NMSTRM.pas' rev: 6.00
...
{
//-- type declarations -------------------------------------------------------
typedef void __fastcall (__closure *TStrmEvent)(Classes::TComponent* Sender, const AnsiString sFrom, Classes::TStream* strm);
