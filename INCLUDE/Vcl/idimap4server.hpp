...
// (DO NOT EDIT: machine generated header) 'IdIMAP4Server.pas' rev: 6.00
...
typedef void __fastcall (__closure *TCommandEvent)(Idtcpserver::TIdPeerThread* Thread, const AnsiString Tag, const AnsiString CmdStr, bool &Handled);
...
protected:
	...
	void __fastcall DoCommandCAPABILITY(Idtcpserver::TIdPeerThread* Thread, const AnsiString Tag, const AnsiString CmdStr, bool &Handled);
	void __fastcall DoCommandNOOP(Idtcpserver::TIdPeerThread* Thread, const AnsiString Tag, const AnsiString CmdStr, bool &Handled);
	void __fastcall DoCommandLOGOUT(Idtcpserver::TIdPeerThread* Thread, const AnsiString Tag, const AnsiString CmdStr, bool &Handled);
	void __fastcall DoCommandAUTHENTICATE(Idtcpserver::TIdPeerThread* Thread, const AnsiString Tag, const AnsiString CmdStr, bool &Handled);
	void __fastcall DoCommandLOGIN(Idtcpserver::TIdPeerThread* Thread, const AnsiString Tag, const AnsiString CmdStr, bool &Handled);
	void __fastcall DoCommandSELECT(Idtcpserver::TIdPeerThread* Thread, const AnsiString Tag, const AnsiString CmdStr, bool &Handled);
	void __fastcall DoCommandEXAMINE(Idtcpserver::TIdPeerThread* Thread, const AnsiString Tag, const AnsiString CmdStr, bool &Handled);
	void __fastcall DoCommandCREATE(Idtcpserver::TIdPeerThread* Thread, const AnsiString Tag, const AnsiString CmdStr, bool &Handled);
	void __fastcall DoCommandDELETE(Idtcpserver::TIdPeerThread* Thread, const AnsiString Tag, const AnsiString CmdStr, bool &Handled);
	void __fastcall DoCommandRENAME(Idtcpserver::TIdPeerThread* Thread, const AnsiString Tag, const AnsiString CmdStr, bool &Handled);
	void __fastcall DoCommandSUBSCRIBE(Idtcpserver::TIdPeerThread* Thread, const AnsiString Tag, const AnsiString CmdStr, bool &Handled);
	void __fastcall DoCommandUNSUBSCRIBE(Idtcpserver::TIdPeerThread* Thread, const AnsiString Tag, const AnsiString CmdStr, bool &Handled);
	void __fastcall DoCommandLIST(Idtcpserver::TIdPeerThread* Thread, const AnsiString Tag, const AnsiString CmdStr, bool &Handled);
	void __fastcall DoCommandLSUB(Idtcpserver::TIdPeerThread* Thread, const AnsiString Tag, const AnsiString CmdStr, bool &Handled);
	void __fastcall DoCommandSTATUS(Idtcpserver::TIdPeerThread* Thread, const AnsiString Tag, const AnsiString CmdStr, bool &Handled);
	void __fastcall DoCommandAPPEND(Idtcpserver::TIdPeerThread* Thread, const AnsiString Tag, const AnsiString CmdStr, bool &Handled);
	void __fastcall DoCommandCHECK(Idtcpserver::TIdPeerThread* Thread, const AnsiString Tag, const AnsiString CmdStr, bool &Handled);
	void __fastcall DoCommandCLOSE(Idtcpserver::TIdPeerThread* Thread, const AnsiString Tag, const AnsiString CmdStr, bool &Handled);
	void __fastcall DoCommandEXPUNGE(Idtcpserver::TIdPeerThread* Thread, const AnsiString Tag, const AnsiString CmdStr, bool &Handled);
	void __fastcall DoCommandSEARCH(Idtcpserver::TIdPeerThread* Thread, const AnsiString Tag, const AnsiString CmdStr, bool &Handled);
	void __fastcall DoCommandFETCH(Idtcpserver::TIdPeerThread* Thread, const AnsiString Tag, const AnsiString CmdStr, bool &Handled);
	void __fastcall DoCommandSTORE(Idtcpserver::TIdPeerThread* Thread, const AnsiString Tag, const AnsiString CmdStr, bool &Handled);
	void __fastcall DoCommandCOPY(Idtcpserver::TIdPeerThread* Thread, const AnsiString Tag, const AnsiString CmdStr, bool &Handled);
	void __fastcall DoCommandUID(Idtcpserver::TIdPeerThread* Thread, const AnsiString Tag, const AnsiString CmdStr, bool &Handled);
	void __fastcall DoCommandX(Idtcpserver::TIdPeerThread* Thread, const AnsiString Tag, const AnsiString CmdStr, bool &Handled);
	void __fastcall DoCommandError(Idtcpserver::TIdPeerThread* Thread, const AnsiString Tag, const AnsiString CmdStr, bool &Handled);
