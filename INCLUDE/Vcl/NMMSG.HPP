...
// (DO NOT EDIT: machine generated header) 'NMMSG.pas' rev: 6.00
...
{
//-- type declarations -------------------------------------------------------
typedef void __fastcall (__closure *TMSGEvent)(Classes::TComponent* Sender, const AnsiString sFrom, const AnsiString sMsg);
