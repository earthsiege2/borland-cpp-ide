...
// (DO NOT EDIT: machine generated header) 'IdTrivialFTPBase.pas' rev: 6.00
...
extern PACKAGE void __fastcall SendError(Idudpbase::TIdUDPBase* UDPBase, AnsiString APeerIP, const int APort, const Word ErrNumber, AnsiString ErrorString)/* overload */;
extern PACKAGE void __fastcall SendError(Idudpclient::TIdUDPClient* UDPClient, const Word ErrNumber, AnsiString ErrorString)/* overload */;
extern PACKAGE void __fastcall SendError(Idudpbase::TIdUDPBase* UDPBase, AnsiString APeerIP, const int APort, Sysutils::Exception* E)/* overload */;
