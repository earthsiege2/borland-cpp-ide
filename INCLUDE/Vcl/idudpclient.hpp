...
// (DO NOT EDIT: machine generated header) 'IdUDPClient.pas' rev: 6.00
...
public:
	...
	/* TIdUDPBase.Create */ inline __fastcall virtual TIdUDPClient(Classes::TComponent* AOwner) : Idudpbase::TIdUDPBase(AOwner) { }
	#pragma option pop
	#pragma option push -w-inl
