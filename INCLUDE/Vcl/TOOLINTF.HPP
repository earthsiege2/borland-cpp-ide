...
// (DO NOT EDIT: machine generated header) 'ToolIntf.pas' rev: 5.00
...
public:
	...
	virtual TIMenuItemIntf* __stdcall InsertItem(int Index, AnsiString Caption, AnsiString Name, AnsiString 
		Hint, int ShortCut, int Context, int GroupIndex, TIMenuFlags Flags, TIMenuClickEvent EventHandler)
		 = 0 ;
public:
...
enum TFileNotification { fnFileOpening, fnFileOpened, fnFileClosing, fnProjectOpening, fnProjectOpened, 
	...
	fnProjectDesktopLoad, fnprojectDesktopSave, fnPackageInstalled, fnPackageUninstalled };
#pragma option pop
...
public:
	virtual void __stdcall FileNotification(TFileNotification NotifyCode, const AnsiString FileName, bool 
		&Cancel) = 0 ;
...
typedef bool __stdcall (*TProjectEnumProc)(void * Param, const AnsiString FileName, const AnsiString 
	UnitName, const AnsiString FormName);

typedef bool __stdcall (*TProjectEnumModuleProc)(void * Param, const AnsiString FileName, const AnsiString 
	UnitName, const AnsiString FormName, const AnsiString DesignClass);
...
public:
	...
	virtual int __stdcall ModalDialogBox(unsigned Instance, char * TemplateName, HWND WndParent, void * 
		DialogFunc, int InitParam) = 0 ;
	virtual bool __stdcall CreateModule(const AnsiString ModuleName, _di_IStream Source, _di_IStream Form
		, TCreateModuleFlags CreateFlags) = 0 ;
	virtual Editintf::TIModuleInterface* __stdcall CreateModuleEx(const AnsiString ModuleName, const AnsiString 
		FormName, const AnsiString AncestorClass, const AnsiString FileSystem, _di_IStream Source, _di_IStream 
		Form, TCreateModuleFlags CreateFlags) = 0 ;
	...
	virtual Windows::TRect __stdcall GetFormBounds(TBoundsType BoundsType) = 0 ;
	virtual Editintf::TIModuleInterface* __stdcall ProjectCreate(Editintf::TIProjectCreator* ProjectCreator
		, TCreateProjectFlags CreateFlags) = 0 ;
	virtual Editintf::TIModuleInterface* __stdcall ModuleCreate(Editintf::TIModuleCreator* ModuleCreator
		, TCreateModuleFlags CreateFlags) = 0 ;
	virtual bool __stdcall AddNotifierEx(TIAddInNotifier* AddInNotifier) = 0 ;
	virtual bool __stdcall GetNewModuleAndClassName(const AnsiString Prefix, AnsiString &UnitIdent, AnsiString 
		&ClassName, AnsiString &FileName) = 0 ;
	virtual Editintf::TIModuleInterface* __stdcall CreateCppModule(const AnsiString ModuleName, const AnsiString 
		FormName, const AnsiString AncestorClass, const AnsiString FileSystem, _di_IStream HdrSource, _di_IStream 
		Source, _di_IStream Form, TCreateModuleFlags CreateFlags) = 0 ;
	...
	virtual Editintf::TIModuleInterface* __stdcall ProjectCreateEx(Editintf::TIProjectCreatorEx* ProjectCreator
		, TCreateProjectFlags CreateFlags) = 0 ;
	virtual Editintf::TIModuleInterface* __stdcall ModuleCreateEx(Editintf::TIModuleCreatorEx* ModuleCreator
		, TCreateModuleFlags CreateFlags) = 0 ;
public:
	#pragma option push -w-inl
