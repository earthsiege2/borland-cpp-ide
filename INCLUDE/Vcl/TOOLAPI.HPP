...
// (DO NOT EDIT: machine generated header) 'ToolsAPI.pas' rev: 5.00
...
DEFINE_GUID(IID_INTACustomMessage,0xB7523AB7,0xEB81,0x11D2,0xAC,0x7B,0x00,0xC0,0x4F,0xB1,0x73,0xDC);
	
DEFINE_GUID(IID_INTACustomMessage40,0x589BBDA1,0xF995,0x11D1,0xAB,0x27,0x00,0xC0,0x4F,0xB1,0x6F,0xB3);
...
DEFINE_GUID(IID_IOTAMessageServices,0x3263774B,0xE959,0x11D2,0xAC,0x7B,0x00,0xC0,0x4F,0xB1,0x73,0xDC);
...
typedef void __fastcall (__closure *TKeyBindingProc)(const _di_IOTAKeyContext Context, Classes::TShortCut 
	KeyCode, TKeyBindingResult &BindingResult);
...
__interface INTERFACE_UUID("{F17A7BCF-E07D-11D1-AB0B-00C04FB16FB3}") IOTANotifier  : public IUnknown 
...
public:
	virtual void __fastcall ViewNotification(const _di_IOTAEditView View, Classes::TOperation Operation
		) = 0 ;
...
__interface INTERFACE_UUID("{F17A7BD0-E07D-11D1-AB0B-00C04FB16FB3}") IOTAEditor  : public IUnknown 
{
...
__interface INTERFACE_UUID("{26EB0E4F-F97B-11D1-AB27-00C04FB16FB3}") IOTAEditReader  : public IUnknown 
...
__interface INTERFACE_UUID("{26EB0E50-F97B-11D1-AB27-00C04FB16FB3}") IOTAEditWriter  : public IUnknown 
...
__interface INTERFACE_UUID("{0E3B9D78-E119-11D1-AB0C-00C04FB16FB3}") IOTAEditView40  : public IUnknown 
...
public:
	...
	virtual void __fastcall ConvertPos(bool EdPosToCharPos, TOTAEditPos &EditPos, TOTACharPos &CharPos)
		 = 0 ;
...
__interface INTERFACE_UUID("{D1766F8B-D915-11D2-A8C1-00C04FA32F53}") IOTASearchOptions  : public IUnknown 
...
__interface INTERFACE_UUID("{9C510464-C7BC-11D2-9AEB-00A02457621F}") IOTAEditPosition  : public IUnknown 
...
public:
	...
	virtual int __fastcall Replace(const AnsiString Pattern, const AnsiString ReplaceText, bool CaseSensitive
		, bool RegularExpression, bool WholeFile, TSearchDirection Direction, int &ErrorCode) = 0 /* overload */
		;
	...
	virtual bool __fastcall Search(const AnsiString Pattern, bool CaseSensitive, bool RegularExpression
		, bool WholeFile, TSearchDirection Direction, int &ErrorCode) = 0 /* overload */;
...
__interface INTERFACE_UUID("{9C510463-C7BC-11D2-9AEB-00A02457621F}") IOTAEditBlock  : public IUnknown 
...
__interface INTERFACE_UUID("{8CC6430B-E721-11D2-A8CC-00C04FA32F53}") INTAEditWindow  : public IUnknown 
...
__interface INTERFACE_UUID("{ECB23623-E2D8-11D2-ABE5-00C04FB16FB3}") IOTAEditActions  : public IUnknown 
...
__interface INTERFACE_UUID("{26EB0E51-F97B-11D1-AB27-00C04FB16FB3}") IOTAResourceEntry  : public IUnknown 
...
public:
	...
	virtual _di_IOTAResourceEntry __fastcall CreateEntry(char * ResType, char * Name, Word Flags, Word 
		LanguageId, int DataVersion, int Version, int Characteristics) = 0 ;
};

__interface IOTAComponent;
typedef System::DelphiInterface<IOTAComponent> _di_IOTAComponent;
typedef void __fastcall (__closure *TOTAGetChildCallback)(void * Param, _di_IOTAComponent Component, 
	bool &Result);

__interface INTAComponent;
typedef System::DelphiInterface<INTAComponent> _di_INTAComponent;
__interface INTERFACE_UUID("{34B2E2D1-E36F-11D1-AB0E-00C04FB16FB3}") INTAComponent  : public IUnknown 
...
__interface INTERFACE_UUID("{34B2E2D0-E36F-11D1-AB0E-00C04FB16FB3}") IOTAComponent  : public IUnknown 
...
__interface INTERFACE_UUID("{34B2E2CF-E36F-11D1-AB0E-00C04FB16FB3}") INTAFormEditor  : public IUnknown 
...
public:
	...
	__property Dsgnintf::_di_IFormDesigner FormDesigner = {read=GetFormDesigner};
};
...
public:
	...
	virtual _di_IOTAComponent __fastcall CreateComponent(const _di_IOTAComponent Container, const AnsiString 
...
__interface INTERFACE_UUID("{F17A7BD6-E07D-11D1-AB0B-00C04FB16FB3}") IOTAModuleInfo  : public IUnknown 
...
__interface INTERFACE_UUID("{F17A7BCC-E07D-11D1-AB0B-00C04FB16FB3}") IOTAModule40  : public IUnknown 
...
__interface INTERFACE_UUID("{15D3FB81-EF27-488E-B2B4-26B59CA89D9D}") IOTAModule  : public IOTAModule40 
...
__interface INTERFACE_UUID("{9C0E91FC-FA5A-11D1-AB28-00C04FB16FB3}") IOTAOptions  : public IUnknown 
...
__interface INTERFACE_UUID("{F17A7BD5-E07D-11D1-AB0B-00C04FB16FB3}") IOTAProjectBuilder40  : public IUnknown 
...
public:
	HIDESBASE virtual bool __fastcall BuildProject(TOTACompileMode CompileMode, bool Wait, bool ClearMessages
		) = 0 /* overload */;
};
...
__interface INTERFACE_UUID("{F17A7BC9-E07D-11D1-AB0B-00C04FB16FB3}") IOTAActionServices  : public IUnknown 
...
__interface INTERFACE_UUID("{A9D1389D-F4B0-11D1-AB22-00C04FB16FB3}") IOTAFileSystem  : public IUnknown 
...
__interface INTERFACE_UUID("{6E2AD9B0-F7F0-11D1-AB26-00C04FB16FB3}") IOTAFile  : public IUnknown 
{
...
__interface INTERFACE_UUID("{6EDB9B9E-F57A-11D1-AB23-00C04FB16FB3}") IOTACreator  : public IUnknown 
...
public:
	...
	virtual _di_IOTAFile __fastcall NewFormFile(const AnsiString FormIdent, const AnsiString AncestorIdent
		) = 0 ;
	virtual _di_IOTAFile __fastcall NewImplSource(const AnsiString ModuleIdent, const AnsiString FormIdent
		, const AnsiString AncestorIdent) = 0 ;
	virtual _di_IOTAFile __fastcall NewIntfSource(const AnsiString ModuleIdent, const AnsiString FormIdent
		, const AnsiString AncestorIdent) = 0 ;
...
__interface INTERFACE_UUID("{F17A7BCD-E07D-11D1-AB0B-00C04FB16FB3}") IOTAModuleServices  : public IUnknown 
...
__interface INTERFACE_UUID("{34B2E2D4-E36F-11D1-AB0E-00C04FB16FB3}") IOTABreakpoint40  : public IUnknown 
...
__interface INTERFACE_UUID("{34B2E2D3-E36F-11D1-AB0E-00C04FB16FB3}") IOTAThread  : public IUnknown 
{
...
__interface INTERFACE_UUID("{09063879-E43A-11D1-AB0F-00C04FB16FB3}") IOTAProcessModule  : public IUnknown 
...
__interface INTERFACE_UUID("{34B2E2D2-E36F-11D1-AB0E-00C04FB16FB3}") IOTAProcess  : public IUnknown 
...
__interface INTERFACE_UUID("{0E3B9D7A-E119-11D1-AB0C-00C04FB16FB3}") IOTADebuggerServices  : public IUnknown 
...
public:
	...
	virtual _di_IOTABreakpoint __fastcall NewAddressBreakpoint(unsigned Address, unsigned Length, TOTAAccessType 
		AccessType, _di_IOTAProcess AProcess) = 0 ;
	virtual _di_IOTABreakpoint __fastcall NewModuleBreakpoint(const AnsiString ModuleName, _di_IOTAProcess 
		AProcess) = 0 ;
	virtual _di_IOTABreakpoint __fastcall NewSourceBreakpoint(const AnsiString FileName, int LineNumber
		, _di_IOTAProcess AProcess) = 0 ;
	virtual void __fastcall RemoveNotifier(int Index) = 0 ;
...
public:
	HIDESBASE virtual void __fastcall BeforeCompile(const _di_IOTAProject Project, bool IsCodeInsight, 
		bool &Cancel) = 0 /* overload */;
...
typedef bool __stdcall (*TWizardInitProc)(const _di_IBorlandIDEServices BorlandIDEServices, TWizardRegisterProc 
...
__interface INTERFACE_UUID("{B75C0CE3-EEA6-11D1-9504-00608CCBF153}") IOTAWizardServices  : public IUnknown 
...
__interface INTERFACE_UUID("{26EB0E4D-F97B-11D1-AB27-00C04FB16FB3}") IOTAPackageServices  : public IUnknown 
...
__interface INTERFACE_UUID("{589BBDA1-F995-11D1-AB27-00C04FB16FB3}") IOTACustomMessage  : public IUnknown 
...
__interface INTERFACE_UUID("{26EB0E4E-F97B-11D1-AB27-00C04FB16FB3}") IOTAMessageServices40  : public IUnknown 
...
__interface INTERFACE_UUID("{3263774B-E959-11D2-AC7B-00C04FB173DC}") IOTAMessageServices  : public IOTAMessageServices40 
	
{
	
public:
	HIDESBASE virtual void __fastcall AddToolMessage(const AnsiString FileName, const AnsiString MessageStr
		, const AnsiString PrefixStr, int LineNumber, int ColumnNumber, void * Parent, /* out */ void * &LineRef
		) = 0 /* overload */;
};
...
__interface INTERFACE_UUID("{3C7F3267-F0BF-11D1-AB1E-00C04FB16FB3}") INTAServices40  : public IUnknown 
...
public:
	HIDESBASE virtual int __fastcall AddMasked(Graphics::TBitmap* Image, Graphics::TColor MaskColor, const 
		AnsiString Ident) = 0 /* overload */;
};

__interface IOTAServices;
typedef System::DelphiInterface<IOTAServices> _di_IOTAServices;
__interface INTERFACE_UUID("{7FD1CE91-E053-11D1-AB0B-00C04FB16FB3}") IOTAServices  : public IUnknown 
...
__interface INTERFACE_UUID("{8C748540-C6C1-11D2-8139-00609792F134}") IOTABufferOptions  : public IUnknown 
...
__interface INTERFACE_UUID("{D9D48F4F-E6CC-11D2-ABE8-00C04FB16FB3}") IOTAEditLineTracker  : public IUnknown 
...
__interface INTERFACE_UUID("{8ECB33AA-D0BD-11D2-ABD6-00C04FB16FB3}") IOTAEditBufferIterator  : public IUnknown 
...
__interface INTERFACE_UUID("{3E7790CB-D2BB-11D2-ABD8-00C04FB16FB3}") IOTAKeyContext  : public IUnknown 
...
__interface INTERFACE_UUID("{F8CAF8D6-D263-11D2-ABD8-00C04FB16FB3}") IOTARecord  : public IUnknown 
{
	
public:
	virtual void __fastcall Append(const Classes::TShortCut * Keys, const int Keys_Size) = 0 /* overload */
		;
	virtual void __fastcall Append(const AnsiString CmdName, bool IsKeys) = 0 /* overload */;
...
__interface INTERFACE_UUID("{F8CAF8D8-D263-11D2-ABD8-00C04FB16FB3}") IOTAKeyBindingServices  : public IUnknown 
	
{
	
public:
	virtual bool __fastcall AddKeyBinding(const Classes::TShortCut * Keys, const int Keys_Size, TKeyBindingProc 
		KeyProc, void * Context, int Flags, const AnsiString Keyboard, const AnsiString HotKey) = 0 ;
	virtual bool __fastcall AddMenuCommand(const AnsiString Command, TKeyBindingProc KeyProc, void * Context
		) = 0 ;
	virtual void __fastcall SetDefaultKeyProc(TKeyBindingProc KeyProc, void * Context, const AnsiString 
		Keyboard) = 0 ;
};
...
__interface INTERFACE_UUID("{F8CAF8D5-D263-11D2-ABD8-00C04FB16FB3}") IOTAKeyboardServices  : public IUnknown 
...
public:
	...
	virtual bool __fastcall LookupKeyBinding(const Classes::TShortCut * Keys, const int Keys_Size, /* out */ 
		TKeyBindingRec &BindingRec, const AnsiString KeyBoard) = 0 ;
...
__interface INTERFACE_UUID("{AEFC65F1-2504-11D3-AC25-00C04FB16FB3}") IOTAKeyboardDiagnostics  : public IUnknown 
...
__interface INTERFACE_UUID("{487BEA91-DBC0-11D2-ABDE-00C04FB16FB3}") IOTAEditOptions  : public IUnknown 
...
public:
	...
	virtual void __fastcall SetSyntaxHighlightTypes(TOTASyntaxHighlighter Index, const AnsiString Value
		) = 0 ;
	...
	__property AnsiString SyntaxHighlightTypes[TOTASyntaxHighlighter Index] = {read=GetSyntaxHighlightTypes
		, write=SetSyntaxHighlightTypes};
...
__interface INTERFACE_UUID("{C2812BA7-C48D-11D2-9AE8-00A02457621F}") IOTAEditorServices  : public IUnknown 
...
__interface INTERFACE_UUID("{094003D8-E7AA-11D2-AA99-00C04FA35CE8}") INTAToDoItem  : public IUnknown 
...
public:
	...
	virtual void __fastcall DrawImage(const Graphics::TCanvas* Canvas, const Windows::TRect &Rect) = 0 
		;
...
__interface INTERFACE_UUID("{3D4A0565-EB77-11D2-AA9A-00C04FA35CE8}") IOTAToDoManager  : public IUnknown 
...
__interface INTERFACE_UUID("{F8FC00EF-E61A-11D2-AA99-00C04FA35CE8}") IOTAToDoServices  : public IUnknown 
...
__interface INTERFACE_UUID("{7FD1CE92-E053-11D1-AB0B-00C04FB16FB3}") IBorlandIDEServices  : public IUnknown 
