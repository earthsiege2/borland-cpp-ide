...
// (DO NOT EDIT: machine generated header) 'vcspell.pas' rev: 5.00
...
private:
	...
	_di__DVSpell FIntf;
	_di__DVSpell __fastcall GetControlInterface();
	
protected:
	HIDESBASE void __fastcall CreateControl(void);
	virtual void __fastcall InitControlData(void);
	void __fastcall Set_OpenStandard(Word loadit, const WideString Param2);
	...
	void __fastcall Set_DictionaryPerformance(short index, short Param2);
	WideString __fastcall Get_Suggestion(short index);
	Word __fastcall Get_CustomIsUpdateable(short index);
	void __fastcall Set_AddToStandardIRList(short index, short Param2);
	void __fastcall Set_AddSuggestion(short matchcode, const WideString Param2);
	void __fastcall Set_AddToCustom(short index, short Param2);
	void __fastcall Set_ClearStandardIRList(short index, short Param2);
	void __fastcall Set_CloseDictionary(short index, short Param2);
	void __fastcall Set_GetEntry(short index, int Param2);
	void __fastcall Set_RemoveFromStandardIRList(short index, const WideString Param2);
	...
	void __fastcall Set_CreateCustomExtended(short index, const WideString Param2);
	void __fastcall Set_EnableDictionary(short index, Word Param2);
	void __fastcall Set_EnableCustomUpdate(short index, Word Param2);
	void __fastcall Set_LoadDictionary(short index, short Param2);
	void __fastcall Set_UnloadDictionary(short index, short Param2);
	Word __fastcall Get_CustomIsReadOnly(short index);
	Word __fastcall Get_CustomIsExtended(short index);
	void __fastcall Set_EnableStandardIRList(short index, Word Param2);
	void __fastcall Set_OpenCustom(Word loadit, const WideString Param2);
	
public:
	void __fastcall AboutBox(void);
	__property _di__DVSpell ControlInterface = {read=GetControlInterface};
	__property _di__DVSpell DefaultInterface = {read=GetControlInterface};
...
__published:
	...
	__property short EventOptions = {read=GetSmallintProp, write=SetSmallintProp, stored=false, index=18
		, nodefault};
	__property WideString Hyphenation = {read=GetWideStringProp, write=SetWideStringProp, stored=false, 
		index=19};
	...
	__property short LineOffset = {read=GetSmallintProp, write=SetSmallintProp, stored=false, index=23, 
		nodefault};
	__property WideString MisspelledWord = {read=GetWideStringProp, write=SetWideStringProp, stored=false
		, index=24};
	__property int ReplaceCount = {read=GetIntegerProp, write=SetIntegerProp, stored=false, index=25, nodefault
		};
	__property WideString ReplacementWord = {read=GetWideStringProp, write=SetWideStringProp, stored=false
		, index=26};
	...
	__property WideString CheckedWord = {read=GetWideStringProp, write=SetWideStringProp, stored=false, 
		index=52};
	__property Word CommonIRListIsEnabled = {read=GetWordBoolProp, write=SetWordBoolProp, stored=false, 
		index=53, nodefault};
	__property WideString WordMisspelledTitle = {read=GetWideStringProp, write=SetWideStringProp, stored=false
		, index=54};
	__property WideString OptionsTitle = {read=GetWideStringProp, write=SetWideStringProp, stored=false
		, index=55};
	__property WideString ErrorTitle = {read=GetWideStringProp, write=SetWideStringProp, stored=false, 
		index=56};
	__property WideString WordMisspelledHelpFile = {read=GetWideStringProp, write=SetWideStringProp, stored=false
		, index=57};
	__property WideString OptionsHelpFile = {read=GetWideStringProp, write=SetWideStringProp, stored=false
		, index=58};
	...
	__property WideString ClickInfoText = {read=GetWideStringProp, write=SetWideStringProp, stored=false
		, index=65};
	...
	__property short ClearOffsets = {read=GetSmallintProp, write=SetSmallintProp, stored=false, index=71
		, nodefault};
	__property WideString FindSuggestions = {read=GetWideStringProp, write=SetWideStringProp, stored=false
		, index=72};
	...
	__property short PopupWordMisspelled = {read=GetSmallintProp, write=SetSmallintProp, stored=false, 
		index=78, nodefault};
	__property WideString CreateCustom = {read=GetWideStringProp, write=SetWideStringProp, stored=false
		, index=79};
	...
	__property short ClearCommonIRList = {read=GetSmallintProp, write=SetSmallintProp, stored=false, index=82
		, nodefault};
	__property WideString RemoveFromCommonIRList = {read=GetWideStringProp, write=SetWideStringProp, stored=false
		, index=83};
	...
	__property WideString StandardDictionary = {read=GetWideStringProp, write=SetWideStringProp, stored=false
		, index=2};
	__property WideString CustomDictionary = {read=GetWideStringProp, write=SetWideStringProp, stored=false
		, index=3};
...
public:
	...
	/* TOleControl.Create */ inline __fastcall virtual TVSSpell(Classes::TComponent* AOwner) : Olectrls::TOleControl(
		AOwner) { }
	#pragma option pop
	#pragma option push -w-inl
...
public:
	#pragma option push -w-inl
	/* TWinControl.CreateParented */ inline __fastcall TVSSpell(HWND ParentWindow) : Olectrls::TOleControl(
		ParentWindow) { }
	#pragma option pop
...
//-- var, const, procedure ---------------------------------------------------
static const Shortint VspelocxLibMajorVersion = 0x2;
static const Shortint VspelocxLibMinorVersion = 0x0;
extern PACKAGE GUID LIBID_VspelocxLib;
extern PACKAGE GUID DIID__DVSpell;
extern PACKAGE GUID DIID__DVSpellEvents;
...
static const unsigned VSR_WORD_MISSPELLED = 0xffffffff;
static const unsigned VSR_IGNORE_REPLACE = 0xfffffffe;
static const unsigned VSR_CHECK_CANCELED = 0xfffffffd;
static const unsigned VSR_BREAK = 0xfffffffc;
static const unsigned VSR_FOUND = 0xfffffffb;
static const unsigned VSR_REPLACED = 0xfffffffa;
static const unsigned VSR_CHANGED = 0xfffffff9;
static const unsigned VSR_END_LIST = 0xfffffff8;
static const unsigned VSR_ENTRY_NOT_FOUND = 0xfffffff7;
static const unsigned VSR_OPENED_READONLY = 0xfffffff5;
static const unsigned VSR_REPLACE_OVERFLOW = 0xfffffff4;
static const unsigned VSR_NOT_ADDED = 0xfffffff3;
static const unsigned VSR_POPPED = 0xfffffff2;
static const unsigned VSR_CLICK_IN = 0xfffffff1;
static const unsigned VSR_CLICK_OUT = 0xfffffff0;
