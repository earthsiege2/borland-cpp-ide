...
// (DO NOT EDIT: machine generated header) 'IdThreadMgrDefault.pas' rev: 6.00
...
public:
	...
	/* TIdThreadMgr.Create */ inline __fastcall virtual TIdThreadMgrDefault(Classes::TComponent* AOwner) : Idthreadmgr::TIdThreadMgr(AOwner) { }
	#pragma option pop
	#pragma option push -w-inl
