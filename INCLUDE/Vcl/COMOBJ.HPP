...
// (DO NOT EDIT: machine generated header) 'ComObj.pas' rev: 6.00
...
__interface INTERFACE_UUID("{6A8D432B-EB81-11D1-AAB1-00C04FB16FBC}") IServerExceptionHandler  : public IInterface 
{
	
public:
	virtual void __fastcall OnException(const WideString ServerClass, const WideString ExceptionClass, const WideString ErrorMessage, int ExceptAddr, const WideString ErrorIID, const WideString ProgID, int &Handled, HRESULT &Result) = 0 ;
};
...
#pragma option push -b-
enum TThreadingModel { tmSingle, tmApartment, tmFree, tmBoth, tmNeutral };
#pragma option pop
...
public:
	#pragma option push -w-inl
	/* Exception.CreateFmt */ inline __fastcall EOleException(const AnsiString Msg, const System::TVarRec * Args, const int Args_Size) : EOleSysError(Msg, Args, Args_Size) { }
	#pragma option pop
	#pragma option push -w-inl
	/* Exception.CreateRes */ inline __fastcall EOleException(int Ident)/* overload */ : EOleSysError(Ident) { }
	#pragma option pop
	#pragma option push -w-inl
	/* Exception.CreateResFmt */ inline __fastcall EOleException(int Ident, const System::TVarRec * Args, const int Args_Size)/* overload */ : EOleSysError(Ident, Args, Args_Size) { }
	#pragma option pop
	#pragma option push -w-inl
	/* Exception.CreateHelp */ inline __fastcall EOleException(const AnsiString Msg, int AHelpContext) : EOleSysError(Msg, AHelpContext) { }
	#pragma option pop
	#pragma option push -w-inl
	/* Exception.CreateFmtHelp */ inline __fastcall EOleException(const AnsiString Msg, const System::TVarRec * Args, const int Args_Size, int AHelpContext) : EOleSysError(Msg, Args, Args_Size, AHelpContext) { }
	#pragma option pop
	#pragma option push -w-inl
	/* Exception.CreateResHelp */ inline __fastcall EOleException(int Ident, int AHelpContext)/* overload */ : EOleSysError(Ident, AHelpContext) { }
	#pragma option pop
	#pragma option push -w-inl
	/* Exception.CreateResFmtHelp */ inline __fastcall EOleException(System::PResStringRec ResStringRec, const System::TVarRec * Args, const int Args_Size, int AHelpContext)/* overload */ : EOleSysError(ResStringRec, Args, Args_Size, AHelpContext) { }
	#pragma option pop
...
public:
	...
	#pragma option pop
	#pragma option push -w-inl
	/* Exception.CreateFmt */ inline __fastcall EOleRegistrationError(const AnsiString Msg, const System::TVarRec * Args, const int Args_Size) : EOleError(Msg, Args, Args_Size) { }
	#pragma option pop
	#pragma option push -w-inl
	/* Exception.CreateRes */ inline __fastcall EOleRegistrationError(int Ident)/* overload */ : EOleError(Ident) { }
	#pragma option pop
	#pragma option push -w-inl
	/* Exception.CreateResFmt */ inline __fastcall EOleRegistrationError(int Ident, const System::TVarRec * Args, const int Args_Size)/* overload */ : EOleError(Ident, Args, Args_Size) { }
	#pragma option pop
	#pragma option push -w-inl
	/* Exception.CreateHelp */ inline __fastcall EOleRegistrationError(const AnsiString Msg, int AHelpContext) : EOleError(Msg, AHelpContext) { }
	#pragma option pop
	#pragma option push -w-inl
	/* Exception.CreateFmtHelp */ inline __fastcall EOleRegistrationError(const AnsiString Msg, const System::TVarRec * Args, const int Args_Size, int AHelpContext) : EOleError(Msg, Args, Args_Size, AHelpContext) { }
	#pragma option pop
	#pragma option push -w-inl
	/* Exception.CreateResHelp */ inline __fastcall EOleRegistrationError(int Ident, int AHelpContext)/* overload */ : EOleError(Ident, AHelpContext) { }
	#pragma option pop
	#pragma option push -w-inl
	/* Exception.CreateResFmtHelp */ inline __fastcall EOleRegistrationError(System::PResStringRec ResStringRec, const System::TVarRec * Args, const int Args_Size, int AHelpContext)/* overload */ : EOleError(ResStringRec, Args, Args_Size, AHelpContext) { }
	#pragma option pop
...
extern PACKAGE HRESULT __fastcall HandleSafeCallException(System::TObject* ExceptObject, void * ExceptAddr, const GUID &ErrorIID, const WideString ProgID, const WideString HelpFileName);
...
extern PACKAGE void __fastcall CreateRegKey(const AnsiString Key, const AnsiString ValueName, const AnsiString Value, unsigned RootKey = (unsigned)(0x80000000));
extern PACKAGE void __fastcall DeleteRegKey(const AnsiString Key, unsigned RootKey = (unsigned)(0x80000000));
extern PACKAGE AnsiString __fastcall GetRegStringValue(const AnsiString Key, const AnsiString ValueName, unsigned RootKey = (unsigned)(0x80000000));
extern PACKAGE System::_di_IInterface __fastcall CreateComObject(const GUID &ClassID);
extern PACKAGE System::_di_IInterface __fastcall CreateRemoteComObject(const WideString MachineName, const GUID &ClassID);
...
extern PACKAGE void __fastcall InterfaceConnect(const System::_di_IInterface Source, const GUID &IID, const System::_di_IInterface Sink, int &Connection);
extern PACKAGE void __fastcall InterfaceDisconnect(const System::_di_IInterface Source, const GUID &IID, int &Connection);
extern PACKAGE void __fastcall DispatchInvoke(const _di_IDispatch Dispatch, System::PCallDesc CallDesc, Activex::PDispIDList DispIDs, void * Params, System::PVariant Result);
extern PACKAGE void __fastcall DispatchInvokeError(int Status, const tagEXCEPINFO &ExcepInfo);
extern PACKAGE OleVariant __fastcall GetDispatchPropValue(_di_IDispatch Disp, int DispID)/* overload */;
extern PACKAGE OleVariant __fastcall GetDispatchPropValue(_di_IDispatch Disp, WideString Name)/* overload */;
extern PACKAGE void __fastcall SetDispatchPropValue(_di_IDispatch Disp, int DispID, const OleVariant &Value)/* overload */;
extern PACKAGE void __fastcall SetDispatchPropValue(_di_IDispatch Disp, WideString Name, const OleVariant &Value)/* overload */;
