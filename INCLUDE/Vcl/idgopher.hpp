...
// (DO NOT EDIT: machine generated header) 'IdGopher.pas' rev: 6.00
...
protected:
	...
	TIdGopherMenu* __fastcall ProcessDirectory(AnsiString PreviousData = "", const int ExpectedLength = 0x0);
	TIdGopherMenu* __fastcall LoadExtendedDirectory(AnsiString PreviousData = "", const int ExpectedLength = 0x0);
	void __fastcall ProcessFile(Classes::TStream* ADestStream, AnsiString APreviousData = "", const int ExpectedLength = 0x0);
	void __fastcall ProcessTextFile(Classes::TStream* ADestStream, AnsiString APreviousData = "", const int ExpectedLength = 0x0);
	
public:
	__fastcall virtual TIdGopher(Classes::TComponent* AOwner);
	TIdGopherMenu* __fastcall GetMenu(AnsiString ASelector, bool IsGopherPlus = false, AnsiString AView = "");
	TIdGopherMenu* __fastcall Search(AnsiString ASelector, AnsiString AQuery);
	void __fastcall GetFile(AnsiString ASelector, Classes::TStream* ADestStream, bool IsGopherPlus = false, AnsiString AView = "");
	void __fastcall GetTextFile(AnsiString ASelector, Classes::TStream* ADestStream, bool IsGopherPlus = false, AnsiString AView = "");
