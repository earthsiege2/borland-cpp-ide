...
// (DO NOT EDIT: machine generated header) 'BrushDlg.pas' rev: 6.00
...
//-- var, const, procedure ---------------------------------------------------
extern PACKAGE Graphics::TFont* __fastcall InternalEditFont(Classes::TComponent* AOwner, Graphics::TFont* AFont);
