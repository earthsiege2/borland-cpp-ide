...
// (DO NOT EDIT: machine generated header) 'NMURL.pas' rev: 6.00
...
{
//-- type declarations -------------------------------------------------------
typedef void __fastcall (__closure *TOnErrorEvent)(System::TObject* Sender, AnsiString Operation, AnsiString ErrMsg);
