...
// (DO NOT EDIT: machine generated header) 'ChartFX.pas' rev: 5.00
...
__published:
	...
	__property Word AutoInvalidate = {read=GetOleBoolProp, write=SetOleBoolProp, stored=false, index=3, 
		nodefault};
	...
	__property Word AutoIncrement = {read=GetOleBoolProp, write=SetOleBoolProp, stored=false, index=49, 
		nodefault};
...
public:
	...
	/* TOleControl.Create */ inline __fastcall virtual TChartFX(Classes::TComponent* AOwner) : Olectrls::TOleControl(
		AOwner) { }
	#pragma option pop
	#pragma option push -w-inl
...
public:
	#pragma option push -w-inl
	/* TWinControl.CreateParented */ inline __fastcall TChartFX(HWND ParentWindow) : Olectrls::TOleControl(
		ParentWindow) { }
	#pragma option pop
