...
// (DO NOT EDIT: machine generated header) 'IdIrcServer.pas' rev: 6.00
...
typedef void __fastcall (__closure *TIdIrcOtherEvent)(Idtcpserver::TIdPeerThread* Thread, AnsiString Command, AnsiString Parm);

typedef void __fastcall (__closure *TIdIrcOneParmEvent)(Idtcpserver::TIdPeerThread* Thread, AnsiString Parm);

typedef void __fastcall (__closure *TIdIrcTwoParmEvent)(Idtcpserver::TIdPeerThread* Thread, AnsiString Parm1, AnsiString Parm2);

typedef void __fastcall (__closure *TIdIrcThreeParmEvent)(Idtcpserver::TIdPeerThread* Thread, AnsiString Parm1, AnsiString Parm2, AnsiString Parm3);

typedef void __fastcall (__closure *TIdIrcFiveParmEvent)(Idtcpserver::TIdPeerThread* Thread, AnsiString Parm1, AnsiString Parm2, AnsiString Parm3, AnsiString Parm4, AnsiString Parm5);

typedef void __fastcall (__closure *TIdIrcUserEvent)(Idtcpserver::TIdPeerThread* Thread, AnsiString UserName, AnsiString HostName, AnsiString ServerName, AnsiString RealName);

typedef void __fastcall (__closure *TIdIrcServerEvent)(Idtcpserver::TIdPeerThread* Thread, AnsiString ServerName, AnsiString Hopcount, AnsiString Info);
