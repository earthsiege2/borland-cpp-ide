...
// (DO NOT EDIT: machine generated header) 'IdGopherServer.pas' rev: 6.00
...
typedef void __fastcall (__closure *TPlusRequestEvent)(Idtcpserver::TIdPeerThread* AThread, AnsiString ARequest, AnsiString APlusData);
...
public:
	...
	AnsiString __fastcall ReturnGopherItem(char ItemType, AnsiString UserFriendlyName, AnsiString RealResourceName, AnsiString HostServer, int HostPort);
	void __fastcall SendDirectoryEntry(Idtcpserver::TIdPeerThread* Thread, char ItemType, AnsiString UserFriendlyName, AnsiString RealResourceName, AnsiString HostServer, int HostPort);
...
__published:
	...
	__property bool TruncateUserFriendlyName = {read=fTruncateUserFriendly, write=SetTruncateUserFriendlyName, default=1};
...
//-- var, const, procedure ---------------------------------------------------
static const bool Id_TIdGopherServer_TruncateUserFriendly = true;
static const Shortint Id_TIdGopherServer_TruncateLength = 0x46;
