...
// (DO NOT EDIT: machine generated header) 'ArrowEdi.pas' rev: 5.00
...
__published:
	...
	void __fastcall SHArrowColorMouseUp(System::TObject* Sender, Controls::TMouseButton Button, Classes::TShiftState 
		Shift, int X, int Y);
...
public:
	...
	/* TCustomForm.Create */ inline __fastcall virtual TArrowSeriesEditor(Classes::TComponent* AOwner) : 
		Forms::TForm(AOwner) { }
	#pragma option pop
	#pragma option push -w-inl
	/* TCustomForm.CreateNew */ inline __fastcall virtual TArrowSeriesEditor(Classes::TComponent* AOwner
...
public:
	#pragma option push -w-inl
	/* TWinControl.CreateParented */ inline __fastcall TArrowSeriesEditor(HWND ParentWindow) : Forms::TForm(
		ParentWindow) { }
	#pragma option pop
