...
// (DO NOT EDIT: machine generated header) 'IdTelnet.pas' rev: 6.00
...
{
//-- type declarations -------------------------------------------------------
typedef void __fastcall (__closure *TTnDataAvail)(AnsiString Buffer);

#pragma option push -b-
enum TTnState { tnsDATA, tnsIAC, tnsIAC_SB, tnsIAC_WILL, tnsIAC_DO, tnsIAC_WONT, tnsIAC_DONT, tnsIAC_SBIAC, tnsIAC_SBDATA, tnsSBDATA_IAC };
#pragma option pop

#pragma option push -b-
enum TTelnetCommand { tncNoLocalEcho, tncLocalEcho, tncEcho };
#pragma option pop

typedef void __fastcall (__closure *TClientEvent)(void);

typedef void __fastcall (__closure *TOnTelnetCommand)(Classes::TComponent* Sender, TTelnetCommand Status);
...
protected:
	...
	TTnDataAvail FOnDataAvailable;
	bool fIamTelnet;
	TClientEvent FOnDisconnect;
	TClientEvent FOnConnect;
	TOnTelnetCommand FOnTelnetCommand;
	void __fastcall DoOnDataAvailable(void);
	void __fastcall SetOnTelnetCommand(const TOnTelnetCommand Value);
	__property TTnState State = {read=fState, write=fState, nodefault};
	...
	void __fastcall DoTelnetCommand(TTelnetCommand Status);
	
public:
	TIdTelnetReadThread* TelnetThread;
...
__published:
	__property TOnTelnetCommand OnTelnetCommand = {read=FOnTelnetCommand, write=SetOnTelnetCommand};
	__property TTnDataAvail OnDataAvailable = {read=FOnDataAvailable, write=FOnDataAvailable};
	__property AnsiString Terminal = {read=fTerminal, write=fTerminal};
	__property TClientEvent OnConnect = {read=FOnConnect, write=FOnConnect};
	__property TClientEvent OnDisconnect = {read=FOnDisconnect, write=FOnDisconnect};
public:
...
public:
	#pragma option push -w-inl
	/* Exception.Create */ inline __fastcall EIdTelnetError(const AnsiString Msg) : Idexception::EIdException(Msg) { }
	#pragma option pop
	#pragma option push -w-inl
	/* Exception.CreateFmt */ inline __fastcall EIdTelnetError(const AnsiString Msg, const System::TVarRec * Args, const int Args_Size) : Idexception::EIdException(Msg, Args, Args_Size) { }
	#pragma option pop
	#pragma option push -w-inl
	/* Exception.CreateRes */ inline __fastcall EIdTelnetError(int Ident)/* overload */ : Idexception::EIdException(Ident) { }
	#pragma option pop
	#pragma option push -w-inl
	/* Exception.CreateResFmt */ inline __fastcall EIdTelnetError(int Ident, const System::TVarRec * Args, const int Args_Size)/* overload */ : Idexception::EIdException(Ident, Args, Args_Size) { }
	#pragma option pop
	#pragma option push -w-inl
	/* Exception.CreateHelp */ inline __fastcall EIdTelnetError(const AnsiString Msg, int AHelpContext) : Idexception::EIdException(Msg, AHelpContext) { }
	#pragma option pop
	#pragma option push -w-inl
	/* Exception.CreateFmtHelp */ inline __fastcall EIdTelnetError(const AnsiString Msg, const System::TVarRec * Args, const int Args_Size, int AHelpContext) : Idexception::EIdException(Msg, Args, Args_Size, AHelpContext) { }
	#pragma option pop
	#pragma option push -w-inl
	...
	#pragma option pop
	#pragma option push -w-inl
	/* Exception.CreateResFmtHelp */ inline __fastcall EIdTelnetError(System::PResStringRec ResStringRec, const System::TVarRec * Args, const int Args_Size, int AHelpContext)/* overload */ : Idexception::EIdException(ResStringRec, Args, Args_Size, AHelpContext) { }
	#pragma option pop
...
public:
	#pragma option push -w-inl
	/* Exception.Create */ inline __fastcall EIdTelnetClientConnectError(const AnsiString Msg) : EIdTelnetError(Msg) { }
	#pragma option pop
	#pragma option push -w-inl
	/* Exception.CreateFmt */ inline __fastcall EIdTelnetClientConnectError(const AnsiString Msg, const System::TVarRec * Args, const int Args_Size) : EIdTelnetError(Msg, Args, Args_Size) { }
	#pragma option pop
	#pragma option push -w-inl
	/* Exception.CreateRes */ inline __fastcall EIdTelnetClientConnectError(int Ident)/* overload */ : EIdTelnetError(Ident) { }
	#pragma option pop
	#pragma option push -w-inl
	/* Exception.CreateResFmt */ inline __fastcall EIdTelnetClientConnectError(int Ident, const System::TVarRec * Args, const int Args_Size)/* overload */ : EIdTelnetError(Ident, Args, Args_Size) { }
	#pragma option pop
	#pragma option push -w-inl
	/* Exception.CreateHelp */ inline __fastcall EIdTelnetClientConnectError(const AnsiString Msg, int AHelpContext) : EIdTelnetError(Msg, AHelpContext) { }
	#pragma option pop
	#pragma option push -w-inl
	/* Exception.CreateFmtHelp */ inline __fastcall EIdTelnetClientConnectError(const AnsiString Msg, const System::TVarRec * Args, const int Args_Size, int AHelpContext) : EIdTelnetError(Msg, Args, Args_Size, AHelpContext) { }
	#pragma option pop
	#pragma option push -w-inl
	...
	#pragma option pop
	#pragma option push -w-inl
	/* Exception.CreateResFmtHelp */ inline __fastcall EIdTelnetClientConnectError(System::PResStringRec ResStringRec, const System::TVarRec * Args, const int Args_Size, int AHelpContext)/* overload */ : EIdTelnetError(ResStringRec, Args, Args_Size, AHelpContext) { }
	#pragma option pop
...
public:
	#pragma option push -w-inl
	/* Exception.Create */ inline __fastcall EIdTelnetServerOnDataAvailableIsNil(const AnsiString Msg) : EIdTelnetError(Msg) { }
	#pragma option pop
	#pragma option push -w-inl
	/* Exception.CreateFmt */ inline __fastcall EIdTelnetServerOnDataAvailableIsNil(const AnsiString Msg, const System::TVarRec * Args, const int Args_Size) : EIdTelnetError(Msg, Args, Args_Size) { }
	#pragma option pop
	#pragma option push -w-inl
	/* Exception.CreateRes */ inline __fastcall EIdTelnetServerOnDataAvailableIsNil(int Ident)/* overload */ : EIdTelnetError(Ident) { }
	#pragma option pop
	#pragma option push -w-inl
	/* Exception.CreateResFmt */ inline __fastcall EIdTelnetServerOnDataAvailableIsNil(int Ident, const System::TVarRec * Args, const int Args_Size)/* overload */ : EIdTelnetError(Ident, Args, Args_Size) { }
	#pragma option pop
	#pragma option push -w-inl
	/* Exception.CreateHelp */ inline __fastcall EIdTelnetServerOnDataAvailableIsNil(const AnsiString Msg, int AHelpContext) : EIdTelnetError(Msg, AHelpContext) { }
	#pragma option pop
	#pragma option push -w-inl
	/* Exception.CreateFmtHelp */ inline __fastcall EIdTelnetServerOnDataAvailableIsNil(const AnsiString Msg, const System::TVarRec * Args, const int Args_Size, int AHelpContext) : EIdTelnetError(Msg, Args, Args_Size, AHelpContext) { }
	#pragma option pop
	#pragma option push -w-inl
	...
	#pragma option pop
	#pragma option push -w-inl
	/* Exception.CreateResFmtHelp */ inline __fastcall EIdTelnetServerOnDataAvailableIsNil(System::PResStringRec ResStringRec, const System::TVarRec * Args, const int Args_Size, int AHelpContext)/* overload */ : EIdTelnetError(ResStringRec, Args, Args_Size, AHelpContext) { }
	#pragma option pop
