...
EXTERN_C const IID IID_IAMMultiMediaStream;
    ...
    public:
        virtual HRESULT STDMETHODCALLTYPE Initialize( 
            ...
            /* [in] */ DWORD dwFlags,
            /* [in] */ IGraphBuilder __RPC_FAR *pFilterGraph) = 0;
        ...
        virtual HRESULT STDMETHODCALLTYPE AddMediaStream( 
            ...
            /* [in] */ DWORD dwFlags,
            /* [out] */ IMediaStream __RPC_FAR *__RPC_FAR *ppNewStream) = 0;
    ...
    typedef struct IAMMultiMediaStreamVtbl
    {
        ...
        HRESULT ( STDMETHODCALLTYPE __RPC_FAR *GetInformation )( 
            ...
            /* [out] */ STREAM_TYPE __RPC_FAR *pStreamType);
        ...
        HRESULT ( STDMETHODCALLTYPE __RPC_FAR *Initialize )( 
            ...
            /* [in] */ STREAM_TYPE StreamType,
            /* [in] */ DWORD dwFlags,
            /* [in] */ IGraphBuilder __RPC_FAR *pFilterGraph);
        ...
        HRESULT ( STDMETHODCALLTYPE __RPC_FAR *AddMediaStream )( 
            ...
            /* [in] */ const MSPID __RPC_FAR *PurposeId,
            /* [in] */ DWORD dwFlags,
            /* [out] */ IMediaStream __RPC_FAR *__RPC_FAR *ppNewStream);
...
EXTERN_C const IID IID_IAMMediaStream;
    ...
    typedef struct IAMMediaStreamVtbl
    {
        ...
        HRESULT ( STDMETHODCALLTYPE __RPC_FAR *GetInformation )( 
            IAMMediaStream __RPC_FAR * This,
            /* [out] */ MSPID __RPC_FAR *pPurposeId,
            /* [out] */ STREAM_TYPE __RPC_FAR *pType);
...
/* interface __MIDL_itf_amstream_0360 */
/* [local] */ 
...
extern RPC_IF_HANDLE __MIDL_itf_amstream_0360_v0_0_c_ifspec;
extern RPC_IF_HANDLE __MIDL_itf_amstream_0360_v0_0_s_ifspec;
