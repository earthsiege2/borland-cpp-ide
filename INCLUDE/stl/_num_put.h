...
__write_integer(char* buf, ios_base::fmtflags flags, long __x);
...
template<> locale::id num_put<char, ostreambuf_iterator<char, char_traits<char> > >::id = {14};
template<> locale::id num_put<char, char*>::id = {15};

# ifndef _STLP_NO_WCHAR_T
template<> locale::id num_put<wchar_t, ostreambuf_iterator<wchar_t, char_traits<wchar_t> > > ::id = {33};
template<> locale::id num_put<wchar_t, wchar_t*>::id = {34};
# endif
#endif
*/
