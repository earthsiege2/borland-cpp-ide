...
EXTERN_C const IID IID_AsyncIMSAdminBaseSinkW;
    ...
    typedef struct AsyncIMSAdminBaseSinkWVtbl
    {
        ...
        HRESULT ( STDMETHODCALLTYPE __RPC_FAR *QueryInterface )( 
            AsyncIMSAdminBaseSinkW __RPC_FAR * This,
            /* [in] */ REFIID riid,
            /* [iid_is][out] */ void __RPC_FAR *__RPC_FAR *ppvObject);
        ...
        HRESULT ( STDMETHODCALLTYPE __RPC_FAR *Begin_SinkNotify )( 
            AsyncIMSAdminBaseSinkW __RPC_FAR * This,
            /* [in] */ DWORD dwMDNumElements,
            /* [size_is][in] */ MD_CHANGE_OBJECT_W __RPC_FAR pcoChangeList[  ]);
        
        HRESULT ( STDMETHODCALLTYPE __RPC_FAR *Finish_SinkNotify )( 
            AsyncIMSAdminBaseSinkW __RPC_FAR * This);
        
        HRESULT ( STDMETHODCALLTYPE __RPC_FAR *Begin_ShutdownNotify )( 
            AsyncIMSAdminBaseSinkW __RPC_FAR * This);
        
        HRESULT ( STDMETHODCALLTYPE __RPC_FAR *Finish_ShutdownNotify )( 
            AsyncIMSAdminBaseSinkW __RPC_FAR * This);
    ...
    interface AsyncIMSAdminBaseSinkW
    {
        CONST_VTBL struct AsyncIMSAdminBaseSinkWVtbl __RPC_FAR *lpVtbl;
    };
...
/* interface __MIDL_itf_iadmw_0251 */
/* [local] */ 

#endif


extern RPC_IF_HANDLE __MIDL_itf_iadmw_0251_v0_0_c_ifspec;
extern RPC_IF_HANDLE __MIDL_itf_iadmw_0251_v0_0_s_ifspec;
